...
public class Items
{
    ...
    static
    {
        ...
        else
        {
            ...
            // Begin Awaken Dreams code
            LEMBAS = getRegisteredADItem("lembas");
            MITHRIL_INGOT = getRegisteredADItem("mithril_ingot");
            PIPE = (ItemPipe) getRegisteredADItem("pipe");
            ...
            SPIDER_POISON = getRegisteredADItem("spider_poison");
            HERUGRIM = getRegisteredADItem("herugrim");
            NUTS = getRegisteredADItem("nuts");
            CORN_COB = getRegisteredADItem("corn_cob");
            STAFF_BASE = getRegisteredADItem("staff_base");
            KNIFE = getRegisteredADItem("knife");
            BERRIES = getRegisteredADItem("berries");
            BEAR_CLAW = getRegisteredADItem("bear_claw");
            BEAST_SKIN = getRegisteredADItem("beast_skin");
            DEAD_ROOT = getRegisteredADItem("dead_root");
            EAGLE_FEATHER = getRegisteredADItem("eagle_feather");
            GOBLIN_EYE = getRegisteredADItem("goblin_eye");
            HELEGROG_DEAMON_HEART = getRegisteredADItem("helegrog_deamon_heart");
            ORC_BLOOD = getRegisteredADItem("orc_blood");
            OWL_FEATHER = getRegisteredADItem("owl_feather");
            SCORPION_TAIL = getRegisteredADItem("scorpion_tail");
            SHARK_TOOTH = getRegisteredADItem("shark_tooth");
            TROLL_SKIN = getRegisteredADItem("troll_skin");
            WARG_FANG = getRegisteredADItem("warg_fang");
            BLUE_BED = getRegisteredADItem("blue_bed");
            Blocks.BLUE_BED.setItem(BLUE_BED);
            BROWN_BED = getRegisteredADItem("brown_bed");
            Blocks.BROWN_BED.setItem(BROWN_BED);
            BREE_DOOR = getRegisteredADItem("bree_door");
            Blocks.BREE_DOOR.setItem(BREE_DOOR);
            RUCKSACK = getRegisteredADItem("rucksack");
            CRAM = getRegisteredADItem("cram");
            CABBAGE = getRegisteredADItem("cabbage");
            COCONUT = getRegisteredADItem("coconut");
            RAW_DEER_MEAT = getRegisteredADItem("raw_deer_meat");
            COOKED_DEER_MEAT = getRegisteredADItem("cooked_deer_meat");
            MUFFIN = getRegisteredADItem("muffin");
            STRAWBERRY = getRegisteredADItem("strawberry");
            Blocks.STRAWBERRY_BUSH.setCrop(STRAWBERRY);
            STRAWBERRY_MUFFIN = getRegisteredADItem("strawberry_muffin");
            ORANGE = getRegisteredADItem("orange");
            ORANGE_MUFFIN = getRegisteredADItem("orange_muffin");
            PEAR = getRegisteredADItem("pear");
            RAW_MEAT = getRegisteredADItem("raw_meat");
            COOKED_MEAT = getRegisteredADItem("cooked_meat");
            ROHAN_HELMET_1 = getRegisteredADItem("rohan_helmet_1");
            ROHAN_HELMET_2 = getRegisteredADItem("rohan_helmet_2");
            ROHAN_HELMET_3 = getRegisteredADItem("rohan_helmet_3");
            ROHAN_HELMET_4 = getRegisteredADItem("rohan_helmet_4");
            ROHAN_HELMET_5 = getRegisteredADItem("rohan_helmet_5");
            ...
            STONE_OF_GREED = getRegisteredADItem("stone_of_greed");
            STONE_OF_HOPE = getRegisteredADItem("stone_of_hope");
            STONE_OF_NATURE = getRegisteredADItem("stone_of_nature");
            STONE_OF_SUNLIGHT = getRegisteredADItem("stone_of_sunlight");
            STONE_OF_SEA = getRegisteredADItem("stone_of_sea");
            STONE_OF_SKY = getRegisteredADItem("stone_of_sky");
            STONE_OF_WEALTH = getRegisteredADItem("stone_of_wealth");
            STONE_OF_WIND = getRegisteredADItem("stone_of_wind");
            HAMMER = getRegisteredADItem("hammer");
            GOLD_RING = getRegisteredADItem("gold_ring");
            ONYX_GOLD_RING = getRegisteredADItem("onyx_gold_ring");
            TANZANITE_GOLD_RING = getRegisteredADItem("tanzanite_gold_ring");
            JADE_GOLD_RING = getRegisteredADItem("jade_gold_ring");
            MOONSTONE_GOLD_RING = getRegisteredADItem("moonstone_gold_ring");
            AMETHYST_GOLD_RING = getRegisteredADItem("amethyst_gold_ring");
            RUBY_GOLD_RING = getRegisteredADItem("ruby_gold_ring");
            QUARTZ_GOLD_RING = getRegisteredADItem("quartz_gold_ring");
            AMBER_GOLD_RING = getRegisteredADItem("amber_gold_ring");
            SILVER_RING = getRegisteredADItem("silver_ring");
            ONYX_SILVER_RING = getRegisteredADItem("onyx_silver_ring");
            TANZANITE_SILVER_RING = getRegisteredADItem("tanzanite_silver_ring");
            JADE_SILVER_RING = getRegisteredADItem("jade_silver_ring");
            MOONSTONE_SILVER_RING = getRegisteredADItem("moonstone_silver_ring");
            AMETHYST_SILVER_RING = getRegisteredADItem("amethyst_silver_ring");
            RUBY_SILVER_RING = getRegisteredADItem("ruby_silver_ring");
            QUARTZ_SILVER_RING = getRegisteredADItem("quartz_silver_ring");
            AMBER_SILVER_RING = getRegisteredADItem("amber_silver_ring");
            BRONZE_RING = getRegisteredADItem("bronze_ring");
            ONYX_BRONZE_RING = getRegisteredADItem("onyx_bronze_ring");
            TANZANITE_BRONZE_RING = getRegisteredADItem("tanzanite_bronze_ring");
            JADE_BRONZE_RING = getRegisteredADItem("jade_bronze_ring");
            MOONSTONE_BRONZE_RING = getRegisteredADItem("moonstone_bronze_ring");
            AMETHYST_BRONZE_RING = getRegisteredADItem("amethyst_bronze_ring");
            RUBY_BRONZE_RING = getRegisteredADItem("ruby_bronze_ring");
            QUARTZ_BRONZE_RING = getRegisteredADItem("quartz_bronze_ring");
            AMBER_BRONZE_RING = getRegisteredADItem("amber_bronze_ring");
            MITHRIL_RING = getRegisteredADItem("mithril_ring");
            ONYX_MITHRIL_RING = getRegisteredADItem("onyx_mithril_ring");
            TANZANITE_MITHRIL_RING = getRegisteredADItem("tanzanite_mithril_ring");
            JADE_MITHRIL_RING = getRegisteredADItem("jade_mithril_ring");
            MOONSTONE_MITHRIL_RING = getRegisteredADItem("moonstone_mithril_ring");
            AMETHYST_MITHRIL_RING = getRegisteredADItem("amethyst_mithril_ring");
            RUBY_MITHRIL_RING = getRegisteredADItem("ruby_mithril_ring");
            ...
            BATTLE_PICKAXE = getRegisteredADItem("battle_pickaxe");
            SHIRRIFF_CLUB = getRegisteredADItem("shirriff_club");
            ...
            GOLD_RING_OF_FIRE = getRegisteredADItem("gold_ring_of_fire");
            GOLD_RING_OF_GREED = getRegisteredADItem("gold_ring_of_greed");
            GOLD_RING_OF_HOPE = getRegisteredADItem("gold_ring_of_hope");
            GOLD_RING_OF_NATURE = getRegisteredADItem("gold_ring_of_nature");
            GOLD_RING_OF_SEA = getRegisteredADItem("gold_ring_of_sea");
            GOLD_RING_OF_SKY = getRegisteredADItem("gold_ring_of_sky");
            GOLD_RING_OF_SUNLIGHT = getRegisteredADItem("gold_ring_of_sunlight");
            GOLD_RING_OF_WEALTH = getRegisteredADItem("gold_ring_of_wealth");
            GOLD_RING_OF_WIND = getRegisteredADItem("gold_ring_of_wind");
            SILVER_RING_OF_DARKNESS = getRegisteredADItem("silver_ring_of_darkness");
            SILVER_RING_OF_EARTH = getRegisteredADItem("silver_ring_of_earth");
            SILVER_RING_OF_FIRE = getRegisteredADItem("silver_ring_of_fire");
            SILVER_RING_OF_GREED = getRegisteredADItem("silver_ring_of_greed");
            SILVER_RING_OF_HOPE = getRegisteredADItem("silver_ring_of_hope");
            SILVER_RING_OF_NATURE = getRegisteredADItem("silver_ring_of_nature");
            SILVER_RING_OF_SEA = getRegisteredADItem("silver_ring_of_sea");
            SILVER_RING_OF_SKY = getRegisteredADItem("silver_ring_of_sky");
            SILVER_RING_OF_SUNLIGHT = getRegisteredADItem("silver_ring_of_sunlight");
            SILVER_RING_OF_WEALTH = getRegisteredADItem("silver_ring_of_wealth");
            SILVER_RING_OF_WIND = getRegisteredADItem("silver_ring_of_wind");
            BRONZE_RING_OF_DARKNESS = getRegisteredADItem("bronze_ring_of_darkness");
            BRONZE_RING_OF_EARTH = getRegisteredADItem("bronze_ring_of_earth");
            BRONZE_RING_OF_FIRE = getRegisteredADItem("bronze_ring_of_fire");
            BRONZE_RING_OF_GREED = getRegisteredADItem("bronze_ring_of_greed");
            BRONZE_RING_OF_HOPE = getRegisteredADItem("bronze_ring_of_hope");
            BRONZE_RING_OF_NATURE = getRegisteredADItem("bronze_ring_of_nature");
            BRONZE_RING_OF_SEA = getRegisteredADItem("bronze_ring_of_sea");
            BRONZE_RING_OF_SKY = getRegisteredADItem("bronze_ring_of_sky");
            BRONZE_RING_OF_SUNLIGHT = getRegisteredADItem("bronze_ring_of_sunlight");
            BRONZE_RING_OF_WEALTH = getRegisteredADItem("bronze_ring_of_wealth");
            BRONZE_RING_OF_WIND = getRegisteredADItem("bronze_ring_of_wind");
            MITHRIL_RING_OF_DARKNESS = getRegisteredADItem("mithril_ring_of_darkness");
            MITHRIL_RING_OF_EARTH = getRegisteredADItem("mithril_ring_of_earth");
            MITHRIL_RING_OF_FIRE = getRegisteredADItem("mithril_ring_of_fire");
            MITHRIL_RING_OF_GREED = getRegisteredADItem("mithril_ring_of_greed");
            MITHRIL_RING_OF_HOPE = getRegisteredADItem("mithril_ring_of_hope");
            MITHRIL_RING_OF_NATURE = getRegisteredADItem("mithril_ring_of_nature");
            MITHRIL_RING_OF_SEA = getRegisteredADItem("mithril_ring_of_sea");
            MITHRIL_RING_OF_SKY = getRegisteredADItem("mithril_ring_of_sky");
            MITHRIL_RING_OF_SUNLIGHT = getRegisteredADItem("mithril_ring_of_sunlight");
            MITHRIL_RING_OF_WEALTH = getRegisteredADItem("mithril_ring_of_wealth");
            MITHRIL_RING_OF_WIND = getRegisteredADItem("mithril_ring_of_wind");
            ANDURIL = getRegisteredADItem("anduril");
            MORGUL_SWORD = getRegisteredADItem("morgul_sword");
            ELVEN_LONG_SWORD = getRegisteredADItem("elven_long_sword");
            BERSERKER_SWORD = getRegisteredADItem("berserker_sword");
            TWO_HANDED_SWORD = getRegisteredADItem("two_handed_sword");
            THROWING_STONE = getRegisteredADItem("throwing_stone");
            ROHIRRIM_AXE = getRegisteredADItem("rohirrim_axe");
            ELVEN_DOOR = getRegisteredADItem("elven_door");
            Blocks.ELVEN_DOOR.setItem(ELVEN_DOOR);
            HUMAN_DOOR = getRegisteredADItem("human_door");
            Blocks.HUMAN_DOOR.setItem(HUMAN_DOOR);
            GREEN_BED = getRegisteredADItem("green_bed");
            Blocks.GREEN_BED.setItem(GREEN_BED);
            AICANAR = getRegisteredADItem("aicanar");
            BALINS_SWORD = getRegisteredADItem("balins_sword");
            BIFURS_SPEAR = getRegisteredADItem("bifurs_spear");
            BOMBURS_SPOON = getRegisteredADItem("bomburs_spoon");
            DORIS_SWORD = getRegisteredADItem("doris_sword");
            DWALINS_AXE = getRegisteredADItem("dwalins_axe");
            FILIS_KNIFE = getRegisteredADItem("filis_knife");
            FILIS_SWORD = getRegisteredADItem("filis_sword");
            KILIS_SWORD = getRegisteredADItem("kilis_sword");
            NORIS_CLUB = getRegisteredADItem("noris_club");
            OINS_STAFF = getRegisteredADItem("oins_staff");
            ORCRIST = getRegisteredADItem("orcrist");
            SWORD_OF_WESTERNESSE = getRegisteredADItem("sword_of_westernesse");
            THORINS_SWORD = getRegisteredADItem("thorins_sword");
            THRAINS_WAR_HAMMER = getRegisteredADItem("thrains_war_hammer");
            THRORS_WAR_HAMMER = getRegisteredADItem("thrors_war_hammer");
            ARAGORNS_ELF_KNIFE = getRegisteredADItem("aragorns_elf_knife");
            EOWYNS_SWORD = getRegisteredADItem("eowyns_sword");
            GANDALF_THE_GREYS_STAFF = getRegisteredADItem("gandalf_the_greys_staff");
            GANDALF_THE_WHITES_STAFF = getRegisteredADItem("gandalf_the_whites_staff");
            GIMLIS_TWO_HEADED_AXE = getRegisteredADItem("gimlis_two_headed_axe");
            GIMLIS_LONGAXE = getRegisteredADItem("gimlis_longaxe");
            GLAMDRING = getRegisteredADItem("glamdring");
            GLOINS_AXE = getRegisteredADItem("gloins_axe");
            GLORFINDELS_SWORD = getRegisteredADItem("glorfindels_sword");
            GUTHWINE = getRegisteredADItem("guthwine");
            HADHAFANG = getRegisteredADItem("hadhafang");
            LEGOLAS_SWORD = getRegisteredADItem("legolas_sword");
            RADAGASTS_STAFF = getRegisteredADItem("radagasts_staff");
            LURTZ_SWORD = getRegisteredADItem("lurtz_sword");
            SAURONS_MACE = getRegisteredADItem("saurons_mace");
            SARUMANS_STAFF = getRegisteredADItem("sarumans_staff");
            YAZNEGS_AXE = getRegisteredADItem("yaznegs_axe");
            DWARVEN_LORD_KNIFE = getRegisteredADItem("dwarven_lord_knife");
            GONDORIAN_NOBLE_SWORD = getRegisteredADItem("gondorian_noble_sword");
            MACE_OF_GLORY = getRegisteredADItem("mace_of_glory");
            GOLDEN_WAR_HAMMER_OF_EREBOR = getRegisteredADItem("golden_war_hammer_of_erebor");
            GONDORIAN_SPEAR = getRegisteredADItem("gondorian_spear");
            ROHIRRIM_SPEAR = getRegisteredADItem("rohirrim_spear");
            BULL_HEAD_MACE = getRegisteredADItem("bull_head_mace");
            CORSAIR_EKET = getRegisteredADItem("corsair_eket");
            DOL_GULDUR_SPIKED_MACE = getRegisteredADItem("dol_guldur_spiked_mace");
            FELL_WARGRIDER_SWORD = getRegisteredADItem("fell_wargrider_sword");
            HARADRIM_SNAKE_DAGGER = getRegisteredADItem("haradrim_snake_dagger");
            NORTH_GOBLIN_MACE = getRegisteredADItem("north_goblin_mace");
            NORTH_GOBLIN_SWORD = getRegisteredADItem("north_goblin_sword");
            ORC_CAPTAIN_SWORD = getRegisteredADItem("orc_captain_sword");
            ORC_DAGGER = getRegisteredADItem("orc_dagger");
            ORC_HALBARD = getRegisteredADItem("orc_halbard");
            URUK_SIEGE_TROOPER_DAGGER = getRegisteredADItem("uruk_siege_trooper_dagger");
            IRON_MACE = getRegisteredADItem("iron_mace");
            ...
            HILLMEN_DOOR = getRegisteredADItem("hillmen_door");
            Blocks.HILLMEN_DOOR.setItem(HILLMEN_DOOR);
            MORDOR_DOOR = getRegisteredADItem("mordor_door");
            Blocks.MORDOR_DOOR.setItem(MORDOR_DOOR);
            PRISON_DOOR = getRegisteredADItem("prison_door");
            Blocks.PRISON_DOOR.setItem(PRISON_DOOR);
            SINDAR_DOOR = getRegisteredADItem("sindar_door");
            Blocks.SINDAR_DOOR.setItem(SINDAR_DOOR);
            SOUTHLINCH_SEED = getRegisteredADItem("southlinch_seed");
            Blocks.SOUTHLINCH.setSeed(SOUTHLINCH_SEED);
            GREEN_GRAPE_SEED = getRegisteredADItem("green_grape_seed");
            Blocks.GREEN_GRAPE.setSeed(GREEN_GRAPE_SEED);
            GREEN_GRAPES = getRegisteredADItem("green_grapes");
            Blocks.GREEN_GRAPE.setCrop(GREEN_GRAPES);
            PURPLE_GRAPE_SEED = getRegisteredADItem("purple_grape_seed");
            Blocks.PURPLE_GRAPE.setSeed(PURPLE_GRAPE_SEED);
            PURPLE_GRAPES = getRegisteredADItem("purple_grapes");
            Blocks.PURPLE_GRAPE.setCrop(PURPLE_GRAPES);
            PIPEWEED_SEED = getRegisteredADItem("pipeweed_seed");
            Blocks.PIPEWEED_PLANT.setSeed(PIPEWEED_SEED);
            PEAS = getRegisteredADItem("peas");
            Blocks.PEA_PLANT.setSeed(PEAS);
            PEA_POD = getRegisteredADItem("pea_pod");
            Blocks.PEA_PLANT.setCrop(PEA_POD);
            LEEK = getRegisteredADItem("leek");
            Blocks.LEEK_PLANT.setCrop(LEEK);
            LEEK_SEED = getRegisteredADItem("leek_seed");
            Blocks.LEEK_PLANT.setSeed(LEEK_SEED);
            ONION_SEED = getRegisteredADItem("onion_seed");
            Blocks.ONION_PLANT.setSeed(ONION_SEED);
            ONION = getRegisteredADItem("onion");
            Blocks.ONION_PLANT.setCrop(ONION);
            OLD_TOBY_SEED = getRegisteredADItem("old_toby_seed");
            Blocks.OLD_TOBY_PLANT.setSeed(OLD_TOBY_SEED);
            SOUTHERN_STAR_SEED = getRegisteredADItem("southern_star_seed");
