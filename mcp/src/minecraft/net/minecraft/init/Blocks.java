...
public class Blocks
{
    ...
    static
    {
        ...
        else
        {
            ...
            SIMBELMYNE = getRegisteredBlock("simbelmyne");
            ...
            WINDOW = getRegisteredBlock("window");
            ...
            DWARF_FLOOR_1 = getRegisteredBlock("dwarf_floor_1");
            ...
            LOSSARNACH_DECORATION_STONE = getRegisteredBlock("lossarnach_decoration_stone");
            ...
            DWARF_FLOOR_2 = getRegisteredBlock("dwarf_floor_2");
            DWARF_FLOOR_3 = getRegisteredBlock("dwarf_floor_3");
            DWARF_FLOOR_4 = getRegisteredBlock("dwarf_floor_4");
            DWARF_FLOOR_5 = getRegisteredBlock("dwarf_floor_5");
            DWARF_FLOOR_6 = getRegisteredBlock("dwarf_floor_6");
            DWARF_FLOOR_7 = getRegisteredBlock("dwarf_floor_7");
            DWARF_FLOOR_8 = getRegisteredBlock("dwarf_floor_8");
            DWARF_FLOOR_9 = getRegisteredBlock("dwarf_floor_9");
            DWARF_KING_STONE = getRegisteredBlock("dwarf_king_stone");
            DWARVEN_KING_FLOOR_1 = getRegisteredBlock("dwarven_king_floor_1");
            DWARVEN_KING_FLOOR_2 = getRegisteredBlock("dwarven_king_floor_2");
            DWARVEN_PILLAR_DECORATION = getRegisteredBlock("dwarven_pillar_decoration");
            DWARVEN_STEEL = getRegisteredBlock("dwarven_steel");
            EREBOR_FLOOR_1 = getRegisteredBlock("erebor_floor_1");
            EREBOR_FLOOR_2 = getRegisteredBlock("erebor_floor_2");
            ...
            SINDAR_FLOOR_1 = getRegisteredBlock("sindar_floor_1");
            SINDAR_FLOOR_2 = getRegisteredBlock("sindar_floor_2");
            ...
            ELVEN_DECORATION_1 = getRegisteredBlock("elven_decoration_1");
            ELVEN_DECORATION_LIGHT = getRegisteredBlock("elven_decoration_light");
            ELVEN_DECORATION_2 = getRegisteredBlock("elven_decoration_2");
            ELVEN_DECORATION_3 = getRegisteredBlock("elven_decoration_3");
            HOBBIT_FLOOR_1 = getRegisteredBlock("hobbit_floor_1");
            HOBBIT_FLOOR_2 = getRegisteredBlock("hobbit_floor_2");
            DARK_BRICKS = getRegisteredBlock("dark_bricks");
            ROHIRRIM_CROSSBEAM = getRegisteredBlock("rohirrim_crossbeam");
            CROSSBEAM_1 = getRegisteredBlock("crossbeam_1");
            CROSSBEAM_2 = getRegisteredBlock("crossbeam_2");
            CROSSBEAM_3 = getRegisteredBlock("crossbeam_3");
            STANDARD_CROSSBEAM_1 = getRegisteredBlock("standard_crossbeam_1");
            STANDARD_CROSSBEAM_2 = getRegisteredBlock("standard_crossbeam_2");
            STANDARD_CROSSBEAM_3 = getRegisteredBlock("standard_crossbeam_3");
            ...
            HUMAN_LADDER = getRegisteredBlock("human_ladder");
            ROHIRRIM_LADDER = getRegisteredBlock("rohirrim_ladder");
            DUNLAND_LADDER = getRegisteredBlock("dunland_ladder");
