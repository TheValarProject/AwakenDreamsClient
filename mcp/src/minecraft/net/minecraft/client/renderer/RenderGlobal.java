...
public class RenderGlobal implements IWorldEventListener, IResourceManagerReloadListener
{
    ...
    {
        return this.entityOutlineFramebuffer != null && this.entityOutlineShader != null && this.mc.thePlayer != null;
    }
        ...
        else
        {
            ...
            for (RenderGlobal.ContainerLocalRenderInformation renderglobal$containerlocalrenderinformation : this.renderInfos)
            {
                ...
                if (!classinheritancemultimap.isEmpty())
                {
                    ...
                    {
                        boolean flag = this.renderManager.shouldRender(entity2, camera, d0, d1, d2) || entity2.isRidingOrBeingRiddenBy(this.mc.thePlayer);
                        ...
                        if (flag)
                        {
                            ...
                            if ((entity2 != this.mc.getRenderViewEntity() || this.mc.gameSettings.thirdPersonView != 0 || flag1) && (entity2.posY < 0.0D || entity2.posY >= 256.0D || this.theWorld.isBlockLoaded(blockpos$pooledmutableblockpos.func_189535_a(entity2))))
                            {
                                ++this.countEntitiesRendered;
        ...
        if (!flag && this.displayListEntitiesDirty)
        {
            ...
            while (!((Queue)queue).isEmpty())
            {
                ...
                for (EnumFacing enumfacing1 : EnumFacing.values())
                {
                    ...
                    if ((!flag1 || !renderglobal$containerlocalrenderinformation1.func_189560_a(enumfacing1.getOpposite())) && (!flag1 || enumfacing2 == null || renderchunk3.getCompiledChunk().isVisible(enumfacing2.getOpposite(), enumfacing1)) && renderchunk2 != null && renderchunk2.setFrameIndex(frameCount) && ((ICamera)camera).isBoundingBoxInFrustum(renderchunk2.boundingBox))
                    {
                        ...
                        renderglobal$containerlocalrenderinformation.func_189561_a(renderglobal$containerlocalrenderinformation1.setFacing, enumfacing1);
