...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void registerItems()
    {
        ...
        this.registerADBlock(Blocks.AMBER_ORE, "amber_ore");
        this.registerADBlock(Blocks.TANZANITE_ORE, "tanzanite_ore");
        this.registerADBlock(Blocks.PERMANENT_DIRT, "permanent_dirt");
        this.registerADBlock(Blocks.LUINDOL, "luindol");
        this.registerADBlock(Blocks.HOPPER_MUSHROOM, "hopper_mushroom");
        this.registerADBlock(Blocks.AMETHYST_ORE, "amethyst_ore");
        this.registerADBlock(Blocks.RUBY_ORE, "ruby_ore");
        this.registerADBlock(Blocks.ONYX_ORE, "onyx_ore");
        this.registerADBlock(Blocks.MOONSTONE_ORE, "moonstone_ore");
        this.registerADBlock(Blocks.MINAS_MORGUL_GLOWSTONE, "minas_morgul_glowstone");
        this.registerADBlock(Blocks.ARGONATH_STONE, "argonath_stone");
        this.registerADBlock(Blocks.MITHRIL_BLOCK, "mithril_block");
        this.registerADBlock(Blocks.CRYSTAL_ORE, "crystal_ore");
        this.registerADBlock(Blocks.DESERT_ROAD_BLOCK, "desert_road_block");
        this.registerADBlock(Blocks.DIRT_ROAD_BLOCK, "dirt_road_block");
        this.registerADBlock(Blocks.LIGHT_BLUE_GLOWSTONE, "light_blue_glowstone");
        this.registerADBlock(Blocks.BLACK_IRON, "black_iron");
        this.registerADBlock(Blocks.MORIA_PILLAR_STONE, "moria_pillar_stone");
        this.registerADBlock(Blocks.RUSTY_IRON, "rusty_iron");
        this.registerADBlock(Blocks.ELF_FLOOR, "elf_floor");
        this.registerADBlock(Blocks.GONDORIAN_FLOOR, "gondorian_floor");
        this.registerADBlock(Blocks.STONE_FLOOR, "stone_floor");
        this.registerADBlock(Blocks.MORIA_TRAPDOOR, "moria_trapdoor");
        this.registerADBlock(Blocks.PALM_LOG, "palm_log");
        this.registerADBlock(Blocks.SILK_STONE, "silk_stone");
        this.registerADBlock(Blocks.CRACKED_SILK_STONE, "cracked_silk_stone");
        this.registerADBlock(Blocks.STRAW, "straw");
        this.registerADBlock(Blocks.CRACKED_EARTH, "cracked_earth");
        this.registerADBlock(Blocks.BAG_END_FLOOR, "bag_end_floor");
        this.registerADBlock(Blocks.BAG_END_WALL, "bag_end_wall");
        this.registerADBlock(Blocks.BROWN_STONE, "brown_stone");
        this.registerADBlock(Blocks.MORDOR_STONE, "mordor_stone");
        this.registerADBlock(Blocks.CLIFF_BLOCK, "cliff_block");
        this.registerADBlock(Blocks.SPIDER_EGG, "spider_egg");
        this.registerADBlock(Blocks.BAKRUEL, "bakruel");
        this.registerADBlock(Blocks.HOPPERFOOT, "hopperfoot");
        this.registerADBlock(Blocks.MADARCH, "madarch");
        this.registerADBlock(Blocks.MEHAS, "mehas");
        this.registerADBlock(Blocks.ARFANDAS,  "arfandas");
        this.registerADBlock(Blocks.ATHELAS, "athelas");
        this.registerADBlock(Blocks.BELLIS, "bellis");
        this.registerADBlock(Blocks.LAMP, "lamp");
        this.registerADBlock(Blocks.GONDORIAN_STONE, "gondorian_stone");
        this.registerADBlock(Blocks.GONDORIAN_BRICK_STONE, "gondorian_brick_stone");
        this.registerADBlock(Blocks.CRACKED_GONDORIAN_BRICK_STONE, "cracked_gondorian_brick_stone");
        this.registerADBlock(Blocks.LORIEN_LAMP, "lorien_lamp");
        this.registerADBlock(Blocks.BUCKLEBURY_LAMP, "bucklebury_lamp");
        this.registerADBlock(Blocks.SALT_ORE, "salt_ore");
        this.registerADBlock(Blocks.SIMBELMYNE, "simbelmyne");
        this.registerADBlock(Blocks.SHIRE_FLOWER, "shire_flower");
        this.registerADBlock(Blocks.DARK_METAL, "dark_metal");
        this.registerADBlock(Blocks.RIVENDELL_WOOD, "rivendell_wood");
        this.registerADBlock(Blocks.MOSS, "moss");
        this.registerADBlock(Blocks.GONDORIAN_ROOF, "gondorian_roof");
        this.registerADBlock(Blocks.RIVENDELL_ROOF, "rivendell_roof");
        this.registerADBlock(Blocks.MOSSY_GONDORIAN_BRICK_STONE, "mossy_gondorian_brick_stone");
        this.registerADBlock(Blocks.WINDOW, "window");
        this.registerADBlock(Blocks.ROHAN_BRICKS, "rohan_bricks");
        this.registerADBlock(Blocks.MORDOR_BRICK_STONE, "mordor_brick_stone");
        this.registerADBlock(Blocks.MITHRIL_ORE, "mithril_ore");
        this.registerADBlock(Blocks.ARLANS_SLIPPER, "arlans_slipper");
        this.registerADBlock(Blocks.NUMENOREAN, "numenorean");
        this.registerADBlock(Blocks.DWARF_INNER_WALL_DECORATION, "dwarf_inner_wall_decoration");
        this.registerADBlock(Blocks.DALE_STONE, "dale_stone");
        this.registerADBlock(Blocks.DWARF_INNER_WALL_STONE, "dwarf_inner_wall_stone");
        this.registerADBlock(Blocks.RED_LAPIS, "red_lapis");
        this.registerADBlock(Blocks.PURPLE_LAPIS, "purple_lapis");
        this.registerADBlock(Blocks.LIGHT_BLUE_LAPIS, "light_blue_lapis");
        this.registerADBlock(Blocks.GREEN_LAPIS, "green_lapis");
        this.registerADBlock(Blocks.DWARF_WALL, "dwarf_wall");
        this.registerADBlock(Blocks.BROWN_LAPIS, "brown_lapis");
        this.registerADBlock(Blocks.DWARF_FLOOR_1, "dwarf_floor_1");
        this.registerADBlock(Blocks.DWARVEN_HALL_FLOOR, "dwarven_hall_floor");
        this.registerADBlock(Blocks.DWARF_STONE, "dwarf_stone");
        this.registerADBlock(Blocks.DWARVEN_TORCH, "dwarven_torch");
        this.registerADBlock(Blocks.DWARVEN_GOLD, "dwarven_gold");
        this.registerADBlock(Blocks.ROHAN_IRON, "rohan_iron");
        this.registerADBlock(Blocks.DARK_DWARF_STONE, "dark_dwarf_stone");
        this.registerADBlock(Blocks.MEDIUM_DARK_DWARF_STONE, "medium_dark_dwarf_stone");
        this.registerADBlock(Blocks.LIGHT_BROWN_WOOD, "light_brown_wood");
        this.registerADBlock(Blocks.OLD_TREE, "old_tree");
        this.registerADBlock(Blocks.BREE_BOOKSHELF, "bree_bookshelf");
        this.registerADBlock(Blocks.CROSS_HAY, "cross_hay");
        this.registerADBlock(Blocks.LIGHT_GREY_CIRCLE_STONE, "light_grey_circle_stone");
        this.registerADBlock(Blocks.HOBBIT_LAMP_1, "hobbit_lamp_1");
        this.registerADBlock(Blocks.HOBBIT_LAMP_2, "hobbit_lamp_2");
        this.registerADBlock(Blocks.LOSSARNACH_DECORATION_STONE, "lossarnach_decoration_stone");
        this.registerADBlock(Blocks.BREE_LAMP, "bree_lamp");
        this.registerADBlock(Blocks.ARCHET_LAMP, "archet_lamp");
        this.registerADBlock(Blocks.TOWN_MARKER, "town_marker");
        this.registerADBlock(Blocks.VILLAGE_MARKER, "village_marker");
        this.registerADBlock(Blocks.RUIN_MARKER, "ruin_marker");
        this.registerADBlock(Blocks.ELVEN_STONE_FLOOR, "elven_stone_floor");
        this.registerADBlock(Blocks.ANCIENT_STONE, "ancient_stone");
        this.registerADBlock(Blocks.BREE_STONE_BRICKS, "bree_stone_bricks");
        this.registerADBlock(Blocks.CRACKED_BREE_STONE_BRICKS, "cracked_bree_stone_bricks");
        this.registerADBlock(Blocks.MOSSY_BREE_STONE_BRICKS, "mossy_bree_stone_bricks");
        this.registerADBlock(Blocks.SHIRE_HAY, "shire_hay");
        this.registerADBlock(Blocks.BREE_OAK_PLANKS, "bree_oak_planks");
        this.registerADBlock(Blocks.BREE_SPRUCE_PLANKS, "bree_spruce_planks");
        this.registerADBlock(Blocks.BREE_BIRCH_PLANKS, "bree_birch_planks");
        this.registerADBlock(Blocks.BREE_JUNGLE_PLANKS, "bree_jungle_planks");
        this.registerADBlock(Blocks.SHIRE_PATH, "shire_path");
        this.registerADBlock(Blocks.BREE_FLOOR, "bree_floor");
        this.registerADBlock(Blocks.ARNOR_FLOOR, "arnor_floor");
        this.registerADBlock(Blocks.CARDOLAN_BRICK_STONE, "cardolan_brick_stone");
        this.registerADBlock(Blocks.ELVEN_SANDSTONE_FLOOR, "elven_sandstone_floor");
        this.registerADBlock(Blocks.DEAD_LAVA, "dead_lava");
        this.registerADBlock(Blocks.CHISELED_GONDORIAN_STONE, "chiseled_gondorian_stone");
        this.registerADBlock(Blocks.NEEDLES, "needles");
        this.registerADBlock(Blocks.RHUN_FLOOR, "rhun_floor");
        this.registerADBlock(Blocks.KHAND_FLOOR, "khand_floor");
        this.registerADBlock(Blocks.CITY_MARKER, "city_marker");
        this.registerADBlock(Blocks.RIVENDELL_FLOOR, "rivendell_floor");
        this.registerADBlock(Blocks.COLUMN, "column");
        this.registerADBlock(Blocks.COLUMN_TOP, "column_top");
        this.registerADBlock(Blocks.DWARF_BRICKS, "dwarf_bricks");
        this.registerADBlock(Blocks.DWARF_FLOOR_2, "dwarf_floor_2");
        this.registerADBlock(Blocks.DWARF_FLOOR_3, "dwarf_floor_3");
        this.registerADBlock(Blocks.DWARF_FLOOR_4, "dwarf_floor_4");
        this.registerADBlock(Blocks.DWARF_FLOOR_5, "dwarf_floor_5");
        this.registerADBlock(Blocks.DWARF_FLOOR_6, "dwarf_floor_6");
        this.registerADBlock(Blocks.DWARF_FLOOR_7, "dwarf_floor_7");
        this.registerADBlock(Blocks.DWARF_FLOOR_8, "dwarf_floor_8");
        this.registerADBlock(Blocks.DWARF_FLOOR_9, "dwarf_floor_9");
        this.registerADBlock(Blocks.DWARF_KING_STONE, "dwarf_king_stone");
        this.registerADBlock(Blocks.DWARVEN_KING_FLOOR_1, "dwarven_king_floor_1");
        this.registerADBlock(Blocks.DWARVEN_KING_FLOOR_2, "dwarven_king_floor_2");
        this.registerADBlock(Blocks.DWARVEN_PILLAR_DECORATION, "dwarven_pillar_decoration");
        this.registerADBlock(Blocks.DWARVEN_STEEL, "dwarven_steel");
        this.registerADBlock(Blocks.EREBOR_FLOOR_1, "erebor_floor_1");
        this.registerADBlock(Blocks.EREBOR_FLOOR_2, "erebor_floor_2");
        this.registerADBlock(Blocks.ERED_LUIN_STONE, "ered_luin_stone");
        this.registerADBlock(Blocks.IRON_HILLS_FLOOR, "iron_hills_floor");
        this.registerADBlock(Blocks.SMOOTH_GOLD, "smooth_gold");
        this.registerADBlock(Blocks.RIVENDELL_WALL, "rivendell_wall");
        this.registerADBlock(Blocks.SINDAR_STONE, "sindar_stone");
        this.registerADBlock(Blocks.SINDAR_FLOOR_1, "sindar_floor_1");
        this.registerADBlock(Blocks.SINDAR_FLOOR_2, "sindar_floor_2");
        this.registerADBlock(Blocks.SINDAR_DECORATION_STONE, "sindar_decoration_stone");
        this.registerADBlock(Blocks.NOLDOR_FLOOR, "noldor_floor");
        this.registerADBlock(Blocks.NOLDOR_SANDSTONE_FLOOR, "noldor_sandstone_floor");
        this.registerADBlock(Blocks.MALLORN_WOODPLANKS, "mallorn_woodplanks");
        this.registerADBlock(Blocks.LINDON_WOOD, "lindon_wood");
        this.registerADBlock(Blocks.LINDON_WALL_DECORATION, "lindon_wall_decoration");
        this.registerADBlock(Blocks.HIGH_ELF_WALL, "high_elf_wall");
        this.registerADBlock(Blocks.HARLINDON_WOOD, "harlindon_wood");
        this.registerADBlock(Blocks.FORLOND_FLOOR, "forlond_floor");
        this.registerADBlock(Blocks.FORLINDON_WOOD, "forlindon_wood");
        this.registerADBlock(Blocks.FORLINDON_WALL, "forlindon_wall");
        this.registerADBlock(Blocks.ELVEN_STONE_WALL, "elven_stone_wall");
        this.registerADBlock(Blocks.ELVEN_NOBLE_WALL, "elven_noble_wall");
        this.registerADBlock(Blocks.RIVENDELL_STATUE_BOTTOM, "rivendell_statue_bottom");
        this.registerADBlock(Blocks.ELVEN_DECORATION_1, "elven_decoration_1");
        this.registerADBlock(Blocks.ELVEN_DECORATION_LIGHT, "elven_decoration_light");
        this.registerADBlock(Blocks.ELVEN_DECORATION_2, "elven_decoration_2");
        this.registerADBlock(Blocks.ELVEN_DECORATION_3, "elven_decoration_3");
        this.registerADBlock(Blocks.HOBBIT_FLOOR_1, "hobbit_floor_1");
        this.registerADBlock(Blocks.HOBBIT_FLOOR_2, "hobbit_floor_2");
        this.registerADBlock(Blocks.DARK_BRICKS, "dark_bricks");
        this.registerADBlock(Blocks.ROHIRRIM_CROSSBEAM, "rohirrim_crossbeam");
        this.registerADBlock(Blocks.CROSSBEAM_1, "crossbeam_1");
        this.registerADBlock(Blocks.CROSSBEAM_2, "crossbeam_2");
        this.registerADBlock(Blocks.CROSSBEAM_3, "crossbeam_3");
        this.registerADBlock(Blocks.STANDARD_CROSSBEAM_1, "standard_crossbeam_1");
        this.registerADBlock(Blocks.STANDARD_CROSSBEAM_2, "standard_crossbeam_2");
        this.registerADBlock(Blocks.STANDARD_CROSSBEAM_3, "standard_crossbeam_3");
        this.registerADBlock(Blocks.VERTICAL_BEAM, "vertical_beam");
        this.registerADBlock(Blocks.VERTICAL_HORIZONTAL_BEAM, "vertical_horizontal_beam");
        this.registerADBlock(Blocks.DALE_SANDSTONE, "dale_sandstone");
        this.registerADBlock(Blocks.DALE_TILES, "dale_tiles");
        this.registerADBlock(Blocks.DALE_WALL, "dale_wall");
        this.registerADBlock(Blocks.HARAD_SANDSTONE_FLOOR, "harad_sandstone_floor");
        this.registerADBlock(Blocks.HARAD_STONE_BRICKS, "harad_stone_bricks");
        this.registerADBlock(Blocks.SANDFLOOR, "sandfloor");
        this.registerADBlock(Blocks.UMBAR_HAVEN_FLOOR, "umbar_haven_floor");
        this.registerADBlock(Blocks.UMBAR_STONE_BRICKS, "umbar_stone_bricks");
        this.registerADBlock(Blocks.UMBAR_WALL_DECORATION, "umbar_wall_decoration");
        this.registerADBlock(Blocks.KHAND_STONE_BRICKS, "khand_stone_bricks");
        this.registerADBlock(Blocks.BROWN_BRICKS, "brown_bricks");
        this.registerADBlock(Blocks.EDORAS_COBBLESTONE, "edoras_cobblestone");
        this.registerADBlock(Blocks.REINFORCED_WOOD, "reinforced_wood");
        this.registerADBlock(Blocks.MEDUSELD_WOOD, "meduseld_wood");
        this.registerADBlock(Blocks.ROHIRRIM_WALL_DECORATION, "rohirrim_wall_decoration");
        this.registerADBlock(Blocks.STATUE_HEAD, "statue_head");
        this.registerADBlock(Blocks.ROHIRRIM_OAK_PLANKS, "rohirrim_oak_planks");
        this.registerADBlock(Blocks.ROHIRRIM_SPRUCE_PLANKS, "rohirrim_spruce_planks");
        this.registerADBlock(Blocks.ROHIRRIM_BIRCH_PLANKS, "rohirrim_birch_planks");
        this.registerADBlock(Blocks.ROHIRRIM_JUNGLE_PLANKS, "rohirrim_jungle_planks");
        this.registerADBlock(Blocks.ANGMAR_FLOOR, "angmar_floor");
        this.registerADBlock(Blocks.ANGMAR_BRICKS, "angmar_bricks");
        this.registerADBlock(Blocks.BEORNING_WOOD, "beorning_wood");
        this.registerADBlock(Blocks.ANNUMINAS_DECORATION, "annuminas_decoration");
        this.registerADBlock(Blocks.ARNOR_DECORATION_JEWEL, "arnor_decoration_jewel");
        this.registerADBlock(Blocks.ARNORIAN_BRICKS, "arnorian_bricks");
        this.registerADBlock(Blocks.MINAS_TIRITH_FLOOR, "minas_tirith_floor");
        this.registerADBlock(Blocks.PELARGIR_STONE, "pelargir_stone");
        this.registerADBlock(Blocks.WHITE_COBBLESTONE, "white_cobblestone");
        this.registerADBlock(Blocks.DUNLAND_TOTEM, "dunland_totem");
        this.registerADBlock(Blocks.MIRKWOOD_WEB, "mirkwood_web");
        this.registerADBlock(Blocks.DALE_WINDOW_1, "dale_window_1");
        ...
        this.registerADBlock(Blocks.ELVEN_LAMP, "elven_lamp");
        this.registerADBlock(Blocks.CARN_DUM_LAMP, "carn_dum_lamp");
        this.registerADBlock(Blocks.BREE_TILE, "bree_tile");
        this.registerADBlock(Blocks.CITY_MARKER, "city_marker");
        this.registerADBlock(Blocks.HUMAN_TRAPDOOR, "human_trapdoor");
        this.registerADBlock(Blocks.MORDOR_TRAPDOOR, "mordor_trapdoor");
        this.registerADBlock(Blocks.KHANDISH_TRAPDOOR, "khandish_trapdoor");
        this.registerADBlock(Blocks.SINDAR_TRAPDOOR, "sindar_trapdoor");
        this.registerADBlock(Blocks.RIVERFOLK_TRAPDOOR, "riverfolk_trapdoor");
        this.registerADBlock(Blocks.FORNOST_TRAPDOOR, "fornost_trapdoor");
        this.registerADBlock(Blocks.PRISON_TRAPDOOR, "prison_trapdoor");
        this.registerADBlock(Blocks.CANDLE, "candle");
        this.registerADBlock(Blocks.HUMAN_LADDER, "human_ladder");
        this.registerADBlock(Blocks.ROHIRRIM_LADDER, "rohirrim_ladder");
        this.registerADBlock(Blocks.DUNLAND_LADDER, "dunland_ladder");
        this.registerADBlock(Blocks.BUSH, "bush");
        this.registerADBlock(Blocks.ALT_DEAD_BUSH, "alt_dead_bush");
        this.registerADBlock(Blocks.CURSED_PLANT, "cursed_plant");
        this.registerADBlock(Blocks.HARADWAITH_FERN, "haradwaith_fern");
        this.registerADBlock(Blocks.LORILENDEL, "lorilendel");
        this.registerADBlock(Blocks.STAKES, "stakes");
        this.registerADBlock(Blocks.SHIRE_GARDEN_FLOWER,  "shire_garden_flower");
        this.registerADBlock(Blocks.PILE_OF_COINS, "pile_of_coins");
        this.registerADBlock(Blocks.GREY_COLUMN, "grey_column");
        this.registerADBlock(Blocks.GREY_COLUMN_TOP, "grey_column_top");
        this.registerADBlock(Blocks.COLUMN_TOP_DECORATION, "column_top_decoration");
        this.registerADBlock(Blocks.MEDUSELD_PILLAR, "meduseld_pillar");
        this.registerADBlock(Blocks.DIAGONAL_BRICKS, "diagonal_bricks");
        this.registerADBlock(Blocks.BELL, "bell");
        this.registerADBlock(Blocks.CUSTOM_CRAFTING_TABLE, BlockCustomWorkbench.EnumType.ELVEN.getMetadata(), "elven_crafting_table");
        this.registerADBlock(Blocks.CUSTOM_CRAFTING_TABLE, BlockCustomWorkbench.EnumType.HUMAN.getMetadata(), "human_crafting_table");
        this.registerADBlock(Blocks.CUSTOM_CRAFTING_TABLE, BlockCustomWorkbench.EnumType.GONDORIAN.getMetadata(), "gondorian_crafting_table");
        this.registerADBlock(Blocks.CUSTOM_CRAFTING_TABLE, BlockCustomWorkbench.EnumType.ROHIRRIM.getMetadata(), "rohirrim_crafting_table");
        this.registerADBlock(Blocks.CUSTOM_CRAFTING_TABLE, BlockCustomWorkbench.EnumType.HOBBIT.getMetadata(), "hobbit_crafting_table");
        this.registerADBlock(Blocks.CUSTOM_CRAFTING_TABLE, BlockCustomWorkbench.EnumType.MORDOR.getMetadata(), "mordor_crafting_table");
        this.registerADBlock(Blocks.CUSTOM_CRAFTING_TABLE, BlockCustomWorkbench.EnumType.ISENGARD.getMetadata(), "isengard_crafting_table");
        this.registerADBlock(Blocks.CUSTOM_CRAFTING_TABLE, BlockCustomWorkbench.EnumType.GOBLIN.getMetadata(), "goblin_crafting_table");
        this.registerADBlock(Blocks.CUSTOM_CRAFTING_TABLE, BlockCustomWorkbench.EnumType.DWARVEN.getMetadata(), "dwarven_crafting_table");
        this.registerADBlock(Blocks.WATER_WHEEL, "water_wheel");
        // End Awaken Dreams code
        ...
        // Begin Awaken Dreams code
        this.registerADItem(Items.LEMBAS, "lembas");
        this.registerADItem(Items.MITHRIL_INGOT, "mithril_ingot");
        this.registerADItem(Items.BRONZE_INGOT, "bronze_ingot");
        ...
        this.registerADItem(Items.AMETHYST, "amethyst");
        this.registerADItem(Items.ONYX, "onyx");
        this.registerADItem(Items.MOONSTONE, "moonstone");
        this.registerADItem(Items.TANZANITE, "tanzanite");
        this.registerADItem(Items.URUK_SWORD, "uruk_sword");
        this.registerADItem(Items.TOMATO, "tomato");
        this.registerADItem(Items.BLUE_FEATHER, "blue_feather");
        this.registerADItem(Items.SPIDER_POISON, "spider_poison");
        this.registerADItem(Items.HERUGRIM, "herugrim");
        this.registerADItem(Items.NUTS, "nuts");
        this.registerADItem(Items.CORN_COB, "corn_cob");
        this.registerADItem(Items.STAFF_BASE, "staff_base");
        this.registerADItem(Items.KNIFE, "knife");
        this.registerADItem(Items.BERRIES, "berries");
        this.registerADItem(Items.BEAR_CLAW, "bear_claw");
        this.registerADItem(Items.BEAST_SKIN, "beast_skin");
        this.registerADItem(Items.DEAD_ROOT, "dead_root");
        this.registerADItem(Items.EAGLE_FEATHER, "eagle_feather");
        this.registerADItem(Items.GOBLIN_EYE, "goblin_eye");
        this.registerADItem(Items.HELEGROG_DEAMON_HEART, "helegrog_deamon_heart");
        this.registerADItem(Items.ORC_BLOOD, "orc_blood");
        this.registerADItem(Items.OWL_FEATHER, "owl_feather");
        this.registerADItem(Items.SCORPION_TAIL, "scorpion_tail");
        this.registerADItem(Items.SHARK_TOOTH, "shark_tooth");
        this.registerADItem(Items.TROLL_SKIN, "troll_skin");
        this.registerADItem(Items.WARG_FANG, "warg_fang");
        this.registerADItem(Items.BLUE_BED, "blue_bed");
        this.registerADItem(Items.BROWN_BED, "brown_bed");
        this.registerADItem(Items.BREE_DOOR, "bree_door");
        this.registerADItem(Items.RUCKSACK, "rucksack");
        this.registerADItem(Items.CRAM, "cram");
        this.registerADItem(Items.CABBAGE, "cabbage");
        this.registerADItem(Items.COCONUT, "coconut");
        this.registerADItem(Items.RAW_DEER_MEAT, "raw_deer_meat");
        this.registerADItem(Items.COOKED_DEER_MEAT, "cooked_deer_meat");
        this.registerADItem(Items.MUFFIN, "muffin");
        this.registerADItem(Items.STRAWBERRY, "strawberry");
        this.registerADItem(Items.STRAWBERRY_MUFFIN, "strawberry_muffin");
        this.registerADItem(Items.ORANGE, "orange");
        this.registerADItem(Items.ORANGE_MUFFIN, "orange_muffin");
        this.registerADItem(Items.PEAR, "pear");
        this.registerADItem(Items.RAW_MEAT, "raw_meat");
        this.registerADItem(Items.COOKED_MEAT, "cooked_meat");
        this.registerADItem(Items.ROHAN_HELMET_1, "rohan_helmet_1");
        this.registerADItem(Items.ROHAN_HELMET_2, "rohan_helmet_2");
        this.registerADItem(Items.ROHAN_HELMET_3, "rohan_helmet_3");
        this.registerADItem(Items.ROHAN_HELMET_4, "rohan_helmet_4");
        this.registerADItem(Items.ROHAN_HELMET_5, "rohan_helmet_5");
        ...
        this.registerADItem(Items.STONE_OF_GREED, "stone_of_greed");
        this.registerADItem(Items.STONE_OF_HOPE, "stone_of_hope");
        this.registerADItem(Items.STONE_OF_NATURE, "stone_of_nature");
        this.registerADItem(Items.STONE_OF_SUNLIGHT, "stone_of_sunlight");
        this.registerADItem(Items.STONE_OF_SEA, "stone_of_sea");
        this.registerADItem(Items.STONE_OF_SKY, "stone_of_sky");
        this.registerADItem(Items.STONE_OF_WEALTH, "stone_of_wealth");
        this.registerADItem(Items.STONE_OF_WIND, "stone_of_wind");
        this.registerADItem(Items.HAMMER, "hammer");
        this.registerADItem(Items.GOLD_RING, "gold_ring");
        this.registerADItem(Items.ONYX_GOLD_RING, "onyx_gold_ring");
        this.registerADItem(Items.TANZANITE_GOLD_RING, "tanzanite_gold_ring");
        this.registerADItem(Items.JADE_GOLD_RING, "jade_gold_ring");
        this.registerADItem(Items.MOONSTONE_GOLD_RING, "moonstone_gold_ring");
        this.registerADItem(Items.AMETHYST_GOLD_RING, "amethyst_gold_ring");
        this.registerADItem(Items.RUBY_GOLD_RING, "ruby_gold_ring");
        this.registerADItem(Items.QUARTZ_GOLD_RING, "quartz_gold_ring");
        this.registerADItem(Items.AMBER_GOLD_RING, "amber_gold_ring");
        this.registerADItem(Items.SILVER_RING, "silver_ring");
        this.registerADItem(Items.ONYX_SILVER_RING, "onyx_silver_ring");
        this.registerADItem(Items.TANZANITE_SILVER_RING, "tanzanite_silver_ring");
        this.registerADItem(Items.JADE_SILVER_RING, "jade_silver_ring");
        this.registerADItem(Items.MOONSTONE_SILVER_RING, "moonstone_silver_ring");
        this.registerADItem(Items.AMETHYST_SILVER_RING, "amethyst_silver_ring");
        this.registerADItem(Items.RUBY_SILVER_RING, "ruby_silver_ring");
        this.registerADItem(Items.QUARTZ_SILVER_RING, "quartz_silver_ring");
        this.registerADItem(Items.AMBER_SILVER_RING, "amber_silver_ring");
        this.registerADItem(Items.BRONZE_RING, "bronze_ring");
        this.registerADItem(Items.ONYX_BRONZE_RING, "onyx_bronze_ring");
        this.registerADItem(Items.TANZANITE_BRONZE_RING, "tanzanite_bronze_ring");
        this.registerADItem(Items.JADE_BRONZE_RING, "jade_bronze_ring");
        this.registerADItem(Items.MOONSTONE_BRONZE_RING, "moonstone_bronze_ring");
        this.registerADItem(Items.AMETHYST_BRONZE_RING, "amethyst_bronze_ring");
        this.registerADItem(Items.RUBY_BRONZE_RING, "ruby_bronze_ring");
        this.registerADItem(Items.QUARTZ_BRONZE_RING, "quartz_bronze_ring");
        this.registerADItem(Items.AMBER_BRONZE_RING, "amber_bronze_ring");
        this.registerADItem(Items.MITHRIL_RING, "mithril_ring");
        this.registerADItem(Items.ONYX_MITHRIL_RING, "onyx_mithril_ring");
        this.registerADItem(Items.TANZANITE_MITHRIL_RING, "tanzanite_mithril_ring");
        this.registerADItem(Items.JADE_MITHRIL_RING, "jade_mithril_ring");
        this.registerADItem(Items.MOONSTONE_MITHRIL_RING, "moonstone_mithril_ring");
        this.registerADItem(Items.AMETHYST_MITHRIL_RING, "amethyst_mithril_ring");
        this.registerADItem(Items.RUBY_MITHRIL_RING, "ruby_mithril_ring");
        this.registerADItem(Items.QUARTZ_MITHRIL_RING, "quartz_mithril_ring");
        this.registerADItem(Items.AMBER_MITHRIL_RING, "amber_mithril_ring");
        this.registerADItem(Items.SALT, "salt");
        this.registerADItem(Items.NOLDOR_CHESTPLATE, "noldor_chestplate");
        this.registerADItem(Items.SILVER_INGOT, "silver_ingot");
        this.registerADItem(Items.DWARF_DOOR, "dwarf_door");
        ...
        this.registerADItem(Items.BATTLE_PICKAXE, "battle_pickaxe");
        this.registerADItem(Items.SHIRRIFF_CLUB, "shirriff_club");
        ...
        this.registerADItem(Items.GOLD_RING_OF_FIRE, "gold_ring_of_fire");
        this.registerADItem(Items.GOLD_RING_OF_GREED, "gold_ring_of_greed");
        this.registerADItem(Items.GOLD_RING_OF_HOPE, "gold_ring_of_hope");
        this.registerADItem(Items.GOLD_RING_OF_NATURE, "gold_ring_of_nature");
        this.registerADItem(Items.GOLD_RING_OF_SEA, "gold_ring_of_sea");
        this.registerADItem(Items.GOLD_RING_OF_SKY, "gold_ring_of_sky");
        this.registerADItem(Items.GOLD_RING_OF_SUNLIGHT, "gold_ring_of_sunlight");
        this.registerADItem(Items.GOLD_RING_OF_WEALTH, "gold_ring_of_wealth");
        this.registerADItem(Items.GOLD_RING_OF_WIND, "gold_ring_of_wind");
        this.registerADItem(Items.SILVER_RING_OF_DARKNESS, "silver_ring_of_darkness");
        this.registerADItem(Items.SILVER_RING_OF_EARTH, "silver_ring_of_earth");
        this.registerADItem(Items.SILVER_RING_OF_FIRE, "silver_ring_of_fire");
        this.registerADItem(Items.SILVER_RING_OF_GREED, "silver_ring_of_greed");
        this.registerADItem(Items.SILVER_RING_OF_HOPE, "silver_ring_of_hope");
        this.registerADItem(Items.SILVER_RING_OF_NATURE, "silver_ring_of_nature");
        this.registerADItem(Items.SILVER_RING_OF_SEA, "silver_ring_of_sea");
        this.registerADItem(Items.SILVER_RING_OF_SKY, "silver_ring_of_sky");
        this.registerADItem(Items.SILVER_RING_OF_SUNLIGHT, "silver_ring_of_sunlight");
        this.registerADItem(Items.SILVER_RING_OF_WEALTH, "silver_ring_of_wealth");
        this.registerADItem(Items.SILVER_RING_OF_WIND, "silver_ring_of_wind");
        this.registerADItem(Items.BRONZE_RING_OF_DARKNESS, "bronze_ring_of_darkness");
        this.registerADItem(Items.BRONZE_RING_OF_EARTH, "bronze_ring_of_earth");
        this.registerADItem(Items.BRONZE_RING_OF_FIRE, "bronze_ring_of_fire");
        this.registerADItem(Items.BRONZE_RING_OF_GREED, "bronze_ring_of_greed");
        this.registerADItem(Items.BRONZE_RING_OF_HOPE, "bronze_ring_of_hope");
        this.registerADItem(Items.BRONZE_RING_OF_NATURE, "bronze_ring_of_nature");
        this.registerADItem(Items.BRONZE_RING_OF_SEA, "bronze_ring_of_sea");
        this.registerADItem(Items.BRONZE_RING_OF_SKY, "bronze_ring_of_sky");
        this.registerADItem(Items.BRONZE_RING_OF_SUNLIGHT, "bronze_ring_of_sunlight");
        this.registerADItem(Items.BRONZE_RING_OF_WEALTH, "bronze_ring_of_wealth");
        this.registerADItem(Items.BRONZE_RING_OF_WIND, "bronze_ring_of_wind");
        this.registerADItem(Items.MITHRIL_RING_OF_DARKNESS, "mithril_ring_of_darkness");
        this.registerADItem(Items.MITHRIL_RING_OF_EARTH, "mithril_ring_of_earth");
        this.registerADItem(Items.MITHRIL_RING_OF_FIRE, "mithril_ring_of_fire");
        this.registerADItem(Items.MITHRIL_RING_OF_GREED, "mithril_ring_of_greed");
        this.registerADItem(Items.MITHRIL_RING_OF_HOPE, "mithril_ring_of_hope");
        this.registerADItem(Items.MITHRIL_RING_OF_NATURE, "mithril_ring_of_nature");
        this.registerADItem(Items.MITHRIL_RING_OF_SEA, "mithril_ring_of_sea");
        this.registerADItem(Items.MITHRIL_RING_OF_SKY, "mithril_ring_of_sky");
        this.registerADItem(Items.MITHRIL_RING_OF_SUNLIGHT, "mithril_ring_of_sunlight");
        this.registerADItem(Items.MITHRIL_RING_OF_WEALTH, "mithril_ring_of_wealth");
        this.registerADItem(Items.MITHRIL_RING_OF_WIND, "mithril_ring_of_wind");
        this.registerADItem(Items.ANDURIL, "anduril");
        this.registerADItem(Items.MORGUL_SWORD, "morgul_sword");
        this.registerADItem(Items.ELVEN_LONG_SWORD, "elven_long_sword");
        this.registerADItem(Items.BERSERKER_SWORD, "berserker_sword");
        this.registerADItem(Items.TWO_HANDED_SWORD, "two_handed_sword");
        this.registerADItem(Items.THROWING_STONE, "throwing_stone");
        this.registerADItem(Items.ROHIRRIM_AXE, "rohirrim_axe");
        this.registerADItem(Items.ELVEN_DOOR, "elven_door");
        this.registerADItem(Items.HUMAN_DOOR, "human_door");
        this.registerADItem(Items.GREEN_BED, "green_bed");
        this.registerADItem(Items.AICANAR, "aicanar");
        this.registerADItem(Items.BALINS_SWORD, "balins_sword");
        this.registerADItem(Items.BIFURS_SPEAR, "bifurs_spear");
        this.registerADItem(Items.BOMBURS_SPOON, "bomburs_spoon");
        this.registerADItem(Items.DORIS_SWORD, "doris_sword");
        this.registerADItem(Items.DWALINS_AXE, "dwalins_axe");
        this.registerADItem(Items.FILIS_KNIFE, "filis_knife");
        this.registerADItem(Items.FILIS_SWORD, "filis_sword");
        this.registerADItem(Items.KILIS_SWORD, "kilis_sword");
        this.registerADItem(Items.NORIS_CLUB, "noris_club");
        this.registerADItem(Items.OINS_STAFF, "oins_staff");
        this.registerADItem(Items.ORCRIST, "orcrist");
        this.registerADItem(Items.SWORD_OF_WESTERNESSE, "sword_of_westernesse");
        this.registerADItem(Items.THORINS_SWORD, "thorins_sword");
        this.registerADItem(Items.THRAINS_WAR_HAMMER, "thrains_war_hammer");
        this.registerADItem(Items.THRORS_WAR_HAMMER, "thrors_war_hammer");
        this.registerADItem(Items.ARAGORNS_ELF_KNIFE, "aragorns_elf_knife");
        this.registerADItem(Items.EOWYNS_SWORD, "eowyns_sword");
        this.registerADItem(Items.GANDALF_THE_GREYS_STAFF, "gandalf_the_greys_staff");
        this.registerADItem(Items.GANDALF_THE_WHITES_STAFF, "gandalf_the_whites_staff");
        this.registerADItem(Items.GIMLIS_TWO_HEADED_AXE, "gimlis_two_headed_axe");
        this.registerADItem(Items.GIMLIS_LONGAXE, "gimlis_longaxe");
        this.registerADItem(Items.GLAMDRING, "glamdring");
        this.registerADItem(Items.GLOINS_AXE, "gloins_axe");
        this.registerADItem(Items.GLORFINDELS_SWORD, "glorfindels_sword");
        this.registerADItem(Items.GUTHWINE, "guthwine");
        this.registerADItem(Items.HADHAFANG, "hadhafang");
        this.registerADItem(Items.LEGOLAS_SWORD, "legolas_sword");
        this.registerADItem(Items.RADAGASTS_STAFF, "radagasts_staff");
        this.registerADItem(Items.LURTZ_SWORD, "lurtz_sword");
        this.registerADItem(Items.SAURONS_MACE, "saurons_mace");
        this.registerADItem(Items.SARUMANS_STAFF, "sarumans_staff");
        this.registerADItem(Items.YAZNEGS_AXE, "yaznegs_axe");
        this.registerADItem(Items.DWARVEN_LORD_KNIFE, "dwarven_lord_knife");
        this.registerADItem(Items.GONDORIAN_NOBLE_SWORD, "gondorian_noble_sword");
        this.registerADItem(Items.MACE_OF_GLORY, "mace_of_glory");
        this.registerADItem(Items.GOLDEN_WAR_HAMMER_OF_EREBOR, "golden_war_hammer_of_erebor");
        this.registerADItem(Items.GONDORIAN_SPEAR, "gondorian_spear");
        this.registerADItem(Items.ROHIRRIM_SPEAR, "rohirrim_spear");
        this.registerADItem(Items.BULL_HEAD_MACE, "bull_head_mace");
        this.registerADItem(Items.CORSAIR_EKET, "corsair_eket");
        this.registerADItem(Items.DOL_GULDUR_SPIKED_MACE, "dol_guldur_spiked_mace");
        this.registerADItem(Items.FELL_WARGRIDER_SWORD, "fell_wargrider_sword");
        this.registerADItem(Items.HARADRIM_SNAKE_DAGGER, "haradrim_snake_dagger");
        this.registerADItem(Items.NORTH_GOBLIN_MACE, "north_goblin_mace");
        this.registerADItem(Items.NORTH_GOBLIN_SWORD, "north_goblin_sword");
        this.registerADItem(Items.ORC_CAPTAIN_SWORD, "orc_captain_sword");
        this.registerADItem(Items.ORC_DAGGER, "orc_dagger");
        this.registerADItem(Items.ORC_HALBARD, "orc_halbard");
        this.registerADItem(Items.URUK_SIEGE_TROOPER_DAGGER, "uruk_siege_trooper_dagger");
        this.registerADItem(Items.IRON_MACE, "iron_mace");
        this.registerADItem(Items.ORC_SWORD_3, "orc_sword_3");
        this.registerADItem(Items.MORANNON_DAGGER, "morannon_dagger");
        this.registerADItem(Items.ORC_SPEAR, "orc_spear");
        this.registerADItem(Items.CASTLE_DOOR, "castle_door");
        this.registerADItem(Items.DOL_GULDUR_PRISON_DOOR, "dol_guldur_prison_door");
        this.registerADItem(Items.HILLMEN_DOOR, "hillmen_door");
        this.registerADItem(Items.MORDOR_DOOR, "mordor_door");
        this.registerADItem(Items.PRISON_DOOR, "prison_door");
        this.registerADItem(Items.SINDAR_DOOR, "sindar_door");
        this.registerADItem(Items.SOUTHLINCH_SEED, "southlinch_seed");
        this.registerADItem(Items.GREEN_GRAPE_SEED, "green_grape_seed");
        this.registerADItem(Items.GREEN_GRAPES, "green_grapes");
        this.registerADItem(Items.PURPLE_GRAPE_SEED, "purple_grape_seed");
        this.registerADItem(Items.PURPLE_GRAPES, "purple_grapes");
        this.registerADItem(Items.PIPEWEED_SEED, "pipeweed_seed");
        this.registerADItem(Items.PEAS, "peas");
        this.registerADItem(Items.PEA_POD, "pea_pod");
        this.registerADItem(Items.LEEK, "leek");
        this.registerADItem(Items.LEEK_SEED, "leek_seed");
        this.registerADItem(Items.ONION_SEED, "onion_seed");
        this.registerADItem(Items.ONION, "onion");
