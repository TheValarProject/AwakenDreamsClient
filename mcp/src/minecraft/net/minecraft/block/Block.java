...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(599, "hobbit_lamp_1", (new Block3D(Material.GLASS, Arrays.asList(new AxisAlignedBB(4.0 / 16, 0.0D, 4.0 / 16, 12.0 / 16, 1.0D, 12.0 / 16)))).setUnlocalizedName("hobbitLamp1").setCreativeTab(CreativeTabs.DECORATIONS).setLightLevel(1.0F));
        registerBlock(600, "hobbit_lamp_2", (new Block3D(Material.GLASS, Arrays.asList(new AxisAlignedBB(4.0 / 16, 0.0D, 4.0 / 16, 12.0 / 16, 1.0D, 12.0 / 16)))).setUnlocalizedName("hobbitLamp2").setCreativeTab(CreativeTabs.DECORATIONS).setLightLevel(1.0F));
