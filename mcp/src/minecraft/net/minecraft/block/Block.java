...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(500, "jade_ore", (new BlockCustomOre()).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oreJade").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
        registerBlock(501, "amber_ore", (new BlockCustomOre()).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oreAmber").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
        registerBlock(502, "tanzanite_ore", (new BlockCustomOre()).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oreTanzanite").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
        ...
        registerBlock(506, "amethyst_ore", (new BlockCustomOre()).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oreAmethyst").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
        ...
        registerBlock(508, "onyx_ore", (new BlockCustomOre()).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oreOnyx").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
        registerBlock(509, "moonstone_ore", (new BlockCustomOre()).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oreMoonstone").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
        ...
        registerBlock(516, "crystal_ore", (new BlockCustomOre()).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oreCrystal").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
        ...
        registerBlock(557, "salt_ore", (new BlockCustomOre()).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oreSalt").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
        ...
        registerBlock(571, "mithril_ore", (new BlockCustomOre()).setHardness(6.0F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oreMithril").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
