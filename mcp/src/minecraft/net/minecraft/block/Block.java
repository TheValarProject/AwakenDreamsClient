...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(534, "silk_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("silkStone").setBlockTextureName("silk_stone"));
        registerBlock(535, "cracked_silk_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("crackedSilkStone").setBlockTextureName("cracked_silk_stone"));
        registerBlock(536, "straw", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("straw").setBlockTextureName("straw"));
        registerBlock(537, "cracked_earth", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("crackedEarth").setBlockTextureName("cracked_earth"));
        registerBlock(538, "bag_end_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("bagEndFloor").setBlockTextureName("bag_end_floor"));
        registerBlock(539, "bag_end_wall", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("bagEndWall").setBlockTextureName("bag_end_wall"));
        registerBlock(540, "brown_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("brownStone").setBlockTextureName("brown_stone"));
        registerBlock(541, "mordor_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("mordorStone").setBlockTextureName("mordor_stone"));
        registerBlock(542, "cliff_block", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("cliffBlock").setBlockTextureName("cliff_block"));
        registerBlock(543, "spider_egg", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("spiderEgg").setBlockTextureName("spider_egg"));
        ...
        registerBlock(552, "gondorian_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("gondorianStone").setBlockTextureName("gondorian_stone"));
        registerBlock(553, "gondorian_brick_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("gondorianBrickStone").setBlockTextureName("gondorian_brick_stone"));
        registerBlock(554, "cracked_gondorian_brick_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("crackedGondorianBrickStone").setBlockTextureName("cracked_gondorian_brick_stone"));
        ...
        registerBlock(557, "salt_ore", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("saltOre").setBlockTextureName("salt_ore"));
        ...
        registerBlock(561, "dark_metal", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("darkMetal").setBlockTextureName("dark_metal"));
        registerBlock(562, "rivendell_wood", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rivendellWood").setBlockTextureName("rivendell_wood"));
        registerBlock(563, "moss", (new Block(Material.plants)).setHardness(0.3F).setSoundType(soundTypeGrass).setUnlocalizedName("moss").setBlockTextureName("moss"));
        registerBlock(564, "gondorian_roof", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("gondorianRoof").setBlockTextureName("gondorian_roof"));
        registerBlock(565, "rivendell_roof", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rivendellRoof").setBlockTextureName("rivendell_roof"));
        registerBlock(566, "mossy_gondorian_brick_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("mossyGondorianBrickStone").setBlockTextureName("mossy_gondorian_brick_stone"));
        ...
        registerBlock(569, "rohan_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rohanBricks").setBlockTextureName("rohan_bricks"));
        registerBlock(570, "mordor_brick_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("mordorBrickStone").setBlockTextureName("mordor_brick_stone"));
        registerBlock(571, "mithril_ore", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("mithrilOre").setBlockTextureName("mithril_ore"));
        ...
        registerBlock(574, "numenorean", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("numenorean").setBlockTextureName("numenorean"));
        registerBlock(575, "dwarf_inner_wall_decoration", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfInnerWallDecoration").setBlockTextureName("dwarf_inner_wall_decoration"));
        registerBlock(576, "dale_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("daleStone").setBlockTextureName("dale_stone"));
        registerBlock(577, "dwarf_inner_wall_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfInnerWallStone").setBlockTextureName("dwarf_inner_wall_stone"));
        registerBlock(578, "red_lapis", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("redLapis").setBlockTextureName("red_lapis"));
        registerBlock(579, "purple_lapis", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("purpleLapis").setBlockTextureName("purple_lapis"));
        registerBlock(580, "light_blue_lapis", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("lightBlueLapis").setBlockTextureName("light_blue_lapis"));
        registerBlock(581, "green_lapis", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("greenLapis").setBlockTextureName("green_lapis"));
        registerBlock(582, "dwarf_wall", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfWall").setBlockTextureName("dwarf_wall"));
        registerBlock(583, "brown_lapis", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("brownLapis").setBlockTextureName("brown_lapis"));
        registerBlock(584, "dwarf_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfFloor").setBlockTextureName("dwarf_floor"));
        registerBlock(585, "dwarven_hall_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarvenHallFloor").setBlockTextureName("dwarven_hall_floor"));
        registerBlock(586, "dwarf_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfStone").setBlockTextureName("dwarf_stone"));
        ...
        registerBlock(588, "dwarven_gold", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarvenGold").setBlockTextureName("dwarven_gold"));
        registerBlock(589, "rohan_iron", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rohanIron").setBlockTextureName("rohan_iron"));
        registerBlock(590, "dark_dwarf_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("darkDwarfStone").setBlockTextureName("dark_dwarf_stone"));
        registerBlock(591, "medium_dark_dwarf_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("mediumDarkDwarfStone").setBlockTextureName("medium_dark_dwarf_stone"));
        ...
        registerBlock(595, "old_tree", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("oldTree").setBlockTextureName("old_tree"));
        ...
        registerBlock(597, "cross_hay", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("crossHay").setBlockTextureName("cross_hay"));
        registerBlock(598, "light_grey_circle_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("lightGreyCircleStone").setBlockTextureName("light_grey_circle_stone"));
        ...
        registerBlock(601, "lossarnarch_decoration_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("lossarnarchDecorationStone").setBlockTextureName("lossarnarch_decoration_stone"));
        ...
        registerBlock(609, "elven_stone_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("elvenStoneFloor").setBlockTextureName("elven_stone_floor"));
        registerBlock(610, "ancient_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("ancientStone").setBlockTextureName("ancient_stone"));
        registerBlock(611, "bree_stone_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("breeStoneBricks").setBlockTextureName("bree_stone_bricks"));
        registerBlock(612, "cracked_bree_stone_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("crackedBreeStoneBricks").setBlockTextureName("cracked_bree_stone_bricks"));
        registerBlock(613, "mossy_bree_stone_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("mossyBreeStoneBricks").setBlockTextureName("mossy_bree_stone_bricks"));
        registerBlock(614, "shire_hay", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("shireHay").setBlockTextureName("shire_hay"));
        ...
        registerBlock(619, "shire_path", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("shirePath").setBlockTextureName("shire_path"));
        registerBlock(620, "bree_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("breeFloor").setBlockTextureName("bree_floor"));
        registerBlock(621, "arnor_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("arnorFloor").setBlockTextureName("arnor_floor"));
        registerBlock(622, "cardolan_brick_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("cardolanBrickStone").setBlockTextureName("cardolan_brick_stone"));
        registerBlock(623, "elven_sandstone_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("elvenSandstoneFloor").setBlockTextureName("elven_sandstone_floor"));
        registerBlock(624, "dead_lava", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("deadLava").setBlockTextureName("dead_lava"));
        registerBlock(625, "chiseled_gondorian_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("chiseledGondorianStone").setBlockTextureName("chiseled_gondorian_stone"));
        registerBlock(626, "needles", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("needles").setBlockTextureName("needles"));
        registerBlock(627, "rhun_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rhunFloor").setBlockTextureName("rhun_floor"));
        registerBlock(628, "khand_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("khandFloor").setBlockTextureName("khand_floor"));
        registerBlock(629, "hobbit_window", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("hobbitWindow").setBlockTextureName("hobbit_window"));
        ...
        registerBlock(632, "rivendell_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rivendellFloor").setBlockTextureName("rivendell_floor"));
        registerBlock(633, "column", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("column").setBlockTextureName("column"));
        ...
        registerBlock(635, "dwarf_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfBricks").setBlockTextureName("dwarf_bricks"));
        registerBlock(636, "dwarf_floor2", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfFloor2").setBlockTextureName("dwarf_floor2"));
        registerBlock(637, "dwarf_floor3", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfFloor3").setBlockTextureName("dwarf_floor3"));
        registerBlock(638, "dwarf_floor4", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfFloor4").setBlockTextureName("dwarf_floor4"));
        registerBlock(639, "dwarf_floor5", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfFloor5").setBlockTextureName("dwarf_floor5"));
        registerBlock(640, "dwarf_floor6", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfFloor6").setBlockTextureName("dwarf_floor6"));
        registerBlock(641, "dwarf_floor7", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfFloor7").setBlockTextureName("dwarf_floor7"));
        registerBlock(642, "dwarf_floor8", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfFloor8").setBlockTextureName("dwarf_floor8"));
        registerBlock(643, "dwarf_floor9", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfFloor9").setBlockTextureName("dwarf_floor9"));
        registerBlock(644, "dwarf_king_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarfKingStone").setBlockTextureName("dwarf_king_stone"));
        registerBlock(645, "dwarven_king_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarvenKingFloor").setBlockTextureName("dwarven_king_floor"));
        registerBlock(646, "dwarven_king_floor2", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarvenKingFloor2").setBlockTextureName("dwarven_king_floor2"));
        registerBlock(647, "dwarven_pillar_decoration", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarvenPillarDecoration").setBlockTextureName("dwarven_pillar_decoration"));
        registerBlock(648, "dwarven_steel", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dwarvenSteel").setBlockTextureName("dwarven_steel"));
        registerBlock(649, "erebor_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("ereborFloor").setBlockTextureName("erebor_floor"));
        registerBlock(650, "erebor_floor2", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("ereborFloor2").setBlockTextureName("erebor_floor2"));
        registerBlock(651, "ered_luin_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("eredLuinStone").setBlockTextureName("ered_luin_stone"));
        registerBlock(652, "iron_hills_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("ironHillsFloor").setBlockTextureName("iron_hills_floor"));
        registerBlock(653, "smooth_gold", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("smoothGold").setBlockTextureName("smooth_gold"));
        registerBlock(654, "rivendell_wall", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rivendellWall").setBlockTextureName("rivendell_wall"));
        registerBlock(655, "sindar_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("sindarStone").setBlockTextureName("sindar_stone"));
        registerBlock(656, "sindar_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("sindarFloor").setBlockTextureName("sindar_floor"));
        registerBlock(657, "sindar_floor2", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("sindarFloor2").setBlockTextureName("sindar_floor2"));
        registerBlock(658, "sindar_decoration_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("sindarDecorationStone").setBlockTextureName("sindar_decoration_stone"));
        registerBlock(659, "noldor_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("noldorFloor").setBlockTextureName("noldor_floor"));
        registerBlock(660, "noldor_sandstone_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("noldorSandstoneFloor").setBlockTextureName("noldor_sandstone_floor"));
        registerBlock(661, "mallorn_woodplanks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("mallornWoodplanks").setBlockTextureName("mallorn_woodplanks"));
        registerBlock(662, "lindon_wood", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("lindonWood").setBlockTextureName("lindon_wood"));
        registerBlock(663, "lindon_wall_decoration", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("lindonWallDecoration").setBlockTextureName("lindon_wall_decoration"));
        registerBlock(664, "high_elf_wall", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("highElfWall").setBlockTextureName("high_elf_wall"));
        registerBlock(665, "harlindon_wood", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("harlindonWood").setBlockTextureName("harlindon_wood"));
        registerBlock(666, "forlond_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("forlondFloor").setBlockTextureName("forlond_floor"));
        registerBlock(667, "forlindon_wood", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("forlindonWood").setBlockTextureName("forlindon_wood"));
        registerBlock(668, "forlindon_wall", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("forlindonWall").setBlockTextureName("forlindon_wall"));
        registerBlock(669, "elven_stone_wall", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("elvenStoneWall").setBlockTextureName("elven_stone_wall"));
        registerBlock(670, "elven_noble_wall", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("elvenNobleWall").setBlockTextureName("elven_noble_wall"));
        registerBlock(671, "rivendell_statue_bottom", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rivendellStatueBottom").setBlockTextureName("rivendell_statue_bottom"));
        registerBlock(672, "elven_decoration", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("elvenDecoration").setBlockTextureName("elven_decoration"));
        registerBlock(673, "elven_decoration_light", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("elvenDecorationLight").setBlockTextureName("elven_decoration_light"));
        registerBlock(674, "elven_decoration2", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("elvenDecoration2").setBlockTextureName("elven_decoration2"));
        registerBlock(675, "elven_decoration3", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("elvenDecoration3").setBlockTextureName("elven_decoration3"));
        registerBlock(676, "hobbit_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("hobbitFloor").setBlockTextureName("hobbit_floor"));
        registerBlock(677, "hobbit_floor2", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("hobbitFloor2").setBlockTextureName("hobbit_floor2"));
        registerBlock(678, "dark_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("darkBricks").setBlockTextureName("dark_bricks"));
        registerBlock(679, "rohirrim_crossbeam", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rohirrimCrossbeam").setBlockTextureName("rohirrim_crossbeam"));
        registerBlock(680, "crossbeam", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("crossbeam").setBlockTextureName("crossbeam"));
        registerBlock(681, "crossbeam2", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("crossbeam2").setBlockTextureName("crossbeam2"));
        registerBlock(682, "crossbeam3", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("crossbeam3").setBlockTextureName("crossbeam3"));
        registerBlock(683, "standard_crossbeam", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("standardCrossbeam").setBlockTextureName("standard_crossbeam"));
        registerBlock(684, "standard_crossbeam2", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("standardCrossbeam2").setBlockTextureName("standard_crossbeam2"));
        registerBlock(685, "standard_crossbeam3", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("standardCrossbeam3").setBlockTextureName("standard_crossbeam3"));
        registerBlock(686, "vertical_beam", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("verticalBeam").setBlockTextureName("vertical_beam"));
        registerBlock(687, "vertical_horizontal_beam", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("verticalHorizontalBeam").setBlockTextureName("vertical_horizontal_beam"));
        registerBlock(689, "dale_sandstone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("daleSandstone").setBlockTextureName("dale_sandstone"));
        registerBlock(690, "dale_tiles", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("daleTiles").setBlockTextureName("dale_tiles"));
        registerBlock(691, "dale_wall", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("daleWall").setBlockTextureName("dale_wall"));
        registerBlock(692, "harad_sandstone_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("haradSandstoneFloor").setBlockTextureName("harad_sandstone_floor"));
        registerBlock(693, "harad_stone_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("haradStoneBricks").setBlockTextureName("harad_stone_bricks"));
        registerBlock(694, "sandfloor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("sandfloor").setBlockTextureName("sandfloor"));
        registerBlock(695, "umbar_haven_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("umbarHavenFloor").setBlockTextureName("umbar_haven_floor"));
        registerBlock(696, "umbar_stone_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("umbarStoneBricks").setBlockTextureName("umbar_stone_bricks"));
        registerBlock(697, "umbar_wall_decoration", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("umbarWallDecoration").setBlockTextureName("umbar_wall_decoration"));
        registerBlock(698, "khand_stone_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("khandStoneBricks").setBlockTextureName("khand_stone_bricks"));
        registerBlock(699, "brown_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("brownBricks").setBlockTextureName("brown_bricks"));
        registerBlock(700, "edoras_cobblestone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("edorasCobblestone").setBlockTextureName("edoras_cobblestone"));
        registerBlock(701, "reinforced_wood", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("reinforcedWood").setBlockTextureName("reinforced_wood"));
        registerBlock(702, "medusled_wood", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("medusledWood").setBlockTextureName("medusled_wood"));
        registerBlock(703, "rohirrim_wall_decoration", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("rohirrimWallDecoration").setBlockTextureName("rohirrim_wall_decoration"));
        registerBlock(704, "statue_head", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("statueHead").setBlockTextureName("statue_head"));
        ...
        registerBlock(709, "angmar_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("angmarFloor").setBlockTextureName("angmar_floor"));
        registerBlock(710, "angmar_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("angmarBricks").setBlockTextureName("angmar_bricks"));
        registerBlock(711, "beorning_wood", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("beorningWood").setBlockTextureName("beorning_wood"));
        registerBlock(712, "annuminas_decoration", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("annuminasDecoration").setBlockTextureName("annuminas_decoration"));
        registerBlock(713, "arnor_decoration_jewel", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("arnorDecorationJewel").setBlockTextureName("arnor_decoration_jewel"));
        registerBlock(714, "arnorian_bricks", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("arnorianBricks").setBlockTextureName("arnorian_bricks"));
        registerBlock(715, "minas_tirith_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("minasTirithFloor").setBlockTextureName("minas_tirith_floor"));
        registerBlock(716, "pelargir_stone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("pelargirStone").setBlockTextureName("pelargir_stone"));
        registerBlock(717, "white_cobblestone", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("whiteCobblestone").setBlockTextureName("white_cobblestone"));
        registerBlock(718, "dunland_totem", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dunlandTotem").setBlockTextureName("dunland_totem"));
        registerBlock(719, "dunland_wall_decoration", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("dunlandWallDecoration").setBlockTextureName("dunland_wall_decoration"));
        ...
        Block breeTile = (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("breeTile").setBlockTextureName("bree_tile");
