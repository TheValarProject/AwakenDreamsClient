...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(676, "hobbit_floor", (new Block(Material.ROCK)).setHardness(1.5F).setResistance(10.0F).setSoundType(SoundType.STONE).setUnlocalizedName("hobbitFloor").setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
