...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        registerADBlock(721, "dale_Window_1", (new BlockGlass(Material.GLASS, false)).setHardness(0.3F).setSoundType(SoundType.GLASS).setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
        registerADBlock(722, "dale_Window_2", (new BlockGlass(Material.GLASS, false)).setHardness(0.3F).setSoundType(SoundType.GLASS).setCreativeTab(CreativeTabs.BUILDING_BLOCKS));
