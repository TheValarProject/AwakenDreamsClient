...
public abstract class BlockButton extends BlockDirectional
{
    ...
    protected static boolean canPlaceBlock(World worldIn, BlockPos pos, EnumFacing direction)
    {
        ...
        return direction == EnumFacing.DOWN ? worldIn.getBlockState(blockpos).isFullyOpaque() : worldIn.getBlockState(blockpos).isNormalCube();
    }
    ...
    {
        if (this.checkForDrop(p_189540_2_, p_189540_3_, p_189540_1_) && !canPlaceBlock(p_189540_2_, p_189540_3_, ((EnumFacing)p_189540_1_.getValue(FACING)).getOpposite()))
        {
