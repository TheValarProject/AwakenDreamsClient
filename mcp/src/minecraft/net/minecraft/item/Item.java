...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        //registerItem(6028, "herugrim", (new ItemValarWeapon(830, 7, 0, true, false).setUnlocalizedName("herugrim").setTextureName("herugrim")));
        ...
        //registerItem(6035, "staff_base", (new ItemValarWeapon()).setUnlocalizedName("staffBase").setTextureName("staff_base")));
        //registerItem(6036, "knife", (new ItemValarWeapon(35, 4, 0, true, false).setUnlocalizedName("knife").setTextureName("knife")));
        ...
        //registerItem(6078, "crossbow", (new ItemValarBase().setUnlocalizedName("crossbow").setTextureName("crossbow")));
        //registerItem(6079, "crossbow_bolt", (new ItemValarBase().setUnlocalizedName("crossbowBolt").setTextureName("crossbow_bolt")));
        ...
        //registerItem(6083, "into_the_west", (new ItemValarBase().setUnlocalizedName("intotheWest").setTextureName("into_the_west")));
        //registerItem(6084, "may_it_be", (new ItemValarBase().setUnlocalizedName("mayItBe").setTextureName("may_it_be")));
        registerItem(6085, "human_dagger", (new ItemValarWeapon(50, 4).setUnlocalizedName("humanDagger").setTextureName("human_dagger")));
        registerItem(6086, "hobbit_dagger", (new ItemValarWeapon(50, 4).setUnlocalizedName("hobbitDagger").setTextureName("hobbit_dagger")));
        registerItem(6087, "elf_dagger", (new ItemValarWeapon(80, 5).setUnlocalizedName("elfDagger").setTextureName("elf_dagger")));
        registerItem(6088, "gondorian_sword", (new ItemValarWeapon(350, 6).setUnlocalizedName("gondorianSword").setTextureName("gondorian_sword")));
        ...
        /*registerItem(6102, "brown_pipe", (new ItemValarBase().setUnlocalizedName("brownPipe").setTextureName("brown_pipe")));
        registerItem(6103, "stone_of_darkness", (new ItemValarBase().setUnlocalizedName("stoneOfDarkness").setTextureName("stone_of_darkness")));
        registerItem(6104, "stone_of_earth", (new ItemValarBase().setUnlocalizedName("stoneOfEarth").setTextureName("stone_of_earth")));
        registerItem(6105, "stone_of_fire", (new ItemValarBase().setUnlocalizedName("stoneOfFire").setTextureName("stone_of_fire")));
        registerItem(6106, "stone_of_greed", (new ItemValarBase().setUnlocalizedName("stoneOfGreed").setTextureName("stone_of_greed")));
        registerItem(6107, "stone_of_hope", (new ItemValarBase().setUnlocalizedName("stoneOfHope").setTextureName("stone_of_hope")));
        registerItem(6108, "stone_of_nature", (new ItemValarBase().setUnlocalizedName("stoneOfNature").setTextureName("stone_of_nature")));
        registerItem(6109, "stone_of_sunlight", (new ItemValarBase().setUnlocalizedName("stoneOfSunlight").setTextureName("stone_of_sunlight")));
        registerItem(6110, "stone_of_sea", (new ItemValarBase().setUnlocalizedName("stoneOfSea").setTextureName("stone_of_sea")));
        registerItem(6111, "stone_of_sky", (new ItemValarBase().setUnlocalizedName("stoneOfSky").setTextureName("stone_of_sky")));
        registerItem(6112, "stone_of_wealth", (new ItemValarBase().setUnlocalizedName("stoneOfWealth").setTextureName("stone_of_wealth")));
        registerItem(6113, "stone_of_wind", (new ItemValarBase().setUnlocalizedName("stoneOfWind").setTextureName("stone_of_wind")));
        registerItem(6114, "hammer", (new ItemValarBase().setUnlocalizedName("hammer").setTextureName("hammer")));
        registerItem(6115, "gold_ring", (new ItemValarBase().setUnlocalizedName("goldRing").setTextureName("gold_ring")));
        registerItem(6116, "onyx_gold_ring", (new ItemValarBase().setUnlocalizedName("onyxGoldRing").setTextureName("onyx_gold_ring")));
        registerItem(6117, "tanzanite_gold_ring", (new ItemValarBase().setUnlocalizedName("tanzaniteGoldRing").setTextureName("tanzanite_gold_ring")));
        registerItem(6118, "jade_gold_ring", (new ItemValarBase().setUnlocalizedName("jadeGoldRing").setTextureName("jade_gold_ring")));
        registerItem(6119, "moonstone_gold_ring", (new ItemValarBase().setUnlocalizedName("moonstoneGoldRing").setTextureName("moonstone_gold_ring")));
        registerItem(6120, "amethyst_gold_ring", (new ItemValarBase().setUnlocalizedName("amethystGoldRing").setTextureName("amethyst_gold_ring")));
        registerItem(6121, "ruby_gold_ring", (new ItemValarBase().setUnlocalizedName("rubyGoldRing").setTextureName("ruby_gold_ring")));
        registerItem(6122, "quartz_gold_ring", (new ItemValarBase().setUnlocalizedName("quartzGoldRing").setTextureName("quartz_gold_ring")));
        registerItem(6123, "amber_gold_ring", (new ItemValarBase().setUnlocalizedName("amberGoldRing").setTextureName("amber_gold_ring")));
        registerItem(6124, "silver_ring", (new ItemValarBase().setUnlocalizedName("silverRing").setTextureName("silver_ring")));
        registerItem(6125, "onyx_silver_ring", (new ItemValarBase().setUnlocalizedName("onyxSilverRing").setTextureName("onyx_silver_ring")));
        registerItem(6126, "tanzanite_silver_ring", (new ItemValarBase().setUnlocalizedName("tanzaniteSilverRing").setTextureName("tanzanite_silver_ring")));
        registerItem(6127, "jade_silver_ring", (new ItemValarBase().setUnlocalizedName("jadeSilverRing").setTextureName("jade_silver_ring")));
        registerItem(6128, "moonstone_silver_ring", (new ItemValarBase().setUnlocalizedName("moonstoneSilverRing").setTextureName("moonstone_silver_ring")));
        registerItem(6129, "amethyst_silver_ring", (new ItemValarBase().setUnlocalizedName("amethystSilverRing").setTextureName("amethyst_silver_ring")));
        registerItem(6130, "ruby_silver_ring", (new ItemValarBase().setUnlocalizedName("rubySilverRing").setTextureName("ruby_silver_ring")));
        registerItem(6131, "quartz_silver_ring", (new ItemValarBase().setUnlocalizedName("quartzSilverRing").setTextureName("quartz_silver_ring")));
        registerItem(6132, "amber_silver_ring", (new ItemValarBase().setUnlocalizedName("amberSilverRing").setTextureName("amber_silver_ring")));
        registerItem(6133, "bronze_ring", (new ItemValarBase().setUnlocalizedName("bronzeRing").setTextureName("bronze_ring")));
        registerItem(6134, "onyx_bronze_ring", (new ItemValarBase().setUnlocalizedName("onyxBronzeRing").setTextureName("onyx_bronze_ring")));
        registerItem(6135, "tanzanite_bronze_ring", (new ItemValarBase().setUnlocalizedName("tanzaniteBronzeRing").setTextureName("tanzanite_bronze_ring")));
        registerItem(6136, "jade_bronze_ring", (new ItemValarBase().setUnlocalizedName("jadeBronzeRing").setTextureName("jade_bronze_ring")));
        registerItem(6137, "moonstone_bronze_ring", (new ItemValarBase().setUnlocalizedName("moonstoneBronzeRing").setTextureName("moonstone_bronze_ring")));
        registerItem(6138, "amethyst_bronze_ring", (new ItemValarBase().setUnlocalizedName("amethystBronzeRing").setTextureName("amethyst_bronze_ring")));
        registerItem(6139, "ruby_bronze_ring", (new ItemValarBase().setUnlocalizedName("rubyBronzeRing").setTextureName("ruby_bronze_ring")));
        registerItem(6140, "quartz_bronze_ring", (new ItemValarBase().setUnlocalizedName("quartzBronzeRing").setTextureName("quartz_bronze_ring")));
        registerItem(6141, "amber_bronze_ring", (new ItemValarBase().setUnlocalizedName("amberBronzeRing").setTextureName("amber_bronze_ring")));
        registerItem(6142, "mithril_ring", (new ItemValarBase().setUnlocalizedName("mithrilRing").setTextureName("mithril_ring")));
        registerItem(6143, "onyx_mithril_ring", (new ItemValarBase().setUnlocalizedName("onyxMithrilRing").setTextureName("onyx_mithril_ring")));
        registerItem(6144, "tanzanite_mithril_ring", (new ItemValarBase().setUnlocalizedName("tanzaniteMithrilRing").setTextureName("tanzanite_mithril_ring")));
        registerItem(6145, "jade_mithril_ring", (new ItemValarBase().setUnlocalizedName("jadeMithrilRing").setTextureName("jade_mithril_ring")));
        registerItem(6146, "moonstone_mithril_ring", (new ItemValarBase().setUnlocalizedName("moonstoneMithrilRing").setTextureName("moonstone_mithril_ring")));
        registerItem(6147, "amethyst_mithril_ring", (new ItemValarBase().setUnlocalizedName("amethystMithrilRing").setTextureName("amethyst_mithril_ring")));
        registerItem(6148, "ruby_mithril_ring", (new ItemValarBase().setUnlocalizedName("rubyMithrilRing").setTextureName("ruby_mithril_ring")));
        registerItem(6149, "quartz_mithril_ring", (new ItemValarBase().setUnlocalizedName("quartzMithrilRing").setTextureName("quartz_mithril_ring")));
        registerItem(6150, "amber_mithril_ring", (new ItemValarBase().setUnlocalizedName("amberMithrilRing").setTextureName("amber_mithril_ring")));
        registerItem(6151, "salt", (new ItemValarBase().setUnlocalizedName("salt").setTextureName("salt")));
        ...
        registerItem(6153, "silver_ingot", (new ItemValarBase().setUnlocalizedName("silverIngot").setTextureName("silver_ingot")));*/
        registerItem(6154, "dwarf_door", (new ItemDoor(Blocks.DWARF_DOOR)).setUnlocalizedName("dwarfDoor"));
        /*registerItem(6155, "boromirs_sword", (new ItemValarWeapon(900, 9, 0, true, false).setUnlocalizedName("boromirsSword").setTextureName("boromirs_sword")));
        ...
        registerItem(6163, "orc_sword_1", (new ItemValarWeapon(230, 5, 0, true, true).setUnlocalizedName("orcSword1").setTextureName("orc_sword_1")));
        registerItem(6164, "orc_sword_2", (new ItemValarWeapon(230, 5).setUnlocalizedName("orcSword2").setTextureName("orc_sword_2")));
        //registerItem(6165, "rivendell_sword", (new ItemValarBase().setUnlocalizedName("rivendellSword").setTextureName("rivendell_sword")));
        registerItem(6166, "goblin_sword", (new ItemValarWeapon(200, 5).setUnlocalizedName("goblinSword").setTextureName("goblin_sword")));
        registerItem(6167, "hobbit_axe", (new ItemValarWeapon(235, 5, 0, true, true).setUnlocalizedName("hobbitAxe").setTextureName("hobbit_axe")));
        registerItem(6168, "sharkus_shortsword", (new ItemValarWeapon(467, 8).setUnlocalizedName("sharkusShortsword").setTextureName("sharkus_shortsword")));
        registerItem(6169, "battle_pickaxe", (new ItemValarWeapon(300, 5).setUnlocalizedName("battlePickaxe").setTextureName("battle_pickaxe")));
        registerItem(6170, "shirriff_club", (new ItemValarWeapon(131, 6).setUnlocalizedName("shirriffClub").setTextureName("shirriff_club")));
        registerItem(6171, "pike_club", (new ItemValarWeapon(350, 6).setUnlocalizedName("pikeClub").setTextureName("pike_club")));
        registerItem(6172, "hobbit_sword", (new ItemValarWeapon(230, 5).setUnlocalizedName("hobbitSword").setTextureName("hobbit_sword")));
        registerItem(6173, "hobbit_hammer", (new ItemValarWeapon(235, 5).setUnlocalizedName("hobbitHammer").setTextureName("hobbit_hammer")));
        ...
        registerItem(6181, "boar_horns", (new ItemValarBase().setUnlocalizedName("boarHorns").setTextureName("boar_horns")));
        registerItem(6182, "gold_ring_of_darkness", (new ItemValarBase().setUnlocalizedName("goldRingofDarkness").setTextureName("gold_ring_of_darkness")));
        registerItem(6183, "gold_ring_of_earth", (new ItemValarBase().setUnlocalizedName("goldRingofEarth").setTextureName("gold_ring_of_earth")));
        registerItem(6184, "gold_ring_of_fire", (new ItemValarBase().setUnlocalizedName("goldRingofFire").setTextureName("gold_ring_of_fire")));
        registerItem(6185, "gold_ring_of_greed", (new ItemValarBase().setUnlocalizedName("goldRingofGreed").setTextureName("gold_ring_of_greed")));
        registerItem(6186, "gold_ring_of_hope", (new ItemValarBase().setUnlocalizedName("goldRingofHope").setTextureName("gold_ring_of_hope")));
        registerItem(6187, "gold_ring_of_nature", (new ItemValarBase().setUnlocalizedName("goldRingofNature").setTextureName("gold_ring_of_nature")));
        registerItem(6188, "gold_ring_of_sea", (new ItemValarBase().setUnlocalizedName("goldRingofSea").setTextureName("gold_ring_of_sea")));
        registerItem(6189, "gold_ring_of_sky", (new ItemValarBase().setUnlocalizedName("goldRingofSky").setTextureName("gold_ring_of_sky")));
        registerItem(6190, "gold_ring_of_sunlight", (new ItemValarBase().setUnlocalizedName("goldRingofSunlight").setTextureName("gold_ring_of_sunlight")));
        registerItem(6191, "gold_ring_of_wealth", (new ItemValarBase().setUnlocalizedName("goldRingofWealth").setTextureName("gold_ring_of_wealth")));
        registerItem(6192, "gold_ring_of_wind", (new ItemValarBase().setUnlocalizedName("goldRingofWind").setTextureName("gold_ring_of_wind")));
        registerItem(6193, "silver_ring_of_darkness", (new ItemValarBase().setUnlocalizedName("silverRingofDarkness").setTextureName("silver_ring_of_darkness")));
        registerItem(6194, "silver_ring_of_earth", (new ItemValarBase().setUnlocalizedName("silverRingofEarth").setTextureName("silver_ring_of_earth")));
        registerItem(6195, "silver_ring_of_fire", (new ItemValarBase().setUnlocalizedName("silverRingofFire").setTextureName("silver_ring_of_fire")));
        registerItem(6196, "silver_ring_of_greed", (new ItemValarBase().setUnlocalizedName("silverRingofGreed").setTextureName("silver_ring_of_greed")));
        registerItem(6197, "silver_ring_of_hope", (new ItemValarBase().setUnlocalizedName("silverRingofHope").setTextureName("silver_ring_of_hope")));
        registerItem(6198, "silver_ring_of_nature", (new ItemValarBase().setUnlocalizedName("silverRingofNature").setTextureName("silver_ring_of_nature")));
        registerItem(6199, "silver_ring_of_sea", (new ItemValarBase().setUnlocalizedName("silverRingofSea").setTextureName("silver_ring_of_sea")));
        registerItem(6200, "silver_ring_of_sky", (new ItemValarBase().setUnlocalizedName("silverRingofSky").setTextureName("silver_ring_of_sky")));
        registerItem(6201, "silver_ring_of_sunlight", (new ItemValarBase().setUnlocalizedName("silverRingofSunlight").setTextureName("silver_ring_of_sunlight")));
        registerItem(6202, "silver_ring_of_wealth", (new ItemValarBase().setUnlocalizedName("silverRingofWealth").setTextureName("silver_ring_of_wealth")));
        registerItem(6203, "silver_ring_of_wind", (new ItemValarBase().setUnlocalizedName("silverRingofWind").setTextureName("silver_ring_of_wind")));
        registerItem(6204, "bronze_ring_of_darkness", (new ItemValarBase().setUnlocalizedName("bronzeRingofDarkness").setTextureName("bronze_ring_of_darkness")));
        registerItem(6205, "bronze_ring_of_earth", (new ItemValarBase().setUnlocalizedName("bronzeRingofEarth").setTextureName("bronze_ring_of_earth")));
        registerItem(6206, "bronze_ring_of_fire", (new ItemValarBase().setUnlocalizedName("bronzeRingofFire").setTextureName("bronze_ring_of_fire")));
        registerItem(6207, "bronze_ring_of_greed", (new ItemValarBase().setUnlocalizedName("bronzeRingofGreed").setTextureName("bronze_ring_of_greed")));
        registerItem(6208, "bronze_ring_of_hope", (new ItemValarBase().setUnlocalizedName("bronzeRingofHope").setTextureName("bronze_ring_of_hope")));
        registerItem(6209, "bronze_ring_of_nature", (new ItemValarBase().setUnlocalizedName("bronzeRingofNature").setTextureName("bronze_ring_of_nature")));
        registerItem(6210, "bronze_ring_of_sea", (new ItemValarBase().setUnlocalizedName("bronzeRingofSea").setTextureName("bronze_ring_of_sea")));
        registerItem(6211, "bronze_ring_of_sky", (new ItemValarBase().setUnlocalizedName("bronzeRingofSky").setTextureName("bronze_ring_of_sky")));
        registerItem(6212, "bronze_ring_of_sunlight", (new ItemValarBase().setUnlocalizedName("bronzeRingofSunlight").setTextureName("bronze_ring_of_sunlight")));
        registerItem(6213, "bronze_ring_of_wealth", (new ItemValarBase().setUnlocalizedName("bronzeRingofWealth").setTextureName("bronze_ring_of_wealth")));
        registerItem(6214, "bronze_ring_of_wind", (new ItemValarBase().setUnlocalizedName("bronzeRingofWind").setTextureName("bronze_ring_of_wind")));
        registerItem(6215, "mithril_ring_of_darkness", (new ItemValarBase().setUnlocalizedName("mithrilRingofDarkness").setTextureName("mithril_ring_of_darkness")));
        registerItem(6216, "mithril_ring_of_earth", (new ItemValarBase().setUnlocalizedName("mithrilRingofEarth").setTextureName("mithril_ring_of_earth")));
        registerItem(6217, "mithril_ring_of_fire", (new ItemValarBase().setUnlocalizedName("mithrilRingofFire").setTextureName("mithril_ring_of_fire")));
        registerItem(6218, "mithril_ring_of_greed", (new ItemValarBase().setUnlocalizedName("mithrilRingofGreed").setTextureName("mithril_ring_of_greed")));
        registerItem(6219, "mithril_ring_of_hope", (new ItemValarBase().setUnlocalizedName("mithrilRingofHope").setTextureName("mithril_ring_of_hope")));
        registerItem(6220, "mithril_ring_of_nature", (new ItemValarBase().setUnlocalizedName("mithrilRingofNature").setTextureName("mithril_ring_of_nature")));
        registerItem(6221, "mithril_ring_of_sea", (new ItemValarBase().setUnlocalizedName("mithrilRingofSea").setTextureName("mithril_ring_of_sea")));
        registerItem(6222, "mithril_ring_of_sky", (new ItemValarBase().setUnlocalizedName("mithrilRingofSky").setTextureName("mithril_ring_of_sky")));
        registerItem(6223, "mithril_ring_of_sunlight", (new ItemValarBase().setUnlocalizedName("mithrilRingofSunlight").setTextureName("mithril_ring_of_sunlight")));
        registerItem(6224, "mithril_ring_of_wealth", (new ItemValarBase().setUnlocalizedName("mithrilRingofWealth").setTextureName("mithril_ring_of_wealth")));
        registerItem(6225, "mithril_ring_of_wind", (new ItemValarBase().setUnlocalizedName("mithrilRingofWind").setTextureName("mithril_ring_of_wind")));
        registerItem(6226, "anduril", (new ItemValarWeapon(3000, 11, 0, true, false).setUnlocalizedName("anduril").setTextureName("anduril")));
        registerItem(6227, "morgul_sword", (new ItemValarWeapon(2500, 9).setUnlocalizedName("morgulSword").setTextureName("morgul_sword")));
        registerItem(6228, "elven_long_sword", (new ItemValarWeapon(1800, 7).setUnlocalizedName("elvenLongSword").setTextureName("elven_long_sword")));
        registerItem(6229, "berserker_sword", (new ItemValarWeapon(1400, 8).setUnlocalizedName("berserkerSword").setTextureName("berserker_sword")));
        registerItem(6230, "two_handed_sword", (new ItemValarWeapon(500, 7).setUnlocalizedName("twohandedSword").setTextureName("two_handed_sword")));
        //registerItem(6231, "green_flag", (new ItemValarBase().setUnlocalizedName("greenFlag").setTextureName("green_flag")));
        //registerItem(6232, "hobbit_bow", (new ItemValarBase().setUnlocalizedName("hobbitBow").setTextureName("hobbit_bow")));
        registerItem(6233, "rohan_sheild_6", (new ItemValarBase().setUnlocalizedName("rohanShield6").setTextureName("rohan_shield_6")));
        //registerItem(6234, "throwing_stone", (new ItemValarBase().setUnlocalizedName("throwingStone").setTextureName("throwing_stone")));
        registerItem(6235, "rohirrim_axe", (new ItemValarWeapon(267, 6, 0, true, true).setUnlocalizedName("rohirrimAxe").setTextureName("rohirrim_axe")));
        registerItem(6236, "ecthelions_boots", (new ItemValarArmor(3, 500, 3, 0).setUnlocalizedName("ecthelionsBoots").setTextureName("ecthelions_boots")));
        //registerItem(3237, "gondorian_brick_stone_slab_item", (new ItemValarBase().setUnlocalizedName("gondorianBrickStoneSlabItem").setTextureName("gondorian_brick_stone_slab_item")));
        //registerItem(6238, "a_knife_in_the_dark", (new ItemValarBase().setUnlocalizedName("aKnifeintheDark").setTextureName("a_knife_in_the_dark")));*/
        ...
        /*//registerItem(6242, "one_ring", (new ItemValarBase().setUnlocalizedName("oneRing").setTextureName("one_ring")));
        registerItem(6243, "aicanar", (new ItemValarWeapon(6000, 10).setUnlocalizedName("aicanar").setTextureName("aicanar")));
        registerItem(6244, "balins_sword", (new ItemValarWeapon(1600, 7).setUnlocalizedName("balinsSword").setTextureName("balins_sword")));
        registerItem(6245, "bifurs_spear", (new ItemValarWeapon(1102, 6, 0, true, true).setUnlocalizedName("bifursSpear").setTextureName("bifurs_spear")));
        //registerItem(6246, "bofurs_spear", (new ItemValarWeapon(1182, 6).setUnlocalizedName("bofursSpear").setTextureName("bofurs_spear")));
        registerItem(6247, "bomburs_spoon", (new ItemValarWeapon(321, 4).setUnlocalizedName("bombursSpoon").setTextureName("bomburs_spoon")));
        registerItem(6248, "doris_sword", (new ItemValarWeapon(1500, 5).setUnlocalizedName("dorisSword").setTextureName("doris_sword")));
        registerItem(6249, "dwalins_axe", (new ItemValarWeapon(1700, 7).setUnlocalizedName("dwalinsAxe").setTextureName("dwalins_axe")));
        registerItem(6250, "filis_knife", (new ItemValarWeapon(112, 4).setUnlocalizedName("filisKnife").setTextureName("filis_knife")));
        registerItem(6251, "filis_sword", (new ItemValarWeapon(1111, 6).setUnlocalizedName("filisSword").setTextureName("filis_sword")));
        registerItem(6252, "kilis_sword", (new ItemValarWeapon(1111, 6).setUnlocalizedName("kilisSword").setTextureName("kilis_sword")));
        registerItem(6253, "noris_club", (new ItemValarWeapon(861, 5).setUnlocalizedName("norisClub").setTextureName("noris_club")));
        registerItem(6254, "oins_staff", (new ItemValarWeapon(922, 6).setUnlocalizedName("oinsStaff").setTextureName("oins_staff")));
        registerItem(6255, "orcrist", (new ItemValarWeapon(8001, 12).setUnlocalizedName("orcrist").setTextureName("orcrist")));
        registerItem(6256, "sword_of_westernesse", (new ItemValarWeapon(3200, 8).setUnlocalizedName("swordOfWesternesse").setTextureName("sword_of_westernesse")));
        registerItem(6257, "thorins_sword", (new ItemValarWeapon(1200, 6).setUnlocalizedName("thorinsSword").setTextureName("thorins_sword")));
        registerItem(6258, "thrains_warhammer", (new ItemValarWeapon(1288, 6).setUnlocalizedName("thrainsWarhammer").setTextureName("thrains_warhammer")));
        registerItem(6259, "thrors_warhammer", (new ItemValarWeapon(1428, 7).setUnlocalizedName("throrsWarhammer").setTextureName("thrors_warhammer")));
        registerItem(6260, "aragorns_elf_knife", (new ItemValarWeapon(1300, 5, 0, true, true).setUnlocalizedName("aragornsElfKnife").setTextureName("aragorns_elf_knife")));
        registerItem(6261, "eowyns_sword", (new ItemValarWeapon(1261, 6).setUnlocalizedName("eowynsSword").setTextureName("eowyns_sword")));
        registerItem(6262, "gandalf_the_greys_staff", (new ItemValarWeapon(3000, 9).setUnlocalizedName("gandalftheGreysStaff").setTextureName("gandalf_the_greys_staff")));
        registerItem(6263, "gandalf_the_whites_staff", (new ItemValarWeapon(5000, 11).setUnlocalizedName("gandalftheWhitesStaff").setTextureName("gandalf_the_whites_staff")));
        registerItem(6264, "gimlis_two-headed_axe", (new ItemValarWeapon(2000, 9).setUnlocalizedName("gimlisTwo-HeadedAxe").setTextureName("gimlis_two-headed_axe")));
        registerItem(6265, "gimlis_longaxe", (new ItemValarWeapon(1700, 7).setUnlocalizedName("gimlisLongaxe").setTextureName("gimlis_longaxe")));
        registerItem(6266, "glamdring", (new ItemValarWeapon(3200, 11).setUnlocalizedName("glamdring").setTextureName("glamdring")));
        registerItem(6267, "gloins_axe", (new ItemValarWeapon(1700, 7).setUnlocalizedName("gloinsAxe").setTextureName("gloins_axe")));
        registerItem(6268, "glorfindels_sword", (new ItemValarWeapon(3600, 9).setUnlocalizedName("glorfindelsSword").setTextureName("glorfindels_sword")));
        registerItem(6269, "guthwine", (new ItemValarWeapon(1732, 8).setUnlocalizedName("guthwine").setTextureName("guthwine")));
        registerItem(6270, "hadhafang", (new ItemValarWeapon(3400, 10).setUnlocalizedName("hadhafang").setTextureName("hadhafang")));
        //registerItem(6271, "herugrim", (new ItemValarBase().setUnlocalizedName("herugrim").setTextureName("herugrim")));
        registerItem(6272, "legolas_sword", (new ItemValarWeapon(2900, 9, 0, true, true).setUnlocalizedName("legolasSword").setTextureName("legolas_sword")));
        registerItem(6273, "radagasts_staff", (new ItemValarWeapon(3100, 8, 0, true, true).setUnlocalizedName("radagast'sStaff").setTextureName("radagasts_staff")));
        registerItem(6274, "lurtz_sword", (new ItemValarWeapon(1870, 8).setUnlocalizedName("lurtzSword").setTextureName("lurtz_sword")));
        registerItem(6275, "saurons_mace", (new ItemValarWeapon(7500, 13).setUnlocalizedName("sauronsMace").setTextureName("saurons_mace")));
        registerItem(6276, "sarumans_staff", (new ItemValarWeapon(4500, 10).setUnlocalizedName("sarumansStaff").setTextureName("sarumans_staff")));
        registerItem(6277, "yaznegs_axe", (new ItemValarWeapon(830, 6, 0, true, true).setUnlocalizedName("yaznegsAxe").setTextureName("yaznegs_axe")));
        registerItem(6278, "dwarven_lord_knife", (new ItemValarWeapon(1200, 4).setUnlocalizedName("dwarvenLordKnife").setTextureName("dwarven_lord_knife")));
        registerItem(6279, "gondorian_noble_sword", (new ItemValarWeapon(1400, 7).setUnlocalizedName("gondorianNobleSword").setTextureName("gondorian_noble_sword")));
        registerItem(6280, "mace_of_glory", (new ItemValarWeapon(2100, 8).setUnlocalizedName("maceOfGlory").setTextureName("mace_of_glory")));
        registerItem(6281, "golden_war_hammer_of_erebor", (new ItemValarWeapon(2800, 7).setUnlocalizedName("goldenWarHammerofErebor").setTextureName("golden_war_hammer_of_erebor")));
        registerItem(6282, "gondorian_spear", (new ItemValarWeapon(1000, 6).setUnlocalizedName("gondorianSpear").setTextureName("gondorian_spear")));
        registerItem(6283, "rohirrim_spear", (new ItemValarWeapon(1040, 6).setUnlocalizedName("rohirrimSpear").setTextureName("rohirrim_spear")));
        registerItem(6284, "bull-head_mace", (new ItemValarWeapon(1091, 6).setUnlocalizedName("bull-HeadMace").setTextureName("bull-head_mace")));
        registerItem(6285, "corsair_eket", (new ItemValarWeapon(1133, 7).setUnlocalizedName("corsairEket").setTextureName("corsair_eket")));
        registerItem(6286, "dol_guldur_spiked_mace", (new ItemValarWeapon(981, 6).setUnlocalizedName("dolGuldurSpikedMace").setTextureName("dol_guldur_spiked_mace")));
        registerItem(6287, "fell-wargrider_sword", (new ItemValarWeapon(991, 6, 0, true, true).setUnlocalizedName("fell-WargriderSword").setTextureName("fell-wargrider_sword")));
        registerItem(6288, "haradrim_snake_dagger", (new ItemValarWeapon(777, 5).setUnlocalizedName("haradrimSnakeDagger").setTextureName("haradrim_snake_dagger")));
        registerItem(6289, "north-goblin_mace", (new ItemValarWeapon(531, 5).setUnlocalizedName("north-GoblinMace").setTextureName("north-goblin_mace")));
        registerItem(6290, "north-goblin_sword", (new ItemValarWeapon(772, 5).setUnlocalizedName("north-GoblinSword").setTextureName("north-goblin_sword")));
        registerItem(6291, "orc_captain_sword", (new ItemValarWeapon(1130, 7).setUnlocalizedName("orcCaptainSword").setTextureName("orc_captain_sword")));
        registerItem(6292, "orc_dagger", (new ItemValarWeapon(103, 4).setUnlocalizedName("orcDagger").setTextureName("orc_dagger")));
        registerItem(6293, "orc_halbard", (new ItemValarWeapon(605, 7, 0, true, true).setUnlocalizedName("orcHalbard").setTextureName("orc_halbard")));
        registerItem(6294, "uruk_siege-trooper_dagger", (new ItemValarWeapon(1041, 5).setUnlocalizedName("urukSiege-TrooperDagger").setTextureName("uruk_siege-trooper_dagger")));
        //registerItem(6295, "orc_spawner", (new ItemValarBase().setUnlocalizedName("orcSpawner").setTextureName("orc_spawner")));
        registerItem(6296, "iron_mace", (new ItemValarWeapon(387, 7).setUnlocalizedName("ironMace").setTextureName("iron_mace")));
        registerItem(6297, "orc_sword_3", (new ItemValarWeapon(837, 6).setUnlocalizedName("orcSword3").setTextureName("orc_sword_3")));
        registerItem(6298, "morannon_orc_shield", (new ItemValarBase().setUnlocalizedName("morannonOrcShield").setTextureName("morannon_orc_shield")));
        registerItem(6299, "morannon_dagger", (new ItemValarWeapon(99, 3).setUnlocalizedName("morannonDagger").setTextureName("morannon_dagger")));
        registerItem(6300, "orc_spear", (new ItemValarWeapon(123, 6).setUnlocalizedName("orcSpear").setTextureName("orc_spear")));
