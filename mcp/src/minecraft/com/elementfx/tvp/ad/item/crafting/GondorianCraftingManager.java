...
public class GondorianCraftingManager extends CustomCraftingManager
{
	 /** The static instance of this class */
    private static final GondorianCraftingManager INSTANCE = new GondorianCraftingManager();
    private final List<IRecipe> recipes = Lists.<IRecipe>newArrayList();

    /**
     * Returns the static instance of this class
     */
    public static GondorianCraftingManager getInstance()
    {
        return INSTANCE;
    }
