...
public class DamageSource {
   ...
   public static DamageSource field_190095_e = (new DamageSource("hotFloor")).func_76361_j();
   ...
   public static DamageSource field_188406_j = (new DamageSource("flyIntoWall")).func_76348_h();
   ...
   public static DamageSource field_188407_q = (new DamageSource("dragonBreath")).func_76348_h();
