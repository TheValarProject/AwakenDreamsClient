   ...
   protected void func_150269_b(String p_150269_1_) {
      ...
      try {
         ...
         for(; matcher.find(j); j = l) {
            ...
            l = matcher.end();
            if(k > j) {
               TextComponentString textcomponentstring = new TextComponentString(String.format(p_150269_1_.substring(j, k), new Object[0]));
         ...
         if(j < p_150269_1_.length()) {
            TextComponentString textcomponentstring1 = new TextComponentString(String.format(p_150269_1_.substring(j), new Object[0]));
