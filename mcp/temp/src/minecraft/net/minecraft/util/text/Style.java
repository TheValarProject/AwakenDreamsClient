         ...
         if(p_deserialize_1_.isJsonObject()) {
            ...
            if(jsonobject == null) {
               ...
               if(jsonobject.has("bold")) {
                  style.field_150248_c = Boolean.valueOf(jsonobject.get("bold").getAsBoolean());
               }

               if(jsonobject.has("italic")) {
                  style.field_150245_d = Boolean.valueOf(jsonobject.get("italic").getAsBoolean());
               }

               if(jsonobject.has("underlined")) {
                  style.field_150246_e = Boolean.valueOf(jsonobject.get("underlined").getAsBoolean());
               }

               if(jsonobject.has("strikethrough")) {
                  style.field_150243_f = Boolean.valueOf(jsonobject.get("strikethrough").getAsBoolean());
               }

               if(jsonobject.has("obfuscated")) {
                  style.field_150244_g = Boolean.valueOf(jsonobject.get("obfuscated").getAsBoolean());
               }
