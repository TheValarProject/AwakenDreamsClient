...
public class ScreenShotHelper {
   ...
   public static ITextComponent func_148259_a(File p_148259_0_, String p_148259_1_, int p_148259_2_, int p_148259_3_, Framebuffer p_148259_4_) {
      try {
   ...
   public static BufferedImage func_186719_a(int p_186719_0_, int p_186719_1_, Framebuffer p_186719_2_) {
      ...
      if(OpenGlHelper.func_148822_b()) {
         ...
         GlStateManager.func_187433_a(3553, 0, '\u80e1', '\u8367', field_74293_b);
      } else {
         GlStateManager.func_187413_a(0, 0, p_186719_0_, p_186719_1_, '\u80e1', '\u8367', field_74293_b);
      }
      ...
      if(OpenGlHelper.func_148822_b()) {
         bufferedimage = new BufferedImage(p_186719_2_.field_147621_c, p_186719_2_.field_147618_d, 1);
         int j = p_186719_2_.field_147620_b - p_186719_2_.field_147618_d;

         for(int k = j; k < p_186719_2_.field_147620_b; ++k) {
            for(int l = 0; l < p_186719_2_.field_147621_c; ++l) {
               bufferedimage.setRGB(l, k - j, field_74294_c[k * p_186719_2_.field_147622_a + l]);
            }
         }
      } else {
