...
public final class EntitySelectors {
   ...
   public static final Predicate<Entity> field_188445_f = new Predicate<Entity>() {
      public boolean apply(@Nullable Entity p_apply_1_) {
         return p_apply_1_ instanceof EntityShulker && p_apply_1_.func_70089_S();
      }
   };
   ...
   public static class ArmoredMob implements Predicate<Entity> {
      ...
      public boolean apply(@Nullable Entity p_apply_1_) {
         if(!p_apply_1_.func_70089_S()) {
            ...
            return entitylivingbase.func_184582_a(EntityLiving.func_184640_d(this.field_96567_c)) != null?false:(entitylivingbase instanceof EntityLiving?((EntityLiving)entitylivingbase).func_98052_bS():(entitylivingbase instanceof EntityArmorStand?true:entitylivingbase instanceof EntityPlayer));
         }
      }
   }
}
