...
public class DataFixer implements IDataFixer {
   ...
   public NBTTagCompound func_188257_a(IFixType p_188257_1_, NBTTagCompound p_188257_2_) {
      ...
      return i >= 510?p_188257_2_:this.func_188251_a(p_188257_1_, p_188257_2_, i);
   }
   ...
   public void func_188256_a(IFixType p_188256_1_, IFixableData p_188256_2_) {
      ...
      if(i > this.field_188262_d) {
         field_188259_a.warn("Ignored fix registered for version: {} as the DataVersion of the game is: {}", new Object[]{Integer.valueOf(i), Integer.valueOf(this.field_188262_d)});
      } else {
