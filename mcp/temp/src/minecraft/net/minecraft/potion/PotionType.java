...
public class PotionType {
   ...
   @Nullable
   public static PotionType func_185169_a(int p_185169_0_) {
      return (PotionType)field_185176_a.func_148754_a(p_185169_0_);
   }

   public static int func_185171_a(PotionType p_185171_0_) {
      return field_185176_a.func_148757_b(p_185171_0_);
   }

   @Nullable
   public static PotionType func_185168_a(String p_185168_0_) {
      return (PotionType)field_185176_a.func_82594_a(new ResourceLocation(p_185168_0_));
   }
