...
public class PotionUtils {
   ...
   public static int func_185183_a(PotionType p_185183_0_) {
      return func_185181_a(p_185183_0_.func_185170_a());
   }
   ...
   public static PotionType func_185187_c(@Nullable NBTTagCompound p_185187_0_) {
      return p_185187_0_ == null?PotionTypes.field_185230_b:PotionType.func_185168_a(p_185187_0_.func_74779_i("Potion"));
   }

   public static ItemStack func_185188_a(ItemStack p_185188_0_, PotionType p_185188_1_) {
      ResourceLocation resourcelocation = (ResourceLocation)PotionType.field_185176_a.func_177774_c(p_185188_1_);
      if(resourcelocation != null) {
         NBTTagCompound nbttagcompound = p_185188_0_.func_77942_o()?p_185188_0_.func_77978_p():new NBTTagCompound();
         nbttagcompound.func_74778_a("Potion", resourcelocation.toString());
         p_185188_0_.func_77982_d(nbttagcompound);
      }
   ...
   public static ItemStack func_185184_a(ItemStack p_185184_0_, Collection<PotionEffect> p_185184_1_) {
      if(p_185184_1_.isEmpty()) {
         ...
         NBTTagCompound nbttagcompound = (NBTTagCompound)Objects.firstNonNull(p_185184_0_.func_77978_p(), new NBTTagCompound());
   ...
   public static void func_185182_a(ItemStack p_185182_0_, List<String> p_185182_1_, float p_185182_2_) {
      ...
      if(!list1.isEmpty()) {
         ...
         for(Tuple<String, AttributeModifier> tuple : list1) {
            ...
            if(d0 > 0.0D) {
               p_185182_1_.add(TextFormatting.BLUE + I18n.func_74837_a("attribute.modifier.plus." + attributemodifier2.func_111169_c(), new Object[]{ItemStack.field_111284_a.format(d1), I18n.func_74838_a("attribute.name." + (String)tuple.func_76341_a())}));
            } else if(d0 < 0.0D) {
               d1 = d1 * -1.0D;
               p_185182_1_.add(TextFormatting.RED + I18n.func_74837_a("attribute.modifier.take." + attributemodifier2.func_111169_c(), new Object[]{ItemStack.field_111284_a.format(d1), I18n.func_74838_a("attribute.name." + (String)tuple.func_76341_a())}));
            }
         }
      }
