         ...
         if(gameprofile != null && gameprofile.getId() != null) {
            ...
            ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback() {
               ...
               public void onProfileLookupFailed(GameProfile p_onProfileLookupFailed_1_, Exception p_onProfileLookupFailed_2_) {
                  PreYggdrasilConverter.field_152732_e.warn("Could not lookup user whitelist entry for {}", new Object[]{p_onProfileLookupFailed_1_.getName(), p_onProfileLookupFailed_2_});
               }
            };
            func_152717_a(p_187473_0_, Lists.newArrayList(new String[]{p_187473_1_}), profilelookupcallback);
