...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable {
   ...
   public void func_147322_a(String p_147322_1_) {
      try {
         field_147332_c.info("Disconnecting {}: {}", new Object[]{this.func_147317_d(), p_147322_1_});
         TextComponentString textcomponentstring = new TextComponentString(p_147322_1_);
         this.field_147333_a.func_179290_a(new SPacketDisconnect(textcomponentstring));
         this.field_147333_a.func_150718_a(textcomponentstring);
   ...
   public void func_147231_a(ITextComponent p_147231_1_) {
      field_147332_c.info("{} lost connection: {}", new Object[]{this.func_147317_d(), p_147231_1_.func_150260_c()});
   }
            ...
            public void run() {
               ...
               try {
                  ...
                  if(NetHandlerLoginServer.this.field_147337_i != null) {
                     NetHandlerLoginServer.field_147332_c.info("UUID of player {} is {}", new Object[]{NetHandlerLoginServer.this.field_147337_i.getName(), NetHandlerLoginServer.this.field_147337_i.getId()});
                     ...
                     NetHandlerLoginServer.field_147332_c.error("Username \'{}\' tried to join with an invalid session", new Object[]{gameprofile.getName()});
                  }
