...
public class NetHandlerHandshakeTCP implements INetHandlerHandshakeServer {
   ...
   public void func_147383_a(C00Handshake p_147383_1_) {
      ...
      case LOGIN:
         ...
         if(p_147383_1_.func_149595_d() > 210) {
            TextComponentString textcomponentstring = new TextComponentString("Outdated server! I\'m still on 1.10");
         ...
         } else if(p_147383_1_.func_149595_d() < 210) {
            TextComponentString textcomponentstring1 = new TextComponentString("Outdated client! Please use 1.10");
