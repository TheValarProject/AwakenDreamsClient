...
public class WalkNodeProcessor extends NodeProcessor {
   ...
   public PathPoint func_186325_a(double p_186325_1_, double p_186325_3_, double p_186325_5_) {
      return this.func_176159_a(MathHelper.func_76128_c(p_186325_1_ - (double)(this.field_186326_b.field_70130_N / 2.0F)), MathHelper.func_76128_c(p_186325_3_), MathHelper.func_76128_c(p_186325_5_ - (double)(this.field_186326_b.field_70130_N / 2.0F)));
   }
   ...
   public PathNodeType func_186319_a(IBlockAccess p_186319_1_, int p_186319_2_, int p_186319_3_, int p_186319_4_, EntityLiving p_186319_5_, int p_186319_6_, int p_186319_7_, int p_186319_8_, boolean p_186319_9_, boolean p_186319_10_) {
      ...
      for(int i = 0; i < p_186319_6_; ++i) {
         for(int j = 0; j < p_186319_7_; ++j) {
            for(int k = 0; k < p_186319_8_; ++k) {
               int l = i + p_186319_2_;
               int i1 = j + p_186319_3_;
               int j1 = k + p_186319_4_;
               PathNodeType pathnodetype1 = this.func_186330_a(p_186319_1_, l, i1, j1);
               ...
               if(pathnodetype1 == PathNodeType.RAIL && !(p_186319_1_.func_180495_p(blockpos).func_177230_c() instanceof BlockRailBase) && !(p_186319_1_.func_180495_p(blockpos.func_177977_b()).func_177230_c() instanceof BlockRailBase)) {
   ...
   public PathNodeType func_186330_a(IBlockAccess p_186330_1_, int p_186330_2_, int p_186330_3_, int p_186330_4_) {
      ...
      if(pathnodetype == PathNodeType.WALKABLE) {
         for(int j = -1; j <= 1; ++j) {
            for(int i = -1; i <= 1; ++i) {
               if(j != 0 || i != 0) {
                  Block block1 = p_186330_1_.func_180495_p(blockpos$pooledmutableblockpos.func_181079_c(j + p_186330_2_, p_186330_3_, i + p_186330_4_)).func_177230_c();
