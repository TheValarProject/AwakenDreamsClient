...
public abstract class MobSpawnerBaseLogic {
   ...
   private String func_98276_e() {
      return this.field_98282_f.func_185277_b().func_74779_i("id");
   }

   public void func_98272_a(String p_98272_1_) {
      this.field_98282_f.func_185277_b().func_74778_a("id", p_98272_1_);
   }
   ...
   public void func_98270_a(NBTTagCompound p_98270_1_) {
      ...
      NBTTagCompound nbttagcompound = p_98270_1_.func_74775_l("SpawnData");
      if(!nbttagcompound.func_150297_b("id", 8)) {
         nbttagcompound.func_74778_a("id", "Pig");
      }
