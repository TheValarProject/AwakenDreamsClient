...
public class TileEntityEndGateway extends TileEntity implements ITickable {
   ...
   public float func_184302_e() {
      return MathHelper.func_76131_a((float)this.field_184315_f / 200.0F, 0.0F, 1.0F);
   }

   public float func_184305_g() {
      return 1.0F - MathHelper.func_76131_a((float)this.field_184316_g / 20.0F, 0.0F, 1.0F);
   }
