...
public class TileEntityDispenser extends TileEntityLockableLoot implements IInventory {
   ...
   public ItemStack func_70298_a(int p_70298_1_, int p_70298_2_) {
      this.func_184281_d((EntityPlayer)null);
      ItemStack itemstack = ItemStackHelper.func_188382_a(this.field_146022_i, p_70298_1_, p_70298_2_);
      if(itemstack != null) {
         this.func_70296_d();
      }
   ...
   public ItemStack func_70304_b(int p_70304_1_) {
      this.func_184281_d((EntityPlayer)null);
      return ItemStackHelper.func_188383_a(this.field_146022_i, p_70304_1_);
   }
   ...
   public static void func_189678_a(DataFixer p_189678_0_) {
      p_189678_0_.func_188258_a(FixTypes.BLOCK_ENTITY, new ItemStackDataLists("Trap", new String[]{"Items"}));
   }
   ...
   public NBTTagCompound func_189515_b(NBTTagCompound p_189515_1_) {
      ...
      if(this.func_145818_k_()) {
         p_189515_1_.func_74778_a("CustomName", this.field_146020_a);
      }
