...
public class TileEntityHopper extends TileEntityLockableLoot implements IHopper, ITickable {
   ...
   public static void func_189683_a(DataFixer p_189683_0_) {
      p_189683_0_.func_188258_a(FixTypes.BLOCK_ENTITY, new ItemStackDataLists("Hopper", new String[]{"Items"}));
   }
   ...
   public NBTTagCompound func_189515_b(NBTTagCompound p_189515_1_) {
      ...
      if(this.func_145818_k_()) {
         p_189515_1_.func_74778_a("CustomName", this.field_145902_i);
      }
   ...
   public ItemStack func_70298_a(int p_70298_1_, int p_70298_2_) {
      this.func_184281_d((EntityPlayer)null);
      return ItemStackHelper.func_188382_a(this.field_145900_a, p_70298_1_, p_70298_2_);
   }

   @Nullable
   public ItemStack func_70304_b(int p_70304_1_) {
      this.func_184281_d((EntityPlayer)null);
      return ItemStackHelper.func_188383_a(this.field_145900_a, p_70304_1_);
   }
   ...
   public boolean func_145818_k_() {
      return this.field_145902_i != null && !this.field_145902_i.isEmpty();
   }
   ...
   public static ItemStack func_174918_a(IInventory p_174918_0_, ItemStack p_174918_1_, @Nullable EnumFacing p_174918_2_) {
