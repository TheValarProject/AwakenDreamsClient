...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
   ...
   public static void func_189676_a(DataFixer p_189676_0_) {
      p_189676_0_.func_188258_a(FixTypes.BLOCK_ENTITY, new ItemStackDataLists("Furnace", new String[]{"Items"}));
   }
      ...
      if(!this.field_145850_b.field_72995_K) {
         if(this.func_145950_i() || this.field_145957_n[1] != null && this.field_145957_n[0] != null) {
            if(!this.func_145950_i() && this.func_145948_k()) {
               this.field_145956_a = func_145952_a(this.field_145957_n[1]);
   ...
   public int func_174904_a(@Nullable ItemStack p_174904_1_) {
      return 200;
   }
   ...
   public boolean func_94041_b(int p_94041_1_, ItemStack p_94041_2_) {
      if(p_94041_1_ == 2) {
         ...
         ItemStack itemstack = this.field_145957_n[1];
         return func_145954_b(p_94041_2_) || SlotFurnaceFuel.func_178173_c_(p_94041_2_) && (itemstack == null || itemstack.func_77973_b() != Items.field_151133_ar);
      }
   }
