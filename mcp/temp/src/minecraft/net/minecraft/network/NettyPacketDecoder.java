         ...
         if(packet == null) {
            ...
            if(packetbuffer.readableBytes() > 0) {
               ...
               if(field_150800_a.isDebugEnabled()) {
                  field_150800_a.debug(field_150799_b, " IN: [{}:{}] {}", new Object[]{p_decode_1_.channel().attr(NetworkManager.field_150739_c).get(), Integer.valueOf(i), packet.getClass().getName()});
               }
