...
public class EntityDataManager {
   ...
   public static <T> DataParameter<T> func_187226_a(Class<? extends Entity> p_187226_0_, DataSerializer<T> p_187226_1_) {
      ...
      if(field_187232_a.containsKey(p_187226_0_)) {
         i = ((Integer)field_187232_a.get(p_187226_0_)).intValue() + 1;
      } else {
         int j = 0;
         Class<?> oclass = p_187226_0_;

         while(oclass != Entity.class) {
            oclass = oclass.getSuperclass();
            if(field_187232_a.containsKey(oclass)) {
               j = ((Integer)field_187232_a.get(oclass)).intValue() + 1;
               break;
            }
         }
      ...
      if(i > 254) {
         ...
         field_187232_a.put(p_187226_0_, Integer.valueOf(i));
         return p_187226_1_.func_187161_a(i);
      }
   }
