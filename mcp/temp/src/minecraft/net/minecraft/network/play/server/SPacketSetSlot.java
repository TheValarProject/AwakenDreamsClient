...
public class SPacketSetSlot implements Packet<INetHandlerPlayClient> {
   ...
   public SPacketSetSlot(int p_i46951_1_, int p_i46951_2_, @Nullable ItemStack p_i46951_3_) {
      this.field_149179_a = p_i46951_1_;
      this.field_149177_b = p_i46951_2_;
      this.field_149178_c = p_i46951_3_ == null?null:p_i46951_3_.func_77946_l();
   }
