...
public class SPacketEntityEquipment implements Packet<INetHandlerPlayClient> {
   ...
   public SPacketEntityEquipment(int p_i46913_1_, EntityEquipmentSlot p_i46913_2_, @Nullable ItemStack p_i46913_3_) {
      this.field_149394_a = p_i46913_1_;
      this.field_149392_b = p_i46913_2_;
      this.field_149393_c = p_i46913_3_ == null?null:p_i46913_3_.func_77946_l();
   }
