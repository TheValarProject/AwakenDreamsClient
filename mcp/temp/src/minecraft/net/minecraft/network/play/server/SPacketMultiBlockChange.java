...
public class SPacketMultiBlockChange implements Packet<INetHandlerPlayClient> {
   ...
   public void func_148837_a(PacketBuffer p_148837_1_) throws IOException {
      ...
      for(int i = 0; i < this.field_179845_b.length; ++i) {
         this.field_179845_b[i] = new SPacketMultiBlockChange.BlockUpdateData(p_148837_1_.readShort(), (IBlockState)Block.field_176229_d.func_148745_a(p_148837_1_.func_150792_a()));
      }
