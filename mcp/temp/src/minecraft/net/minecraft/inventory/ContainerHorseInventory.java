...
public class ContainerHorseInventory extends Container {
   ...
   private final EntityHorse field_111242_f;
   ...
   public ContainerHorseInventory(IInventory p_i45791_1_, final IInventory p_i45791_2_, final EntityHorse p_i45791_3_, EntityPlayer p_i45791_4_) {
      ...
      this.func_75146_a(new Slot(p_i45791_2_, 1, 8, 36) {
         public boolean func_75214_a(@Nullable ItemStack p_75214_1_) {
            return super.func_75214_a(p_75214_1_) && p_i45791_3_.func_184781_cZ().func_188603_j() && HorseArmorType.func_188577_b(p_75214_1_.func_77973_b());
         }

         public boolean func_111238_b() {
            return p_i45791_3_.func_184781_cZ().func_188603_j();
         }
      });
