...
public class ContainerBrewingStand extends Container {
   ...
   static class Fuel extends Slot {
      ...
      public static boolean func_185004_b_(@Nullable ItemStack p_185004_0_) {
         return p_185004_0_ != null && p_185004_0_.func_77973_b() == Items.field_151065_br;
      }
   ...
   static class Potion extends Slot {
      ...
      public static boolean func_75243_a_(@Nullable ItemStack p_75243_0_) {
         if(p_75243_0_ == null) {
            return false;
         } else {
