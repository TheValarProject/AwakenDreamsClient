...
public class SlotMerchantResult extends Slot {
   ...
   public void func_82870_a(EntityPlayer p_82870_1_, ItemStack p_82870_2_) {
      ...
      if(merchantrecipe != null) {
         ...
         if(this.func_75230_a(merchantrecipe, itemstack, itemstack1) || this.func_75230_a(merchantrecipe, itemstack1, itemstack)) {
            ...
            p_82870_1_.func_71029_a(StatList.field_188075_I);
   ...
   private boolean func_75230_a(MerchantRecipe p_75230_1_, ItemStack p_75230_2_, ItemStack p_75230_3_) {
      ...
      if(p_75230_2_ != null && p_75230_2_.func_77973_b() == itemstack.func_77973_b() && p_75230_2_.field_77994_a >= itemstack.field_77994_a) {
         if(itemstack1 != null && p_75230_3_ != null && itemstack1.func_77973_b() == p_75230_3_.func_77973_b() && p_75230_3_.field_77994_a >= itemstack1.field_77994_a) {
