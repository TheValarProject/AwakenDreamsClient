...
public class EnchantmentDamage extends Enchantment {
   ...
   public float func_152376_a(int p_152376_1_, EnumCreatureAttribute p_152376_2_) {
      return this.field_77361_a == 0?1.0F + (float)Math.max(0, p_152376_1_ - 1) * 0.5F:(this.field_77361_a == 1 && p_152376_2_ == EnumCreatureAttribute.UNDEAD?(float)p_152376_1_ * 2.5F:(this.field_77361_a == 2 && p_152376_2_ == EnumCreatureAttribute.ARTHROPOD?(float)p_152376_1_ * 2.5F:0.0F));
   }
