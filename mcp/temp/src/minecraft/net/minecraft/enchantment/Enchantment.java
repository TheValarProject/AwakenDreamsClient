...
public abstract class Enchantment {
   ...
   public static Enchantment func_185262_c(int p_185262_0_) {
      return (Enchantment)field_185264_b.func_148754_a(p_185262_0_);
   }
   ...
   public static Enchantment func_180305_b(String p_180305_0_) {
      return (Enchantment)field_185264_b.func_82594_a(new ResourceLocation(p_180305_0_));
   }
   ...
   @Nullable
   public Iterable<ItemStack> func_185260_a(EntityLivingBase p_185260_1_) {
