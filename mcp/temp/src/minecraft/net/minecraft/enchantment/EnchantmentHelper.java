...
public class EnchantmentHelper {
   ...
   public static int func_77506_a(Enchantment p_77506_0_, @Nullable ItemStack p_77506_1_) {
      if(p_77506_1_ == null) {
         return 0;
      } else {
         ...
         if(nbttaglist == null) {
            ...
            for(int i = 0; i < nbttaglist.func_74745_c(); ++i) {
               Enchantment enchantment = Enchantment.func_185262_c(nbttaglist.func_150305_b(i).func_74765_d("id"));
               int j = nbttaglist.func_150305_b(i).func_74765_d("lvl");
      ...
      for(Entry<Enchantment, Integer> entry : p_82782_0_.entrySet()) {
         ...
         if(enchantment != null) {
            ...
            if(p_82782_1_.func_77973_b() == Items.field_151134_bR) {
               Items.field_151134_bR.func_92115_a(p_82782_1_, new EnchantmentData(enchantment, i));
            }
         }
      }
   ...
   public static int func_151386_g(EntityLivingBase p_151386_0_) {
      return func_185284_a(Enchantments.field_151370_z, p_151386_0_);
   }

   public static int func_151387_h(EntityLivingBase p_151387_0_) {
      return func_185284_a(Enchantments.field_151369_A, p_151387_0_);
   }
   ...
   public static ItemStack func_92099_a(Enchantment p_92099_0_, EntityLivingBase p_92099_1_) {
      Iterable<ItemStack> iterable = p_92099_0_.func_185260_a(p_92099_1_);
      if(iterable == null) {
         return null;
      } else {
         ...
         for(ItemStack itemstack : iterable) {
            if(itemstack != null && func_77506_a(p_92099_0_, itemstack) > 0) {
               list.add(itemstack);
            }
         }

         return list.isEmpty()?null:(ItemStack)list.get(p_92099_1_.func_70681_au().nextInt(list.size()));
      }
   }
