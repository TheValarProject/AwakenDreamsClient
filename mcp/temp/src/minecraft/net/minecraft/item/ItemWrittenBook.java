...
public class ItemWrittenBook extends Item {
   ...
   public void func_77624_a(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List<String> p_77624_3_, boolean p_77624_4_) {
      if(p_77624_1_.func_77942_o()) {
         ...
         if(!StringUtils.func_151246_b(s)) {
            p_77624_3_.add(TextFormatting.GRAY + I18n.func_74837_a("book.byAuthor", new Object[]{s}));
         }
         ...
         if(!nbttagcompound.func_74767_n("resolved")) {
            ...
            if(func_77828_a(nbttagcompound)) {
               ...
               for(int i = 0; i < nbttaglist.func_74745_c(); ++i) {
                  ...
                  try {
                     lvt_7_1_ = ITextComponent.Serializer.func_186877_b(s);
                     lvt_7_1_ = TextComponentUtils.func_179985_a(p_179229_2_, lvt_7_1_, p_179229_2_);
                  } catch (Exception var9) {
                     lvt_7_1_ = new TextComponentString(s);
                  }

                  nbttaglist.func_150304_a(i, new NBTTagString(ITextComponent.Serializer.func_150696_a(lvt_7_1_)));
               }
