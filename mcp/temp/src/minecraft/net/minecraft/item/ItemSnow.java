...
public class ItemSnow extends ItemBlock {
   ...
   public EnumActionResult func_180614_a(ItemStack p_180614_1_, EntityPlayer p_180614_2_, World p_180614_3_, BlockPos p_180614_4_, EnumHand p_180614_5_, EnumFacing p_180614_6_, float p_180614_7_, float p_180614_8_, float p_180614_9_) {
      if(p_180614_1_.field_77994_a != 0 && p_180614_2_.func_175151_a(p_180614_4_, p_180614_6_, p_180614_1_)) {
         IBlockState iblockstate = p_180614_3_.func_180495_p(p_180614_4_);
         Block block = iblockstate.func_177230_c();
         BlockPos blockpos = p_180614_4_;
         if((p_180614_6_ != EnumFacing.UP || block != this.field_150939_a) && !block.func_176200_f(p_180614_3_, p_180614_4_)) {
            blockpos = p_180614_4_.func_177972_a(p_180614_6_);
         ...
         if(block == this.field_150939_a) {
            ...
            if(i <= 7) {
               ...
               AxisAlignedBB axisalignedbb = iblockstate1.func_185890_d(p_180614_3_, blockpos);
         ...
         return super.func_180614_a(p_180614_1_, p_180614_2_, p_180614_3_, blockpos, p_180614_5_, p_180614_6_, p_180614_7_, p_180614_8_, p_180614_9_);
      } else {
