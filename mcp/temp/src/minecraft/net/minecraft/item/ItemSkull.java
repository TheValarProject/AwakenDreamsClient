...
public class ItemSkull extends Item {
   ...
   public EnumActionResult func_180614_a(ItemStack p_180614_1_, EntityPlayer p_180614_2_, World p_180614_3_, BlockPos p_180614_4_, EnumHand p_180614_5_, EnumFacing p_180614_6_, float p_180614_7_, float p_180614_8_, float p_180614_9_) {
      if(p_180614_6_ == EnumFacing.DOWN) {
         ...
         if(p_180614_2_.func_175151_a(p_180614_4_, p_180614_6_, p_180614_1_) && Blocks.field_150465_bP.func_176196_c(p_180614_3_, p_180614_4_)) {
            if(p_180614_3_.field_72995_K) {
               return EnumActionResult.SUCCESS;
            } else {
               p_180614_3_.func_180501_a(p_180614_4_, Blocks.field_150465_bP.func_176223_P().func_177226_a(BlockSkull.field_176418_a, p_180614_6_), 11);
               int i = 0;
   ...
   public String func_77653_i(ItemStack p_77653_1_) {
      if(p_77653_1_.func_77960_j() == 3 && p_77653_1_.func_77942_o()) {
         if(p_77653_1_.func_77978_p().func_150297_b("SkullOwner", 8)) {
            return I18n.func_74837_a("item.skull.player.name", new Object[]{p_77653_1_.func_77978_p().func_74779_i("SkullOwner")});
         }
   ...
   public boolean func_179215_a(NBTTagCompound p_179215_1_) {
      ...
      if(p_179215_1_.func_150297_b("SkullOwner", 8) && !p_179215_1_.func_74779_i("SkullOwner").isEmpty()) {
