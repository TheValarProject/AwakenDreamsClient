                  ...
                  if(k1 >= 0 && l1 >= -1 && k1 < 128 && l1 < 128) {
                     ...
                     if(!chunk.func_76621_g()) {
                        ...
                        if(p_77872_1_.field_73011_w.func_177495_o()) {
                           ...
                           if((l3 >> 20 & 1) == 0) {
                              multiset.add(Blocks.field_150346_d.func_176223_P().func_177226_a(BlockDirt.field_176386_a, BlockDirt.DirtType.DIRT).func_185909_g(), 10);
                           } else {
                              multiset.add(Blocks.field_150348_b.func_176223_P().func_177226_a(BlockStone.field_176247_a, BlockStone.EnumType.STONE).func_185909_g(), 100);
                           }
                           ...
                           for(int i4 = 0; i4 < i; ++i4) {
                              for(int j4 = 0; j4 < i; ++j4) {
                                 ...
                                 if(k4 > 1) {
                                    label542: {
                                       while(true) {
                                          ...
                                          if(iblockstate.func_185909_g() != MapColor.field_151660_b || k4 <= 0) {
                                             break;
                                          }
                                       }
                                 ...
                                 multiset.add(iblockstate.func_185909_g());
                              }
                           }
                        }
