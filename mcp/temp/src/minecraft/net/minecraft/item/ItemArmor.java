...
public class ItemArmor extends Item {
   ...
   public static final IBehaviorDispenseItem field_96605_cw = new BehaviorDefaultDispenseItem() {
      protected ItemStack func_82487_b(IBlockSource p_82487_1_, ItemStack p_82487_2_) {
         ...
         return itemstack != null?itemstack:super.func_82487_b(p_82487_1_, p_82487_2_);
      }
   };
   ...
   public static ItemStack func_185082_a(IBlockSource p_185082_0_, ItemStack p_185082_1_) {
      ...
      List<EntityLivingBase> list = p_185082_0_.func_82618_k().<EntityLivingBase>func_175647_a(EntityLivingBase.class, new AxisAlignedBB(blockpos), Predicates.<EntityLivingBase>and(EntitySelectors.field_180132_d, new EntitySelectors.ArmoredMob(p_185082_1_)));
      if(list.isEmpty()) {
         return null;
      } else {
         EntityLivingBase entitylivingbase = (EntityLivingBase)list.get(0);
         EntityEquipmentSlot entityequipmentslot = EntityLiving.func_184640_d(p_185082_1_);
         ItemStack itemstack = p_185082_1_.func_77946_l();
