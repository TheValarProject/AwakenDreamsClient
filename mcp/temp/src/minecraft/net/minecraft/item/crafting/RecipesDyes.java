...
public class RecipesDyes {
   public void func_77607_a(CraftingManager p_77607_1_) {
      for(int i = 0; i < 16; ++i) {
         p_77607_1_.func_77596_b(new ItemStack(Blocks.field_150325_L, 1, i), new Object[]{new ItemStack(Items.field_151100_aR, 1, 15 - i), new ItemStack(Item.func_150898_a(Blocks.field_150325_L))});
      ...
      p_77607_1_.func_77596_b(new ItemStack(Items.field_151100_aR, 9, EnumDyeColor.WHITE.func_176767_b()), new Object[]{Blocks.field_189880_di});
      ...
      p_77607_1_.func_77596_b(new ItemStack(Items.field_151100_aR, 1, EnumDyeColor.RED.func_176767_b()), new Object[]{new ItemStack(Items.field_185164_cV, 1)});
