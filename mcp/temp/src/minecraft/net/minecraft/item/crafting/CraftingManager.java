...
public class CraftingManager {
   ...
   private CraftingManager() {
      ...
      this.func_92103_a(new ItemStack(Blocks.field_150333_U, 6, BlockStoneSlab.EnumType.STONE.func_176624_a()), new Object[]{"###", Character.valueOf('#'), new ItemStack(Blocks.field_150348_b, 1, BlockStone.EnumType.STONE.func_176642_a())});
      ...
      this.func_92103_a(new ItemStack(Blocks.field_185771_cX, 6, 0), new Object[]{"###", Character.valueOf('#'), Blocks.field_185767_cT});
      ...
      this.func_92103_a(new ItemStack(Items.field_151124_az, 1), new Object[]{"# #", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150344_f, 1, BlockPlanks.EnumType.OAK.func_176839_a())});
      this.func_92103_a(new ItemStack(Items.field_185150_aH, 1), new Object[]{"# #", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150344_f, 1, BlockPlanks.EnumType.SPRUCE.func_176839_a())});
      this.func_92103_a(new ItemStack(Items.field_185151_aI, 1), new Object[]{"# #", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150344_f, 1, BlockPlanks.EnumType.BIRCH.func_176839_a())});
      this.func_92103_a(new ItemStack(Items.field_185152_aJ, 1), new Object[]{"# #", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150344_f, 1, BlockPlanks.EnumType.JUNGLE.func_176839_a())});
      this.func_92103_a(new ItemStack(Items.field_185153_aK, 1), new Object[]{"# #", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150344_f, 1, BlockPlanks.EnumType.ACACIA.func_176839_a())});
      this.func_92103_a(new ItemStack(Items.field_185154_aL, 1), new Object[]{"# #", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150344_f, 1, BlockPlanks.EnumType.DARK_OAK.func_176839_a())});
      ...
      this.func_92103_a(new ItemStack(Items.field_151153_ao), new Object[]{"###", "#X#", "###", Character.valueOf('#'), Items.field_151043_k, Character.valueOf('X'), Items.field_151034_e});
      this.func_92103_a(new ItemStack(Items.field_151150_bK), new Object[]{"###", "#X#", "###", Character.valueOf('#'), Items.field_151074_bl, Character.valueOf('X'), Items.field_151172_bF});
      ...
      this.func_92103_a(new ItemStack(Items.field_185158_cP), new Object[]{"GGG", "GEG", "GTG", Character.valueOf('G'), Blocks.field_150359_w, Character.valueOf('E'), Items.field_151061_bv, Character.valueOf('T'), Items.field_151073_bk});
      ...
      this.func_92103_a(new ItemStack(Blocks.field_185764_cQ, 4), new Object[]{"/", "#", Character.valueOf('/'), Items.field_151072_bj, Character.valueOf('#'), Items.field_185162_cT});
      this.func_92103_a(new ItemStack(Blocks.field_189880_di, 1), new Object[]{"XXX", "XXX", "XXX", Character.valueOf('X'), new ItemStack(Items.field_151100_aR, 1, EnumDyeColor.WHITE.func_176767_b())});
