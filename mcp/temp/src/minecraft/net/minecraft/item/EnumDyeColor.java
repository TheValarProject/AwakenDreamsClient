...
public enum EnumDyeColor implements IStringSerializable {
   WHITE(0, 15, "white", "white", MapColor.field_151666_j, TextFormatting.WHITE),
   ORANGE(1, 14, "orange", "orange", MapColor.field_151676_q, TextFormatting.GOLD),
   MAGENTA(2, 13, "magenta", "magenta", MapColor.field_151675_r, TextFormatting.AQUA),
   LIGHT_BLUE(3, 12, "light_blue", "lightBlue", MapColor.field_151674_s, TextFormatting.BLUE),
   YELLOW(4, 11, "yellow", "yellow", MapColor.field_151673_t, TextFormatting.YELLOW),
   LIME(5, 10, "lime", "lime", MapColor.field_151672_u, TextFormatting.GREEN),
   PINK(6, 9, "pink", "pink", MapColor.field_151671_v, TextFormatting.LIGHT_PURPLE),
   GRAY(7, 8, "gray", "gray", MapColor.field_151670_w, TextFormatting.DARK_GRAY),
   SILVER(8, 7, "silver", "silver", MapColor.field_151680_x, TextFormatting.GRAY),
   CYAN(9, 6, "cyan", "cyan", MapColor.field_151679_y, TextFormatting.DARK_AQUA),
   PURPLE(10, 5, "purple", "purple", MapColor.field_151678_z, TextFormatting.DARK_PURPLE),
   BLUE(11, 4, "blue", "blue", MapColor.field_151649_A, TextFormatting.DARK_BLUE),
   BROWN(12, 3, "brown", "brown", MapColor.field_151650_B, TextFormatting.GOLD),
   GREEN(13, 2, "green", "green", MapColor.field_151651_C, TextFormatting.DARK_GREEN),
   RED(14, 1, "red", "red", MapColor.field_151645_D, TextFormatting.DARK_RED),
   BLACK(15, 0, "black", "black", MapColor.field_151646_E, TextFormatting.BLACK);
