...
public class Item {
   ...
   public static Item func_111206_d(String p_111206_0_) {
      Item item = (Item)field_150901_e.func_82594_a(new ResourceLocation(p_111206_0_));
      if(item == null) {
         try {
   ...
   public IItemPropertyGetter func_185045_a(ResourceLocation p_185045_1_) {
      return (IItemPropertyGetter)this.field_185051_m.func_82594_a(p_185045_1_);
   }
   ...
   public static void func_150900_l() {
      ...
      func_179214_a(Blocks.field_150398_cm, (new ItemMultiTexture(Blocks.field_150398_cm, Blocks.field_150398_cm, new Function<ItemStack, String>() {
         @Nullable
         public String apply(@Nullable ItemStack p_apply_1_) {
