   ...
   public ActionResult<ItemStack> func_77659_a(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_, EnumHand p_77659_4_) {
      ...
      if(raytraceresult == null) {
         ...
         if(!p_77659_2_.func_175660_a(p_77659_3_, blockpos)) {
            ...
            if(!p_77659_3_.func_175151_a(blockpos.func_177972_a(raytraceresult.field_178784_b), raytraceresult.field_178784_b, p_77659_1_)) {
               return new ActionResult(EnumActionResult.FAIL, p_77659_1_);
            } else {
               ...
               if(material == Material.field_151586_h && ((Integer)iblockstate.func_177229_b(BlockLiquid.field_176367_b)).intValue() == 0) {
                  p_77659_2_.func_180501_a(blockpos, Blocks.field_150350_a.func_176223_P(), 11);
                  p_77659_3_.func_71029_a(StatList.func_188057_b(this));
                  p_77659_3_.func_184185_a(SoundEvents.field_187630_M, 1.0F, 1.0F);
                  return new ActionResult(EnumActionResult.SUCCESS, this.func_150910_a(p_77659_1_, p_77659_3_, Items.field_151131_as));
               } else if(material == Material.field_151587_i && ((Integer)iblockstate.func_177229_b(BlockLiquid.field_176367_b)).intValue() == 0) {
                  p_77659_3_.func_184185_a(SoundEvents.field_187633_N, 1.0F, 1.0F);
                  p_77659_2_.func_180501_a(blockpos, Blocks.field_150350_a.func_176223_P(), 11);
                  p_77659_3_.func_71029_a(StatList.func_188057_b(this));
                  return new ActionResult(EnumActionResult.SUCCESS, this.func_150910_a(p_77659_1_, p_77659_3_, Items.field_151129_at));
               } else {
                  return new ActionResult(EnumActionResult.FAIL, p_77659_1_);
               }
            }
         } else {
            boolean flag1 = p_77659_2_.func_180495_p(blockpos).func_177230_c().func_176200_f(p_77659_2_, blockpos);
            ...
            if(!p_77659_3_.func_175151_a(blockpos1, raytraceresult.field_178784_b, p_77659_1_)) {
               return new ActionResult(EnumActionResult.FAIL, p_77659_1_);
            } else if(this.func_180616_a(p_77659_3_, p_77659_2_, blockpos1)) {
               p_77659_3_.func_71029_a(StatList.func_188057_b(this));
               return !p_77659_3_.field_71075_bZ.field_75098_d?new ActionResult(EnumActionResult.SUCCESS, new ItemStack(Items.field_151133_ar)):new ActionResult(EnumActionResult.SUCCESS, p_77659_1_);
            } else {
               return new ActionResult(EnumActionResult.FAIL, p_77659_1_);
            }
         }
