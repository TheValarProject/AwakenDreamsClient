...
public class ItemHoe extends Item {
   ...
   public EnumActionResult func_180614_a(ItemStack p_180614_1_, EntityPlayer p_180614_2_, World p_180614_3_, BlockPos p_180614_4_, EnumHand p_180614_5_, EnumFacing p_180614_6_, float p_180614_7_, float p_180614_8_, float p_180614_9_) {
      if(!p_180614_2_.func_175151_a(p_180614_4_.func_177972_a(p_180614_6_), p_180614_6_, p_180614_1_)) {
         ...
         if(p_180614_6_ != EnumFacing.DOWN && p_180614_3_.func_180495_p(p_180614_4_.func_177984_a()).func_185904_a() == Material.field_151579_a) {
            if(block == Blocks.field_150349_c || block == Blocks.field_185774_da) {
               this.func_185071_a(p_180614_1_, p_180614_2_, p_180614_3_, p_180614_4_, Blocks.field_150458_ak.func_176223_P());
            ...
            if(block == Blocks.field_150346_d) {
               ...
               case DIRT:
                  ...
                  return EnumActionResult.SUCCESS;
               case COARSE_DIRT:
                  this.func_185071_a(p_180614_1_, p_180614_2_, p_180614_3_, p_180614_4_, Blocks.field_150346_d.func_176223_P().func_177226_a(BlockDirt.field_176386_a, BlockDirt.DirtType.DIRT));
                  return EnumActionResult.SUCCESS;
               }
            }
         }
