...
public class Chunk {
   ...
   public IBlockState func_177436_a(BlockPos p_177436_1_, IBlockState p_177436_2_) {
      ...
      if(iblockstate == p_177436_2_) {
         ...
         if(extendedblockstorage == field_186036_a) {
            ...
            extendedblockstorage = new ExtendedBlockStorage(j >> 4 << 4, !this.field_76637_e.field_73011_w.func_177495_o());
   ...
   public int func_177413_a(EnumSkyBlock p_177413_1_, BlockPos p_177413_2_) {
      ...
      ExtendedBlockStorage extendedblockstorage = this.field_76652_q[j >> 4];
      return extendedblockstorage == field_186036_a?(this.func_177444_d(p_177413_2_)?p_177413_1_.field_77198_c:0):(p_177413_1_ == EnumSkyBlock.SKY?(this.field_76637_e.field_73011_w.func_177495_o()?0:extendedblockstorage.func_76670_c(i, j & 15, k)):(p_177413_1_ == EnumSkyBlock.BLOCK?extendedblockstorage.func_76674_d(i, j & 15, k):p_177413_1_.field_77198_c));
   }
   ...
   public void func_76612_a(Entity p_76612_1_) {
      ...
      if(i != this.field_76635_g || j != this.field_76647_h) {
         field_150817_t.warn("Wrong location! ({}, {}) should be ({}, {}), {}", new Object[]{Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(this.field_76635_g), Integer.valueOf(this.field_76647_h), p_76612_1_, p_76612_1_});
