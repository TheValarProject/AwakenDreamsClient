...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
   ...
   private final Map<ChunkPos, NBTTagCompound> field_75828_a = new ConcurrentHashMap();
   private final Set<ChunkPos> field_75826_b = Collections.<ChunkPos>newSetFromMap(new ConcurrentHashMap());
   ...
   protected Chunk func_75822_a(World p_75822_1_, int p_75822_2_, int p_75822_3_, NBTTagCompound p_75822_4_) {
      if(!p_75822_4_.func_150297_b("Level", 10)) {
         ...
         if(!nbttagcompound.func_150297_b("Sections", 9)) {
            field_151505_a.error("Chunk file at {},{} is missing block data, skipping", new Object[]{Integer.valueOf(p_75822_2_), Integer.valueOf(p_75822_3_)});
            return null;
         } else {
   ...
   public boolean func_75814_c() {
      if(this.field_75828_a.isEmpty()) {
         ...
         boolean lvt_3_1_;
         try {
            this.field_75826_b.add(chunkpos);
            ...
            this.field_75826_b.remove(chunkpos);
         }
