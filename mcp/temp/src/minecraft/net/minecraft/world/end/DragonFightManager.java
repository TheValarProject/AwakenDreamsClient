...
public class DragonFightManager {
   ...
   private static final Predicate<EntityPlayerMP> field_186108_b = Predicates.<EntityPlayerMP>and(EntitySelectors.field_94557_a, EntitySelectors.<EntityPlayerMP>func_188443_a(0.0D, 128.0D, 0.0D, 192.0D));
   ...
   public DragonFightManager(WorldServer p_i46669_1_, NBTTagCompound p_i46669_2_) {
      ...
      this.field_186112_f = FactoryBlockPattern.func_177660_a().func_177659_a(new String[]{"       ", "       ", "       ", "   #   ", "       ", "       ", "       "}).func_177659_a(new String[]{"       ", "       ", "       ", "   #   ", "       ", "       ", "       "}).func_177659_a(new String[]{"       ", "       ", "       ", "   #   ", "       ", "       ", "       "}).func_177659_a(new String[]{"  ###  ", " #   # ", "#     #", "#  #  #", "#     #", " #   # ", "  ###  "}).func_177659_a(new String[]{"       ", "  ###  ", " ##### ", " ##### ", " ##### ", "  ###  ", "       "}).func_177662_a('#', BlockWorldState.func_177510_a(BlockMatcher.func_177642_a(Blocks.field_150357_h))).func_177661_b();
   }
      ...
      if(!this.field_186109_c.func_186757_c().isEmpty()) {
         if(this.field_186120_n) {
            ...
            if(list.isEmpty()) {
               ...
               field_186107_a.info("Found that there\'s a dragon still alive ({})", new Object[]{entitydragon});
   ...
   private BlockPattern.PatternHelper func_186091_h() {
            ...
            for(TileEntity tileentity : chunk.func_177434_r().values()) {
               if(tileentity instanceof TileEntityEndPortal) {
                  ...
                  if(blockpattern$patternhelper != null) {
                     BlockPos blockpos = blockpattern$patternhelper.func_177670_a(3, 3, 4).func_177508_d();
      ...
      for(int l = k; l >= 0; --l) {
         ...
         if(blockpattern$patternhelper1 != null) {
            if(this.field_186121_o == null) {
               this.field_186121_o = blockpattern$patternhelper1.func_177670_a(3, 3, 4).func_177508_d();
            }
   ...
   private void func_186101_k() {
      ...
      field_186107_a.debug("Found {} end crystals still alive", new Object[]{Integer.valueOf(this.field_186114_h)});
   }
      ...
      if(this.field_186117_k && this.field_186122_p == null) {
         ...
         if(blockpos == null) {
            ...
            if(blockpattern$patternhelper == null) {
               ...
               blockpos = blockpattern$patternhelper.func_177670_a(3, 3, 3).func_177508_d();
            }
         }
