...
public class LootTable {
   ...
   public void func_186460_a(IInventory p_186460_1_, Random p_186460_2_, LootContext p_186460_3_) {
      ...
      for(ItemStack itemstack : list) {
         ...
         if(itemstack == null) {
            p_186460_1_.func_70299_a(((Integer)list1.remove(list1.size() - 1)).intValue(), (ItemStack)null);
         } else {
   ...
   private void func_186463_a(List<ItemStack> p_186463_1_, int p_186463_2_, Random p_186463_3_) {
      ...
      while(p_186463_2_ > 0 && ((List)list).size() > 0) {
         ...
         int i = MathHelper.func_76136_a(p_186463_3_, 1, itemstack2.field_77994_a / 2);
         itemstack2.field_77994_a -= i;
         ItemStack itemstack1 = itemstack2.func_77946_l();
         itemstack1.field_77994_a = i;
         if(itemstack2.field_77994_a > 1 && p_186463_3_.nextBoolean()) {
            list.add(itemstack2);
         } else {
            p_186463_1_.add(itemstack2);
         }

         if(itemstack1.field_77994_a > 1 && p_186463_3_.nextBoolean()) {
            list.add(itemstack1);
         } else {
   ...
   private List<Integer> func_186459_a(IInventory p_186459_1_, Random p_186459_2_) {
      ...
      for(int i = 0; i < p_186459_1_.func_70302_i_(); ++i) {
         if(p_186459_1_.func_70301_a(i) == null) {
