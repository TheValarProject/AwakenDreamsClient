...
public class LootEntryItem extends LootEntry {
      ...
      if(itemstack.field_77994_a > 0) {
         if(itemstack.field_77994_a < this.field_186368_a.func_77639_j()) {
            ...
            while(i > 0) {
               ...
               itemstack1.field_77994_a = Math.min(itemstack.func_77976_d(), i);
               i -= itemstack1.field_77994_a;
   ...
   protected void func_186362_a(JsonObject p_186362_1_, JsonSerializationContext p_186362_2_) {
      ...
      ResourceLocation resourcelocation = (ResourceLocation)Item.field_150901_e.func_177774_c(this.field_186368_a);
