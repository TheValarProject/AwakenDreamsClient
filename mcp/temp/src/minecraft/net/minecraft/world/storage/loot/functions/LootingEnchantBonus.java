...
public class LootingEnchantBonus extends LootFunction {
   ...
   public ItemStack func_186553_a(ItemStack p_186553_1_, Random p_186553_2_, LootContext p_186553_3_) {
      ...
      if(entity instanceof EntityLivingBase) {
         ...
         p_186553_1_.field_77994_a += Math.round(f);
         if(this.field_189971_b != 0 && p_186553_1_.field_77994_a > this.field_189971_b) {
            p_186553_1_.field_77994_a = this.field_189971_b;
         }
      }
