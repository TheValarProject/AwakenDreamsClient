...
public class SaveFormatOld implements ISaveFormat {
   ...
   public static WorldInfo func_186353_a(File p_186353_0_, DataFixer p_186353_1_) {
      try {
         ...
         field_151479_b.error("Exception reading {}", new Object[]{p_186353_0_, exception});
         return null;
      }
   }
   ...
   public boolean func_75802_e(String p_75802_1_) {
      ...
      if(!file1.exists()) {
         ...
         field_151479_b.info("Deleting level {}", new Object[]{p_75802_1_});

         for(int i = 1; i <= 5; ++i) {
            field_151479_b.info("Attempt {}...", new Object[]{Integer.valueOf(i)});
   ...
   protected static boolean func_75807_a(File[] p_75807_0_) {
      for(File file1 : p_75807_0_) {
         field_151479_b.debug("Deleting {}", new Object[]{file1});
         if(file1.isDirectory() && !func_75807_a(file1.listFiles())) {
            field_151479_b.warn("Couldn\'t delete directory {}", new Object[]{file1});
            return false;
         }

         if(!file1.delete()) {
            field_151479_b.warn("Couldn\'t delete file {}", new Object[]{file1});
            return false;
         }
      }
