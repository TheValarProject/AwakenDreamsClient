...
public abstract class StructureComponent {
   ...
   protected boolean func_186167_a(World p_186167_1_, StructureBoundingBox p_186167_2_, Random p_186167_3_, int p_186167_4_, int p_186167_5_, int p_186167_6_, ResourceLocation p_186167_7_) {
      ...
      if(p_186167_2_.func_175898_b(blockpos) && p_186167_1_.func_180495_p(blockpos).func_177230_c() != Blocks.field_150486_ae) {
         IBlockState iblockstate = Blocks.field_150486_ae.func_176223_P();
         p_186167_1_.func_180501_a(blockpos, Blocks.field_150486_ae.func_176458_f(p_186167_1_, blockpos, iblockstate), 2);
         TileEntity tileentity = p_186167_1_.func_175625_s(blockpos);
         if(tileentity instanceof TileEntityChest) {
            ((TileEntityChest)tileentity).func_189404_a(p_186167_7_, p_186167_3_.nextLong());
         }
