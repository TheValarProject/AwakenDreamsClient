   ...
   public static class End extends StructureNetherBridgePieces.Piece {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         for(l = 0; l <= 4; ++l) {
            ...
            this.func_175804_a(p_74875_1_, p_74875_3_, l, 2, 0, l, 2, i1, Blocks.field_150385_bj.func_176223_P(), Blocks.field_150385_bj.func_176223_P(), false);
         }

         for(l = 0; l <= 4; ++l) {
            for(int j1 = 0; j1 <= 1; ++j1) {
               int k1 = random.nextInt(3);
               this.func_175804_a(p_74875_1_, p_74875_3_, l, j1, 0, l, j1, k1, Blocks.field_150385_bj.func_176223_P(), Blocks.field_150385_bj.func_176223_P(), false);
            }
         }
