      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         for(i = 1; i <= 6; ++i) {
            ...
            for(int j = 0; j <= 15; j += 15) {
               this.func_175804_a(p_74875_1_, p_74875_3_, j, i, 0, j, i, 1, iblockstate, iblockstate, false);
               this.func_175804_a(p_74875_1_, p_74875_3_, j, i, 6, j, i, 9, iblockstate, iblockstate, false);
               this.func_175804_a(p_74875_1_, p_74875_3_, j, i, 14, j, i, 15, iblockstate, iblockstate, false);
            }

            this.func_175804_a(p_74875_1_, p_74875_3_, 1, i, 0, 1, i, 0, iblockstate, iblockstate, false);
            this.func_175804_a(p_74875_1_, p_74875_3_, 6, i, 0, 9, i, 0, iblockstate, iblockstate, false);
            this.func_175804_a(p_74875_1_, p_74875_3_, 14, i, 0, 14, i, 0, iblockstate, iblockstate, false);
         ...
         for(i = 3; i <= 6; i += 3) {
            for(int k = 6; k <= 9; k += 3) {
               this.func_175811_a(p_74875_1_, field_175825_e, k, i, 6, p_74875_3_);
               this.func_175811_a(p_74875_1_, field_175825_e, k, i, 9, p_74875_3_);
            }
         }
