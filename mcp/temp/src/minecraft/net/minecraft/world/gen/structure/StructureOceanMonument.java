...
public class StructureOceanMonument extends MapGenStructure {
   ...
   public static final List<Biome> field_175802_d = Arrays.<Biome>asList(new Biome[]{Biomes.field_76771_b, Biomes.field_150575_M, Biomes.field_76781_i, Biomes.field_76776_l, Biomes.field_76777_m});
   public static final List<Biome> field_186134_b = Arrays.<Biome>asList(new Biome[]{Biomes.field_150575_M});
