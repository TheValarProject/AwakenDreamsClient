...
public class Template {
   ...
   public void func_189960_a(World p_189960_1_, BlockPos p_189960_2_, @Nullable ITemplateProcessor p_189960_3_, PlacementSettings p_189960_4_, int p_189960_5_) {
      if(!this.field_186270_a.isEmpty() && this.field_186272_c.func_177958_n() >= 1 && this.field_186272_c.func_177956_o() >= 1 && this.field_186272_c.func_177952_p() >= 1) {
   ...
   public BlockPos func_189961_a(BlockPos p_189961_1_, Mirror p_189961_2_, Rotation p_189961_3_) {
      int i = this.func_186259_a().func_177958_n() - 1;
      int j = this.func_186259_a().func_177952_p() - 1;
   ...
   public NBTTagCompound func_189552_a(NBTTagCompound p_189552_1_) {
      ...
      for(Template.BlockInfo template$blockinfo : this.field_186270_a) {
         NBTTagCompound nbttagcompound = new NBTTagCompound();
         nbttagcompound.func_74782_a("pos", this.func_186267_a(new int[]{template$blockinfo.field_186242_a.func_177958_n(), template$blockinfo.field_186242_a.func_177956_o(), template$blockinfo.field_186242_a.func_177952_p()}));
      ...
      for(Template.EntityInfo template$entityinfo : this.field_186271_b) {
         ...
         nbttagcompound1.func_74782_a("pos", this.func_186264_a(new double[]{template$entityinfo.field_186247_a.field_72450_a, template$entityinfo.field_186247_a.field_72448_b, template$entityinfo.field_186247_a.field_72449_c}));
         nbttagcompound1.func_74782_a("blockPos", this.func_186267_a(new int[]{template$entityinfo.field_186248_b.func_177958_n(), template$entityinfo.field_186248_b.func_177956_o(), template$entityinfo.field_186248_b.func_177952_p()}));
      ...
      p_189552_1_.func_74768_a("version", 1);
   ...
   static class BasicPalette implements Iterable<IBlockState> {
      ...
      public IBlockState func_189955_a(int p_189955_1_) {
         IBlockState iblockstate = (IBlockState)this.field_189958_b.func_148745_a(p_189955_1_);
