...
public class ChunkProviderOverworld implements IChunkGenerator {
   ...
   public ChunkProviderOverworld(World p_i46668_1_, long p_i46668_2_, boolean p_i46668_4_, String p_i46668_5_) {
      ...
      if(p_i46668_5_ != null) {
         this.field_186000_s = ChunkProviderSettings.Factory.func_177865_a(p_i46668_5_).func_177864_b();
   ...
   public BlockPos func_180513_a(World p_180513_1_, String p_180513_2_, BlockPos p_180513_3_) {
      return "Stronghold".equals(p_180513_2_) && this.field_186004_w != null?this.field_186004_w.func_180706_b(p_180513_1_, p_180513_3_):null;
   }
