...
public class StructureEndCityPieces {
   public static final TemplateManager field_186201_a = new TemplateManager("structures");
   ...
   private static final StructureEndCityPieces.IGenerator field_186204_d = new StructureEndCityPieces.IGenerator() {
      ...
      public boolean func_186185_a(int p_186185_1_, StructureEndCityPieces.CityTemplate p_186185_2_, BlockPos p_186185_3_, List<StructureComponent> p_186185_4_, Random p_186185_5_) {
         if(p_186185_1_ > 8) {
            ...
            StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(p_186185_2_, p_186185_3_, "base_floor", rotation, true));
            int i = p_186185_5_.nextInt(3);
            if(i == 0) {
               StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-1, 4, -1), "base_roof", rotation, true));
            } else if(i == 1) {
               structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-1, 0, -1), "second_floor_2", rotation, false));
               structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-1, 8, -1), "second_roof", rotation, false));
               ...
               structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-1, 0, -1), "second_floor_2", rotation, false));
               structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-1, 4, -1), "third_floor_c", rotation, false));
               structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-1, 8, -1), "third_roof", rotation, true));
               StructureEndCityPieces.func_186187_b(StructureEndCityPieces.field_186206_f, p_186185_1_ + 1, structureendcitypieces$citytemplate, (BlockPos)null, p_186185_4_, p_186185_5_);
            }
   ...
   private static final StructureEndCityPieces.IGenerator field_186206_f = new StructureEndCityPieces.IGenerator() {
      ...
      public boolean func_186185_a(int p_186185_1_, StructureEndCityPieces.CityTemplate p_186185_2_, BlockPos p_186185_3_, List<StructureComponent> p_186185_4_, Random p_186185_5_) {
         Rotation rotation = p_186185_2_.field_186177_b.func_186215_c();
         StructureEndCityPieces.CityTemplate lvt_7_1_ = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(p_186185_2_, new BlockPos(3 + p_186185_5_.nextInt(2), -3, 3 + p_186185_5_.nextInt(2)), "tower_base", rotation, true));
         lvt_7_1_ = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(lvt_7_1_, new BlockPos(0, 7, 0), "tower_piece", rotation, true));
         StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate1 = p_186185_5_.nextInt(3) == 0?lvt_7_1_:null;
         int i = 1 + p_186185_5_.nextInt(3);

         for(int j = 0; j < i; ++j) {
            lvt_7_1_ = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(lvt_7_1_, new BlockPos(0, 4, 0), "tower_piece", rotation, true));
         ...
         if(structureendcitypieces$citytemplate1 != null) {
            for(Tuple<Rotation, BlockPos> tuple : StructureEndCityPieces.field_186205_e) {
               if(p_186185_5_.nextBoolean()) {
                  StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate2 = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate1, (BlockPos)tuple.func_76340_b(), "bridge_end", rotation.func_185830_a((Rotation)tuple.func_76341_a()), true));
            ...
            StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(lvt_7_1_, new BlockPos(-1, 4, -1), "tower_top", rotation, true));
         } else {
            if(p_186185_1_ != 7) {
               return StructureEndCityPieces.func_186187_b(StructureEndCityPieces.field_186209_i, p_186185_1_ + 1, lvt_7_1_, (BlockPos)null, p_186185_4_, p_186185_5_);
            }
   ...
   private static final StructureEndCityPieces.IGenerator field_186207_g = new StructureEndCityPieces.IGenerator() {
      ...
      public boolean func_186185_a(int p_186185_1_, StructureEndCityPieces.CityTemplate p_186185_2_, BlockPos p_186185_3_, List<StructureComponent> p_186185_4_, Random p_186185_5_) {
         ...
         StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(p_186185_2_, new BlockPos(0, 0, -4), "bridge_piece", rotation, true));
         structureendcitypieces$citytemplate.field_74886_g = -1;
         int j = 0;

         for(int k = 0; k < i; ++k) {
            if(p_186185_5_.nextBoolean()) {
               structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(0, j, -4), "bridge_piece", rotation, true));
               j = 0;
            } else {
               if(p_186185_5_.nextBoolean()) {
                  structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(0, j, -4), "bridge_steep_stairs", rotation, true));
               } else {
                  structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(0, j, -8), "bridge_gentle_stairs", rotation, true));
               }
         ...
         if(!this.field_186186_a && p_186185_5_.nextInt(10 - p_186185_1_) == 0) {
            StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-8 + p_186185_5_.nextInt(8), j, -70 + p_186185_5_.nextInt(10)), "ship", rotation, true));
         ...
         structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(4, j, 0), "bridge_end", rotation.func_185830_a(Rotation.CLOCKWISE_180), true));
         structureendcitypieces$citytemplate.field_74886_g = -1;
         return true;
      }
   };
   ...
   private static final StructureEndCityPieces.IGenerator field_186209_i = new StructureEndCityPieces.IGenerator() {
      ...
      public boolean func_186185_a(int p_186185_1_, StructureEndCityPieces.CityTemplate p_186185_2_, BlockPos p_186185_3_, List<StructureComponent> p_186185_4_, Random p_186185_5_) {
         Rotation rotation = p_186185_2_.field_186177_b.func_186215_c();
         StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(p_186185_2_, new BlockPos(-3, 4, -3), "fat_tower_base", rotation, true));
         structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(0, 4, 0), "fat_tower_middle", rotation, true));

         for(int i = 0; i < 2 && p_186185_5_.nextInt(3) != 0; ++i) {
            structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(0, 8, 0), "fat_tower_middle", rotation, true));

            for(Tuple<Rotation, BlockPos> tuple : StructureEndCityPieces.field_186208_h) {
               if(p_186185_5_.nextBoolean()) {
                  StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate1 = StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, (BlockPos)tuple.func_76340_b(), "bridge_end", rotation.func_185830_a((Rotation)tuple.func_76341_a()), true));
         ...
         StructureEndCityPieces.func_189935_b(p_186185_4_, StructureEndCityPieces.func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-2, 8, -2), "fat_tower_top", rotation, true));
         return true;
      }
   };
   ...
   private static StructureEndCityPieces.CityTemplate func_186189_b(StructureEndCityPieces.CityTemplate p_186189_0_, BlockPos p_186189_1_, String p_186189_2_, Rotation p_186189_3_, boolean p_186189_4_) {
      ...
      BlockPos blockpos = p_186189_0_.field_186176_a.func_186262_a(p_186189_0_.field_186177_b, p_186189_1_, structureendcitypieces$citytemplate.field_186177_b, BlockPos.field_177992_a);
   ...
   public static void func_186190_a(BlockPos p_186190_0_, Rotation p_186190_1_, List<StructureComponent> p_186190_2_, Random p_186190_3_) {
      ...
      structureendcitypieces$citytemplate = func_189935_b(p_186190_2_, func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-1, 0, -1), "second_floor", p_186190_1_, false));
      structureendcitypieces$citytemplate = func_189935_b(p_186190_2_, func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-1, 4, -1), "third_floor", p_186190_1_, false));
      structureendcitypieces$citytemplate = func_189935_b(p_186190_2_, func_186189_b(structureendcitypieces$citytemplate, new BlockPos(-1, 8, -1), "third_roof", p_186190_1_, true));
      func_186187_b(field_186206_f, 1, structureendcitypieces$citytemplate, (BlockPos)null, p_186190_2_, p_186190_3_);
   }
      ...
      if(p_186187_1_ > 8) {
         ...
         if(p_186187_0_.func_186185_a(p_186187_1_, p_186187_2_, p_186187_3_, list, p_186187_5_)) {
            ...
            for(StructureComponent structurecomponent : list) {
               ...
               StructureComponent structurecomponent1 = StructureComponent.func_74883_a(p_186187_4_, structurecomponent.func_74874_b());
               if(structurecomponent1 != null && structurecomponent1.field_74886_g != p_186187_2_.field_74886_g) {
                  flag = true;
                  break;
               }
            }
   ...
   public static class CityTemplate extends StructureComponentTemplate {
      ...
      private void func_186180_a(BlockPos p_186180_1_) {
         Template template = StructureEndCityPieces.field_186201_a.func_186237_a((MinecraftServer)null, new ResourceLocation("endcity/" + this.field_186181_d));
   ...
   interface IGenerator {
      ...
      boolean func_186185_a(int var1, StructureEndCityPieces.CityTemplate var2, BlockPos var3, List<StructureComponent> var4, Random var5);
   }
}
