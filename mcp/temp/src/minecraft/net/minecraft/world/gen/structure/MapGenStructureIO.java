...
public class MapGenStructureIO {
   ...
   public static StructureStart func_143035_a(NBTTagCompound p_143035_0_, World p_143035_1_) {
      ...
      try {
         ...
         field_151687_a.warn("Failed Start with id {}", new Object[]{p_143035_0_.func_74779_i("id")});
      ...
      if(structurestart != null) {
         ...
         field_151687_a.warn("Skipping Structure with id {}", new Object[]{p_143035_0_.func_74779_i("id")});
      }
   ...
   public static StructureComponent func_143032_b(NBTTagCompound p_143032_0_, World p_143032_1_) {
      ...
      try {
         ...
         field_151687_a.warn("Failed Piece with id {}", new Object[]{p_143032_0_.func_74779_i("id")});
         exception.printStackTrace();
      }
      ...
      if(structurecomponent != null) {
         ...
         field_151687_a.warn("Skipping Piece with id {}", new Object[]{p_143032_0_.func_74779_i("id")});
      }
