...
public abstract class Biome {
   ...
   public static final Set<Biome> field_150597_n = Sets.<Biome>newHashSet();
   ...
   public static Biome func_185357_a(int p_185357_0_) {
      return (Biome)field_185377_q.func_148754_a(p_185357_0_);
   }

   @Nullable
   public static Biome func_185356_b(Biome p_185356_0_) {
      return (Biome)field_185373_j.func_148745_a(func_185362_a(p_185356_0_));
   }
   ...
   public Biome.TempCategory func_150561_m() {
      return (double)this.func_185353_n() < 0.2D?Biome.TempCategory.COLD:((double)this.func_185353_n() < 1.0D?Biome.TempCategory.MEDIUM:Biome.TempCategory.WARM);
   }
   ...
   public static void func_185358_q() {
      ...
      func_185354_a(156, "mutated_birch_forest_hills", new BiomeForestMutated((new Biome.BiomeProperties("Birch Forest Hills M")).func_185399_a("birch_forest").func_185398_c(0.55F).func_185400_d(0.5F).func_185410_a(0.6F).func_185395_b(0.6F)));
   ...
   private static void func_185354_a(int p_185354_0_, String p_185354_1_, Biome p_185354_2_) {
      ...
      if(p_185354_2_.func_185363_b()) {
         field_185373_j.func_148746_a(p_185354_2_, func_185362_a((Biome)field_185377_q.func_82594_a(new ResourceLocation(p_185354_2_.field_185364_H))));
      }
