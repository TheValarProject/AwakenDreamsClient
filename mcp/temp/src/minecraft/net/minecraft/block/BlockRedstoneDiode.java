...
public abstract class BlockRedstoneDiode extends BlockHorizontal {
   ...
   public int func_180656_a(IBlockState p_180656_1_, IBlockAccess p_180656_2_, BlockPos p_180656_3_, EnumFacing p_180656_4_) {
      return !this.func_176406_l(p_180656_1_)?0:(p_180656_1_.func_177229_b(field_185512_D) == p_180656_4_?this.func_176408_a(p_180656_2_, p_180656_3_, p_180656_1_):0);
   }
   ...
   public void func_189540_a(IBlockState p_189540_1_, World p_189540_2_, BlockPos p_189540_3_, Block p_189540_4_) {
      if(this.func_176409_d(p_189540_2_, p_189540_3_)) {
         ...
         for(EnumFacing enumfacing : EnumFacing.values()) {
            p_189540_2_.func_175685_c(p_189540_3_.func_177972_a(enumfacing), this);
         }
   ...
   protected int func_176401_c(IBlockAccess p_176401_1_, BlockPos p_176401_2_, EnumFacing p_176401_3_) {
      ...
      return this.func_185545_A(iblockstate)?(block == Blocks.field_150451_bX?15:(block == Blocks.field_150488_af?((Integer)iblockstate.func_177229_b(BlockRedstoneWire.field_176351_O)).intValue():p_176401_1_.func_175627_a(p_176401_2_, p_176401_3_))):0;
   }
