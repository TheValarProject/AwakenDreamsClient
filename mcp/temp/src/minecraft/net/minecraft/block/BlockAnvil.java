   ...
   public IBlockState func_180642_a(World p_180642_1_, BlockPos p_180642_2_, EnumFacing p_180642_3_, float p_180642_4_, float p_180642_5_, float p_180642_6_, int p_180642_7_, EntityLivingBase p_180642_8_) {
      ...
      try {
         ...
         if(!p_180642_1_.field_72995_K) {
            field_185762_e.warn(String.format("Invalid damage property for anvil at %s. Found %d, must be in [0, 1, 2]", new Object[]{p_180642_2_, Integer.valueOf(p_180642_7_ >> 2)}));
            if(p_180642_8_ instanceof EntityPlayer) {
               ((EntityPlayer)p_180642_8_).func_145747_a(new TextComponentTranslation("Invalid damage property. Please pick in [0, 1, 2]", new Object[0]));
            }
         }
