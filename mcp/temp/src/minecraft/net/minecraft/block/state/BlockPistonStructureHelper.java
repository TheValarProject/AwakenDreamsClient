...
public class BlockPistonStructureHelper {
   ...
   private boolean func_177251_a(BlockPos p_177251_1_) {
      ...
      if(iblockstate.func_185904_a() == Material.field_151579_a) {
         return true;
      } else if(!BlockPistonBase.func_185646_a(iblockstate, this.field_177261_a, p_177251_1_, this.field_177257_d, false)) {
         return true;
         ...
         if(i + this.field_177258_e.size() > 12) {
            ...
            while(true) {
               ...
               if(!BlockPistonBase.func_185646_a(iblockstate, this.field_177261_a, blockpos1, this.field_177257_d, true) || blockpos1.equals(this.field_177259_b)) {
                  return false;
               }
