...
public class BlockStateContainer {
   ...
   public BlockStateContainer(Block p_i45663_1_, IProperty<?>... p_i45663_2_) {
      ...
      this.field_177624_d = ImmutableSortedMap.<String, IProperty<?>>copyOf(map);
   ...
   public String toString() {
      return Objects.toStringHelper(this).add("block", Block.field_149771_c.func_177774_c(this.field_177627_c)).add("properties", Iterables.transform(this.field_177624_d.values(), field_177626_b)).toString();
   }
   ...
   static class StateImplementation extends BlockStateBase {
      ...
      public <T extends Comparable<T>> T func_177229_b(IProperty<T> p_177229_1_) {
         ...
         if(comparable == null) {
            ...
            return (T)((Comparable)p_177229_1_.func_177699_b().cast(comparable));
         }
      }
      ...
      public MapColor func_185909_g() {
         return this.field_177239_a.func_180659_g(this);
      }
      ...
      @Nullable
      public AxisAlignedBB func_185890_d(World p_185890_1_, BlockPos p_185890_2_) {
         return this.field_177239_a.func_180646_a(this, p_185890_1_, p_185890_2_);
      }

      public void func_185908_a(World p_185908_1_, BlockPos p_185908_2_, AxisAlignedBB p_185908_3_, List<AxisAlignedBB> p_185908_4_, @Nullable Entity p_185908_5_) {
         this.field_177239_a.func_185477_a(this, p_185908_1_, p_185908_2_, p_185908_3_, p_185908_4_, p_185908_5_);
      }
