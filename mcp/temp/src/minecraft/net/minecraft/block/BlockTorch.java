...
public class BlockTorch extends Block {
   ...
   public void func_180655_c(IBlockState p_180655_1_, World p_180655_2_, BlockPos p_180655_3_, Random p_180655_4_) {
      ...
      if(enumfacing.func_176740_k().func_176722_c()) {
         EnumFacing enumfacing1 = enumfacing.func_176734_d();
         p_180655_2_.func_175688_a(EnumParticleTypes.SMOKE_NORMAL, d0 + 0.27D * (double)enumfacing1.func_82601_c(), d1 + 0.22D, d2 + 0.27D * (double)enumfacing1.func_82599_e(), 0.0D, 0.0D, 0.0D, new int[0]);
         p_180655_2_.func_175688_a(EnumParticleTypes.FLAME, d0 + 0.27D * (double)enumfacing1.func_82601_c(), d1 + 0.22D, d2 + 0.27D * (double)enumfacing1.func_82599_e(), 0.0D, 0.0D, 0.0D, new int[0]);
      } else {
         p_180655_2_.func_175688_a(EnumParticleTypes.SMOKE_NORMAL, d0, d1, d2, 0.0D, 0.0D, 0.0D, new int[0]);
         p_180655_2_.func_175688_a(EnumParticleTypes.FLAME, d0, d1, d2, 0.0D, 0.0D, 0.0D, new int[0]);
      }
