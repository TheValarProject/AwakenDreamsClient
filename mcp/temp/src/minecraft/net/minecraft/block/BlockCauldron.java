...
public class BlockCauldron extends Block {
   ...
   public boolean func_180639_a(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumHand p_180639_5_, @Nullable ItemStack p_180639_6_, EnumFacing p_180639_7_, float p_180639_8_, float p_180639_9_, float p_180639_10_) {
      if(p_180639_6_ == null) {
         ...
         Item item = p_180639_6_.func_77973_b();
         if(item == Items.field_151131_as) {
            ...
            if(i == 3 && !p_180639_1_.field_72995_K) {
               if(!p_180639_4_.field_71075_bZ.field_75098_d) {
                  --p_180639_6_.field_77994_a;
                  if(p_180639_6_.field_77994_a == 0) {
            ...
            if(i > 0 && !p_180639_1_.field_72995_K) {
               if(!p_180639_4_.field_71075_bZ.field_75098_d) {
                  ItemStack itemstack1 = PotionUtils.func_185188_a(new ItemStack(Items.field_151068_bn), PotionTypes.field_185230_b);
                  p_180639_4_.func_71029_a(StatList.field_188078_L);
                  if(--p_180639_6_.field_77994_a == 0) {
            ...
            if(i > 0 && item instanceof ItemArmor) {
               ...
               if(itemarmor.func_82812_d() == ItemArmor.ArmorMaterial.LEATHER && itemarmor.func_82816_b_(p_180639_6_) && !p_180639_1_.field_72995_K) {
                  itemarmor.func_82815_c(p_180639_6_);
                  this.func_176590_a(p_180639_1_, p_180639_2_, p_180639_3_, i - 1);
            ...
            if(i > 0 && item instanceof ItemBanner) {
               if(TileEntityBanner.func_175113_c(p_180639_6_) > 0 && !p_180639_1_.field_72995_K) {
                  ItemStack itemstack = p_180639_6_.func_77946_l();
                  itemstack.field_77994_a = 1;
                  TileEntityBanner.func_175117_e(itemstack);
                  ...
                  if(p_180639_6_.field_77994_a == 0) {
                     p_180639_4_.func_184611_a(p_180639_5_, itemstack);
                  } else if(!p_180639_4_.field_71071_by.func_70441_a(itemstack)) {
                     p_180639_4_.func_71019_a(itemstack, false);
                  } else if(p_180639_4_ instanceof EntityPlayerMP) {
                     ((EntityPlayerMP)p_180639_4_).func_71120_a(p_180639_4_.field_71069_bz);
                  }
