...
public class Block {
   ...
   public boolean func_176212_b(IBlockAccess p_176212_1_, BlockPos p_176212_2_, EnumFacing p_176212_3_) {
      return p_176212_1_.func_180495_p(p_176212_2_).func_185904_a().func_76220_a();
   }
   ...
   public boolean func_176193_a(World p_176193_1_, BlockPos p_176193_2_, EnumFacing p_176193_3_, @Nullable ItemStack p_176193_4_) {
   ...
   public static void func_149671_p() {
      ...
      func_176219_a(159, "stained_hardened_clay", (new BlockColored(Material.field_151576_e)).func_149711_c(1.25F).func_149752_b(7.0F).func_149672_a(SoundType.field_185851_d).func_149663_c("clayHardenedStained"));
      ...
      Block block13 = (new Block(Material.field_151576_e)).func_149711_c(1.5F).func_149752_b(10.0F).func_149672_a(SoundType.field_185851_d).func_149647_a(CreativeTabs.field_78030_b).func_149663_c("purpurBlock");
      func_176219_a(201, "purpur_block", block13);
      func_176219_a(202, "purpur_pillar", (new BlockRotatedPillar(Material.field_151576_e)).func_149711_c(1.5F).func_149752_b(10.0F).func_149672_a(SoundType.field_185851_d).func_149647_a(CreativeTabs.field_78030_b).func_149663_c("purpurPillar"));
      ...
      func_176219_a(206, "end_bricks", (new Block(Material.field_151576_e)).func_149672_a(SoundType.field_185851_d).func_149711_c(0.8F).func_149647_a(CreativeTabs.field_78030_b).func_149663_c("endBricks"));
