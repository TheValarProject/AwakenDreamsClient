...
public class BlockPistonBase extends BlockDirectional {
   ...
   public void func_180633_a(World p_180633_1_, BlockPos p_180633_2_, IBlockState p_180633_3_, EntityLivingBase p_180633_4_, ItemStack p_180633_5_) {
      p_180633_1_.func_180501_a(p_180633_2_, p_180633_3_.func_177226_a(field_176387_N, func_185647_a(p_180633_2_, p_180633_4_)), 2);
   ...
   public IBlockState func_180642_a(World p_180642_1_, BlockPos p_180642_2_, EnumFacing p_180642_3_, float p_180642_4_, float p_180642_5_, float p_180642_6_, int p_180642_7_, EntityLivingBase p_180642_8_) {
      return this.func_176223_P().func_177226_a(field_176387_N, func_185647_a(p_180642_2_, p_180642_8_)).func_177226_a(field_176320_b, Boolean.valueOf(false));
   }
   ...
   public static EnumFacing func_185647_a(BlockPos p_185647_0_, EntityLivingBase p_185647_1_) {
      if(MathHelper.func_76135_e((float)p_185647_1_.field_70165_t - (float)p_185647_0_.func_177958_n()) < 2.0F && MathHelper.func_76135_e((float)p_185647_1_.field_70161_v - (float)p_185647_0_.func_177952_p()) < 2.0F) {
         double d0 = p_185647_1_.field_70163_u + (double)p_185647_1_.func_70047_e();
         if(d0 - (double)p_185647_0_.func_177956_o() > 2.0D) {
            return EnumFacing.UP;
         }

         if((double)p_185647_0_.func_177956_o() - d0 > 0.0D) {
      ...
      if(block == Blocks.field_150343_Z) {
         ...
         if(p_185646_2_.func_177956_o() <= p_185646_1_.func_72800_K() - 1 && (p_185646_3_ != EnumFacing.UP || p_185646_2_.func_177956_o() != p_185646_1_.func_72800_K() - 1)) {
            if(block != Blocks.field_150331_J && block != Blocks.field_150320_F) {
               ...
               if(p_185646_0_.func_185905_o() == EnumPushReaction.BLOCK) {
                  return false;
               }

               if(p_185646_0_.func_185905_o() == EnumPushReaction.DESTROY) {
                  return p_185646_4_;
               }
   ...
   private boolean func_176319_a(World p_176319_1_, BlockPos p_176319_2_, EnumFacing p_176319_3_, boolean p_176319_4_) {
      ...
      if(!blockpistonstructurehelper.func_177253_a()) {
         ...
         if(p_176319_4_) {
            ...
            p_176319_1_.func_175690_a(blockpos2, BlockPistonMoving.func_185588_a(iblockstate3, p_176319_3_, true, false));
         }

         for(int i1 = list2.size() - 1; i1 >= 0; --i1) {
            p_176319_1_.func_175685_c((BlockPos)list2.get(i1), aiblockstate[k++].func_177230_c());
         }

         for(int j1 = list.size() - 1; j1 >= 0; --j1) {
            p_176319_1_.func_175685_c((BlockPos)list.get(j1), aiblockstate[k++].func_177230_c());
         }

         if(p_176319_4_) {
            p_176319_1_.func_175685_c(blockpos2, Blocks.field_150332_K);
