...
public class BlockEndRod extends BlockDirectional {
   ...
   public void func_180655_c(IBlockState p_180655_1_, World p_180655_2_, BlockPos p_180655_3_, Random p_180655_4_) {
      ...
      if(p_180655_4_.nextInt(5) == 0) {
         p_180655_2_.func_175688_a(EnumParticleTypes.END_ROD, d0 + (double)enumfacing.func_82601_c() * d3, d1 + (double)enumfacing.func_96559_d() * d3, d2 + (double)enumfacing.func_82599_e() * d3, p_180655_4_.nextGaussian() * 0.005D, p_180655_4_.nextGaussian() * 0.005D, p_180655_4_.nextGaussian() * 0.005D, new int[0]);
      }
