...
public class CommandDifficulty extends CommandBase {
   ...
   protected EnumDifficulty func_180531_e(String p_180531_1_) throws CommandException, NumberInvalidException {
      return !"peaceful".equalsIgnoreCase(p_180531_1_) && !"p".equalsIgnoreCase(p_180531_1_)?(!"easy".equalsIgnoreCase(p_180531_1_) && !"e".equalsIgnoreCase(p_180531_1_)?(!"normal".equalsIgnoreCase(p_180531_1_) && !"n".equalsIgnoreCase(p_180531_1_)?(!"hard".equalsIgnoreCase(p_180531_1_) && !"h".equalsIgnoreCase(p_180531_1_)?EnumDifficulty.func_151523_a(func_175764_a(p_180531_1_, 0, 3)):EnumDifficulty.HARD):EnumDifficulty.NORMAL):EnumDifficulty.EASY):EnumDifficulty.PEACEFUL;
   }
