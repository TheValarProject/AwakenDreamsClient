...
public class CommandParticle extends CommandBase {
      ...
      if(p_184881_3_.length < 8) {
         ...
         if(enumparticletypes == null) {
            ...
            if(world instanceof WorldServer) {
               ...
               func_152373_a(p_184881_2_, this, "commands.particle.success", new Object[]{s, Integer.valueOf(Math.max(i, 1))});
            }
   ...
   public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_) {
      return p_184883_3_.length == 1?func_175762_a(p_184883_3_, EnumParticleTypes.func_186832_a()):(p_184883_3_.length > 1 && p_184883_3_.length <= 4?func_175771_a(p_184883_3_, 1, p_184883_4_):(p_184883_3_.length == 10?func_71530_a(p_184883_3_, new String[]{"normal", "force"}):(p_184883_3_.length == 11?func_71530_a(p_184883_3_, p_184883_1_.func_71213_z()):Collections.emptyList())));
   }
