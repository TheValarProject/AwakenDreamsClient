...
public class CommandHelp extends CommandBase {
   private static final String[] field_184901_a = new String[]{"Yolo", "/achievement take achievement.understandCommands @p", "Ask for help on twitter", "/deop @p", "Scoreboard deleted, commands blocked", "Contact helpdesk for help", "/testfornoob @p", "/trigger warning", "Oh my god, it\'s full of stats", "/kill @p[name=!Searge]", "Have you tried turning it off and on again?", "Sorry, no help today"};
   ...
   public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException {
      if(p_184881_2_ instanceof CommandBlockBaseLogic) {
         ...
         try {
            ...
            if(MathHelper.func_82715_a(p_184881_3_[0], -1) != -1) {
         ...
         if(k == 0 && p_184881_2_ instanceof EntityPlayer) {
