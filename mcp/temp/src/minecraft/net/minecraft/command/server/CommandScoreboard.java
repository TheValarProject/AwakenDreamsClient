...
public class CommandScoreboard extends CommandBase {
   ...
   protected void func_184922_e(ICommandSender p_184922_1_, String[] p_184922_2_, int p_184922_3_, MinecraftServer p_184922_4_) throws CommandException {
      ...
      if(p_184922_2_.length > p_184922_3_) {
         ...
         TextComponentTranslation textcomponenttranslation = new TextComponentTranslation("commands.scoreboard.teams.list.player.count", new Object[]{Integer.valueOf(collection.size()), scoreplayerteam.func_96661_b()});
         ...
         for(ScorePlayerTeam scoreplayerteam1 : collection1) {
            p_184922_1_.func_145747_a(new TextComponentTranslation("commands.scoreboard.teams.list.entry", new Object[]{scoreplayerteam1.func_96661_b(), scoreplayerteam1.func_96669_c(), Integer.valueOf(scoreplayerteam1.func_96670_d().size())}));
         }
      }
   ...
   protected void func_184916_f(ICommandSender p_184916_1_, String[] p_184916_2_, int p_184916_3_, MinecraftServer p_184916_4_) throws CommandException {
      ...
      if(!set.isEmpty()) {
         ...
         func_152373_a(p_184916_1_, this, "commands.scoreboard.teams.join.success", new Object[]{Integer.valueOf(set.size()), s, func_71527_a(set.toArray(new String[set.size()]))});
      }
   ...
   protected void func_184911_g(ICommandSender p_184911_1_, String[] p_184911_2_, int p_184911_3_, MinecraftServer p_184911_4_) throws CommandException {
      ...
      if(!set.isEmpty()) {
         ...
         func_152373_a(p_184911_1_, this, "commands.scoreboard.teams.leave.success", new Object[]{Integer.valueOf(set.size()), func_71527_a(set.toArray(new String[set.size()]))});
      }
   ...
   protected void func_184917_h(ICommandSender p_184917_1_, String[] p_184917_2_, int p_184917_3_, MinecraftServer p_184917_4_) throws CommandException {
      ...
      if(scoreplayerteam != null) {
         ...
         if(collection.isEmpty()) {
            ...
            func_152373_a(p_184917_1_, this, "commands.scoreboard.teams.empty.success", new Object[]{Integer.valueOf(collection.size()), scoreplayerteam.func_96661_b()});
         }
      }
   }
   ...
   protected void func_184920_j(ICommandSender p_184920_1_, String[] p_184920_2_, int p_184920_3_, MinecraftServer p_184920_4_) throws CommandException {
      ...
      if(p_184920_2_.length > p_184920_3_) {
         ...
         for(Score score : map.values()) {
            p_184920_1_.func_145747_a(new TextComponentTranslation("commands.scoreboard.players.list.player.entry", new Object[]{Integer.valueOf(score.func_96652_c()), score.func_96645_d().func_96678_d(), score.func_96645_d().func_96679_b()}));
         }
      } else {
   ...
   protected void func_184918_k(ICommandSender p_184918_1_, String[] p_184918_2_, int p_184918_3_, MinecraftServer p_184918_4_) throws CommandException {
      ...
      if(s1.length() > 40) {
         ...
         func_152373_a(p_184918_1_, this, "commands.scoreboard.players.set.success", new Object[]{scoreobjective.func_96679_b(), s1, Integer.valueOf(score.func_96652_c())});
      }
   }
      ...
      if(s.length() > 40) {
         ...
         if(!scoreboard.func_178819_b(s, scoreobjective)) {
            ...
            if(score.func_96652_c() >= i && score.func_96652_c() <= j) {
               func_152373_a(p_184907_1_, this, "commands.scoreboard.players.test.success", new Object[]{Integer.valueOf(score.func_96652_c()), Integer.valueOf(i), Integer.valueOf(j)});
            } else {
   ...
   public boolean func_82358_a(String[] p_82358_1_, int p_82358_2_) {
      return !"players".equalsIgnoreCase(p_82358_1_[0])?("teams".equalsIgnoreCase(p_82358_1_[0])?p_82358_2_ == 2:false):(p_82358_1_.length > 1 && "operation".equalsIgnoreCase(p_82358_1_[1])?p_82358_2_ == 2 || p_82358_2_ == 5:p_82358_2_ == 2);
   }
}
