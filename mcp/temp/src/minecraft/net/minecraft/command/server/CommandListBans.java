...
public class CommandListBans extends CommandBase {
   ...
   public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException {
      if(p_184881_3_.length >= 1 && "ips".equalsIgnoreCase(p_184881_3_[0])) {
         p_184881_2_.func_145747_a(new TextComponentTranslation("commands.banlist.ips", new Object[]{Integer.valueOf(p_184881_1_.func_184103_al().func_72363_f().func_152685_a().length)}));
         p_184881_2_.func_145747_a(new TextComponentString(func_71527_a(p_184881_1_.func_184103_al().func_72363_f().func_152685_a())));
      } else {
         p_184881_2_.func_145747_a(new TextComponentTranslation("commands.banlist.players", new Object[]{Integer.valueOf(p_184881_1_.func_184103_al().func_152608_h().func_152685_a().length)}));
