...
public class CommandTestForBlock extends CommandBase {
      ...
      if(p_184881_3_.length < 4) {
         ...
         if(block == null) {
            ...
            if(p_184881_3_.length >= 5) {
               i = func_175764_a(p_184881_3_[4], -1, 15);
            }
            ...
            if(!world.func_175667_e(blockpos)) {
               ...
               if(block1 != block) {
                  ...
                  func_152373_a(p_184881_2_, this, "commands.testforblock.success", new Object[]{Integer.valueOf(blockpos.func_177958_n()), Integer.valueOf(blockpos.func_177956_o()), Integer.valueOf(blockpos.func_177952_p())});
               }
            }
         }
      }
   ...
   public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_) {
      return p_184883_3_.length > 0 && p_184883_3_.length <= 3?func_175771_a(p_184883_3_, 0, p_184883_4_):(p_184883_3_.length == 4?func_175762_a(p_184883_3_, Block.field_149771_c.func_148742_b()):Collections.emptyList());
   }
}
