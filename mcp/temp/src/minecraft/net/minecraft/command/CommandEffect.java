...
public class CommandEffect extends CommandBase {
         ...
         if("clear".equals(p_184881_3_[1])) {
            ...
            if(potion == null) {
               ...
               if(j > 0) {
                  ...
                  func_152373_a(p_184881_2_, this, "commands.effect.success", new Object[]{new TextComponentTranslation(potioneffect.func_76453_d(), new Object[0]), Integer.valueOf(Potion.func_188409_a(potion)), Integer.valueOf(k), entitylivingbase.func_70005_c_(), Integer.valueOf(j)});
   ...
   public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_) {
      return p_184883_3_.length == 1?func_71530_a(p_184883_3_, p_184883_1_.func_71213_z()):(p_184883_3_.length == 2?func_175762_a(p_184883_3_, Potion.field_188414_b.func_148742_b()):(p_184883_3_.length == 5?func_71530_a(p_184883_3_, new String[]{"true", "false"}):Collections.emptyList()));
   }
