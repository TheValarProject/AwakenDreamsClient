...
public class CommandClone extends CommandBase {
               ...
               if(structureboundingbox.field_78895_b >= 0 && structureboundingbox.field_78894_e < 256 && structureboundingbox1.field_78895_b >= 0 && structureboundingbox1.field_78894_e < 256) {
                  ...
                  if(world.func_175711_a(structureboundingbox) && world.func_175711_a(structureboundingbox1)) {
                     ...
                     if(p_184881_3_.length >= 10) {
                        if("masked".equals(p_184881_3_[9])) {
                           ...
                           if(p_184881_3_.length >= 13) {
                              j = func_175764_a(p_184881_3_[12], 0, 15);
                           }
                        }
                     }
                     ...
                     if(i <= 0) {
                        ...
                        func_152373_a(p_184881_2_, this, "commands.clone.success", new Object[]{Integer.valueOf(i)});
                     }
                  } else {
   ...
   public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, @Nullable BlockPos p_184883_4_) {
      return p_184883_3_.length > 0 && p_184883_3_.length <= 3?func_175771_a(p_184883_3_, 0, p_184883_4_):(p_184883_3_.length > 3 && p_184883_3_.length <= 6?func_175771_a(p_184883_3_, 3, p_184883_4_):(p_184883_3_.length > 6 && p_184883_3_.length <= 9?func_175771_a(p_184883_3_, 6, p_184883_4_):(p_184883_3_.length == 10?func_71530_a(p_184883_3_, new String[]{"replace", "masked", "filtered"}):(p_184883_3_.length == 11?func_71530_a(p_184883_3_, new String[]{"normal", "force", "move"}):(p_184883_3_.length == 12 && "filtered".equals(p_184883_3_[9])?func_175762_a(p_184883_3_, Block.field_149771_c.func_148742_b()):Collections.emptyList())))));
   }
