   ...
   public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException {
      ...
      if(p_184881_3_.length >= 2 && item == null) {
         ...
         if(k == 0) {
            ...
            if(j == 0) {
               p_184881_2_.func_145747_a(new TextComponentTranslation("commands.clear.testing", new Object[]{entityplayermp.func_70005_c_(), Integer.valueOf(k)}));
            } else {
               func_152373_a(p_184881_2_, this, "commands.clear.success", new Object[]{entityplayermp.func_70005_c_(), Integer.valueOf(k)});
            }
