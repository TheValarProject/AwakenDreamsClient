      ...
      if(p_184881_3_.length <= 0) {
         ...
         if(flag) {
            ...
            if(flag1) {
               ...
               func_152373_a(p_184881_2_, this, "commands.xp.success.negative.levels", new Object[]{Integer.valueOf(i), entityplayer.func_70005_c_()});
            } else {
               entityplayer.func_82242_a(i);
               func_152373_a(p_184881_2_, this, "commands.xp.success.levels", new Object[]{Integer.valueOf(i), entityplayer.func_70005_c_()});
            }
         } else {
            ...
            func_152373_a(p_184881_2_, this, "commands.xp.success", new Object[]{Integer.valueOf(i), entityplayer.func_70005_c_()});
         }
