...
public abstract class CommandBase implements ICommand {
   ...
   protected static NBTTagCompound func_184887_a(Entity p_184887_0_) {
   ...
   public static EntityPlayerMP func_184888_a(MinecraftServer p_184888_0_, ICommandSender p_184888_1_, String p_184888_2_) throws PlayerNotFoundException {
      EntityPlayerMP entityplayermp = EntitySelector.func_82386_a(p_184888_1_, p_184888_2_);
      if(entityplayermp == null) {
         try {
            entityplayermp = p_184888_0_.func_184103_al().func_177451_a(UUID.fromString(p_184888_2_));
      ...
      if(entityplayermp == null) {
         entityplayermp = p_184888_0_.func_184103_al().func_152612_a(p_184888_2_);
      }
   ...
   public static Entity func_184885_b(MinecraftServer p_184885_0_, ICommandSender p_184885_1_, String p_184885_2_) throws EntityNotFoundException {
      return func_184884_a(p_184885_0_, p_184885_1_, p_184885_2_, Entity.class);
   }

   public static <T extends Entity> T func_184884_a(MinecraftServer p_184884_0_, ICommandSender p_184884_1_, String p_184884_2_, Class<? extends T> p_184884_3_) throws EntityNotFoundException {
   ...
   public static List<Entity> func_184890_c(MinecraftServer p_184890_0_, ICommandSender p_184890_1_, String p_184890_2_) throws EntityNotFoundException {
      return (List<Entity>)(EntitySelector.func_82378_b(p_184890_2_)?EntitySelector.func_179656_b(p_184890_1_, p_184890_2_, Entity.class):Lists.newArrayList(new Entity[]{func_184885_b(p_184890_0_, p_184890_1_, p_184890_2_)}));
   }

   public static String func_184886_d(MinecraftServer p_184886_0_, ICommandSender p_184886_1_, String p_184886_2_) throws PlayerNotFoundException {
      try {
   ...
   public static String func_184891_e(MinecraftServer p_184891_0_, ICommandSender p_184891_1_, String p_184891_2_) throws EntityNotFoundException {
      try {
   ...
   public static ITextComponent func_147176_a(ICommandSender p_147176_0_, String[] p_147176_1_, int p_147176_2_, boolean p_147176_3_) throws PlayerNotFoundException {
