...
public class StatisticsManagerServer extends StatisticsManager {
   ...
   public void func_150882_a() {
      if(this.field_150887_d.isFile()) {
         try {
            ...
            field_150889_b.error("Couldn\'t read statistics file {}", new Object[]{this.field_150887_d, ioexception});
         } catch (JsonParseException jsonparseexception) {
            field_150889_b.error("Couldn\'t parse statistics file {}", new Object[]{this.field_150887_d, jsonparseexception});
         }
      }
   ...
   public void func_150873_a(EntityPlayer p_150873_1_, StatBase p_150873_2_, int p_150873_3_) {
      ...
      if(p_150873_2_.func_75967_d() && i == 0 && p_150873_3_ > 0) {
         ...
         if(this.field_150890_c.func_147136_ar()) {
            this.field_150890_c.func_184103_al().func_148539_a(new TextComponentTranslation("chat.type.achievement", new Object[]{p_150873_1_.func_145748_c_(), p_150873_2_.func_150955_j()}));
         }
      }
      ...
      if(p_150873_2_.func_75967_d() && i > 0 && p_150873_3_ == 0) {
         this.field_150886_g = true;
         if(this.field_150890_c.func_147136_ar()) {
            this.field_150890_c.func_184103_al().func_148539_a(new TextComponentTranslation("chat.type.achievement.taken", new Object[]{p_150873_1_.func_145748_c_(), p_150873_2_.func_150955_j()}));
         }
      }
      ...
      if(!jsonelement.isJsonObject()) {
         ...
         for(Entry<String, JsonElement> entry : jsonobject.entrySet()) {
            ...
            if(statbase != null) {
               ...
               if(((JsonElement)entry.getValue()).isJsonPrimitive() && ((JsonElement)entry.getValue()).getAsJsonPrimitive().isNumber()) {
                  ...
                  if(jsonobject1.has("progress") && statbase.func_150954_l() != null) {
                     try {
                        ...
                        field_150889_b.warn("Invalid statistic progress in {}", new Object[]{this.field_150887_d, throwable});
                     }
                  }
               }
               ...
               field_150889_b.warn("Invalid statistic in {}: Don\'t know what {} is", new Object[]{this.field_150887_d, entry.getKey()});
            }
         }
      ...
      for(Entry<StatBase, TupleIntJsonSerializable> entry : p_150880_0_.entrySet()) {
         if(((TupleIntJsonSerializable)entry.getValue()).func_151187_b() != null) {
            ...
            try {
               ...
               field_150889_b.warn("Couldn\'t save statistic {}: error serializing progress", new Object[]{((StatBase)entry.getKey()).func_150951_e(), throwable});
            }
   ...
   public void func_150884_b(EntityPlayerMP p_150884_1_) {
      ...
      p_150884_1_.field_71135_a.func_147359_a(new SPacketStatistics(map));
   }
