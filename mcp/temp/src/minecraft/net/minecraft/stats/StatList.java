...
public class StatList {
   ...
   public static final StatBase field_188072_F = (new StatBasic("stat.junkFished", new TextComponentTranslation("stat.junkFished", new Object[0]))).func_75971_g();
   public static final StatBase field_188073_G = (new StatBasic("stat.treasureFished", new TextComponentTranslation("stat.treasureFished", new Object[0]))).func_75971_g();
   ...
   public static StatBase func_151182_a(EntityList.EntityEggInfo p_151182_0_) {
      return p_151182_0_.field_75613_a == null?null:(new StatBase("stat.killEntity." + p_151182_0_.field_75613_a, new TextComponentTranslation("stat.entityKill", new Object[]{new TextComponentTranslation("entity." + p_151182_0_.field_75613_a + ".name", new Object[0])}))).func_75971_g();
   }

   public static StatBase func_151176_b(EntityList.EntityEggInfo p_151176_0_) {
      return p_151176_0_.field_75613_a == null?null:(new StatBase("stat.entityKilledBy." + p_151176_0_.field_75613_a, new TextComponentTranslation("stat.entityKilledBy", new Object[]{new TextComponentTranslation("entity." + p_151176_0_.field_75613_a + ".name", new Object[0])}))).func_75971_g();
   }
