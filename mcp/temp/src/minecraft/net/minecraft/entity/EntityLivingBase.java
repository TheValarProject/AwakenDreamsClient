...
public abstract class EntityLivingBase extends Entity {
   ...
   protected void func_184606_a_(@Nullable ItemStack p_184606_1_) {
      if(p_184606_1_ != null) {
         ...
         if(item instanceof ItemArmor) {
            ...
            soundevent = SoundEvents.field_187728_s;
         }
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if(p_70037_1_.func_150297_b("Team", 8)) {
         ...
         this.field_70170_p.func_96441_U().func_151392_a(this.func_189512_bd(), s);
      }
   ...
   public void func_184611_a(EnumHand p_184611_1_, @Nullable ItemStack p_184611_2_) {
   ...
   public abstract void func_184201_a(EntityEquipmentSlot var1, @Nullable ItemStack var2);
   ...
   public void func_110145_l(Entity p_110145_1_) {
      if(!(p_110145_1_ instanceof EntityBoat) && !(p_110145_1_ instanceof EntityHorse)) {
         ...
         AxisAlignedBB axisalignedbb = new AxisAlignedBB(d5 - d7 / 2.0D, this.func_174813_aQ().field_72338_b, d6 - d8 / 2.0D, d5 + d7 / 2.0D, this.func_174813_aQ().field_72337_e, d6 + d8 / 2.0D);
   ...
   public void func_70071_h_() {
      ...
      if(!this.field_70170_p.field_72995_K) {
         ...
         for(EntityEquipmentSlot entityequipmentslot : EntityEquipmentSlot.values()) {
            ...
            case HAND:
               ...
               break;
            case ARMOR:
               itemstack = this.field_184631_bt[entityequipmentslot.func_188454_b()];
               break;
            default:
               continue;
            }
            ...
            if(!ItemStack.func_77989_b(itemstack1, itemstack)) {
               ...
               switch(entityequipmentslot.func_188453_a()) {
               case HAND:
                  this.field_184630_bs[entityequipmentslot.func_188454_b()] = itemstack1 == null?null:itemstack1.func_77946_l();
                  break;
               case ARMOR:
                  this.field_184631_bt[entityequipmentslot.func_188454_b()] = itemstack1 == null?null:itemstack1.func_77946_l();
               }
            }
         }
      ...
      if(f1 > 0.0025000002F) {
         ...
         f2 = (float)MathHelper.func_181159_b(d1, d0) * 57.295776F - 90.0F;
      }
   ...
   public void func_71001_a(Entity p_71001_1_, int p_71001_2_) {
      if(!p_71001_1_.field_70128_L && !this.field_70170_p.field_72995_K) {
         ...
         if(p_71001_1_ instanceof EntityItem) {
            entitytracker.func_151247_a(p_71001_1_, new SPacketCollectItem(p_71001_1_.func_145782_y(), this.func_145782_y()));
         }
   ...
   protected void func_184584_a(@Nullable ItemStack p_184584_1_, int p_184584_2_) {
