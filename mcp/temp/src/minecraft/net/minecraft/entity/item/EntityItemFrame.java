...
public class EntityItemFrame extends EntityHanging {
   private static final DataParameter<Optional<ItemStack>> field_184525_c = EntityDataManager.<Optional<ItemStack>>func_187226_a(EntityItemFrame.class, DataSerializers.field_187196_f);
   ...
   public ItemStack func_82335_i() {
      return (ItemStack)((Optional)this.func_184212_Q().func_187225_a(field_184525_c)).orNull();
   }

   public void func_82334_a(@Nullable ItemStack p_82334_1_) {
      this.func_174864_a(p_82334_1_, true);
   }

   private void func_174864_a(@Nullable ItemStack p_174864_1_, boolean p_174864_2_) {
      if(p_174864_1_ != null) {
   ...
   public void func_184206_a(DataParameter<?> p_184206_1_) {
      if(p_184206_1_.equals(field_184525_c)) {
         ItemStack itemstack = this.func_82335_i();
         if(itemstack != null && itemstack.func_82836_z() != this) {
   ...
   public static void func_189738_a(DataFixer p_189738_0_) {
      p_189738_0_.func_188258_a(FixTypes.ENTITY, new ItemStackData("ItemFrame", new String[]{"Item"}));
   }
   ...
   public boolean func_184230_a(EntityPlayer p_184230_1_, @Nullable ItemStack p_184230_2_, EnumHand p_184230_3_) {
      if(this.func_82335_i() == null) {
         if(p_184230_2_ != null && !this.field_70170_p.field_72995_K) {
            this.func_82334_a(p_184230_2_);
