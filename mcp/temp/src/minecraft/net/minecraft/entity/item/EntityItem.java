...
public class EntityItem extends Entity {
   ...
   private static final DataParameter<Optional<ItemStack>> field_184533_c = EntityDataManager.<Optional<ItemStack>>func_187226_a(EntityItem.class, DataSerializers.field_187196_f);
   ...
   protected void func_70088_a() {
      this.func_184212_Q().func_187214_a(field_184533_c, Optional.<T>absent());
   }
   ...
   public static void func_189742_a(DataFixer p_189742_0_) {
      p_189742_0_.func_188258_a(FixTypes.ENTITY, new ItemStackData("Item", new String[]{"Item"}));
   }
      ...
      if(!this.field_70170_p.field_72995_K) {
         ...
         if(this.field_145804_b == 0 && (this.field_145802_g == null || 6000 - this.field_70292_b <= 200 || this.field_145802_g.equals(p_70100_1_.func_70005_c_())) && p_70100_1_.field_71071_by.func_70441_a(itemstack)) {
            if(itemstack.func_77973_b() == Item.func_150898_a(Blocks.field_150364_r)) {
               p_70100_1_.func_71029_a(AchievementList.field_187983_g);
            }
            ...
            if(itemstack.func_77973_b() == Items.field_151045_i) {
               p_70100_1_.func_71029_a(AchievementList.field_187995_w);
            }

            if(itemstack.func_77973_b() == Items.field_151072_bj) {
               p_70100_1_.func_71029_a(AchievementList.field_187969_A);
            }
            ...
            p_70100_1_.func_71064_a(StatList.func_188056_d(itemstack.func_77973_b()), i);
         }
   ...
   public ItemStack func_92059_d() {
      ItemStack itemstack = (ItemStack)((Optional)this.func_184212_Q().func_187225_a(field_184533_c)).orNull();
      if(itemstack == null) {
         if(this.field_70170_p != null) {
            field_145803_d.error("Item entity {} has no item?!", new Object[]{Integer.valueOf(this.func_145782_y())});
         }
   ...
   public void func_92058_a(@Nullable ItemStack p_92058_1_) {
      this.func_184212_Q().func_187227_b(field_184533_c, Optional.<T>fromNullable(p_92058_1_));
