...
public class EntityBoat extends Entity {
            ...
            while(true) {
               ...
               for(int i2 = i1; i2 < j1; ++i2) {
                  ...
                  if(iblockstate.func_185904_a() == Material.field_151586_h) {
                     f = Math.max(f, func_184456_a(iblockstate, this.field_70170_p, blockpos$pooledmutableblockpos));
                  }
               ...
               if(j2 != 2) {
                  for(int k2 = k; k2 < l; ++k2) {
                     if(j2 <= 0 || k2 != k && k2 != l - 1) {
                        ...
                        IBlockState iblockstate = this.field_70170_p.func_180495_p(blockpos$pooledmutableblockpos);
                        iblockstate.func_185908_a(this.field_70170_p, blockpos$pooledmutableblockpos, axisalignedbb1, list, this);
                        if(!list.isEmpty()) {
         ...
         for(int k1 = i; k1 < j; ++k1) {
            for(int l1 = k; l1 < l; ++l1) {
               for(int i2 = i1; i2 < j1; ++i2) {
                  ...
                  IBlockState iblockstate = this.field_70170_p.func_180495_p(blockpos$pooledmutableblockpos);
                  if(iblockstate.func_185904_a() == Material.field_151586_h) {
                     float f = func_184452_b(iblockstate, this.field_70170_p, blockpos$pooledmutableblockpos);
         ...
         for(int k1 = i; k1 < j; ++k1) {
            for(int l1 = k; l1 < l; ++l1) {
               for(int i2 = i1; i2 < j1; ++i2) {
                  blockpos$pooledmutableblockpos.func_181079_c(k1, l1, i2);
                  IBlockState iblockstate = this.field_70170_p.func_180495_p(blockpos$pooledmutableblockpos);
                  if(iblockstate.func_185904_a() == Material.field_151586_h && d0 < (double)func_184452_b(iblockstate, this.field_70170_p, blockpos$pooledmutableblockpos)) {
   ...
   public static float func_184456_a(IBlockState p_184456_0_, IBlockAccess p_184456_1_, BlockPos p_184456_2_) {
      int i = ((Integer)p_184456_0_.func_177229_b(BlockLiquid.field_176367_b)).intValue();
      return (i & 7) == 0 && p_184456_1_.func_180495_p(p_184456_2_.func_177984_a()).func_185904_a() == Material.field_151586_h?1.0F:1.0F - BlockLiquid.func_149801_b(i);
   }

   public static float func_184452_b(IBlockState p_184452_0_, IBlockAccess p_184452_1_, BlockPos p_184452_2_) {
      return (float)p_184452_2_.func_177956_o() + func_184456_a(p_184452_0_, p_184452_1_, p_184452_2_);
   }
   ...
   public boolean func_184230_a(EntityPlayer p_184230_1_, @Nullable ItemStack p_184230_2_, EnumHand p_184230_3_) {
      if(!this.field_70170_p.field_72995_K && !p_184230_1_.func_70093_af() && this.field_184474_h < 60.0F) {
