...
public class EntityList {
   ...
   private static void func_75614_a(Class<? extends Entity> p_75614_0_, String p_75614_1_, int p_75614_2_, int p_75614_3_, int p_75614_4_) {
      ...
      field_75627_a.put(p_75614_1_, new EntityList.EntityEggInfo(p_75614_1_, p_75614_3_, p_75614_4_));
   }
   ...
   public static Entity func_75615_a(NBTTagCompound p_75615_0_, World p_75615_1_) {
      ...
      if(entity != null) {
         ...
         field_151516_b.warn("Skipping Entity with id {}", new Object[]{p_75615_0_.func_74779_i("id")});
      }
   ...
   public static Entity func_75616_a(int p_75616_0_, World p_75616_1_) {
      ...
      if(entity == null) {
         field_151516_b.warn("Skipping Entity with id {}", new Object[]{Integer.valueOf(p_75616_0_)});
      }
   ...
   public static String func_75621_b(Entity p_75621_0_) {
      return func_188430_a(p_75621_0_.getClass());
   }

   public static String func_188430_a(Class<? extends Entity> p_188430_0_) {
      return (String)field_75626_c.get(p_188430_0_);
   }
   ...
   public static boolean func_180123_a(Entity p_180123_0_, String p_180123_1_) {
      ...
      if(s == null) {
         if(p_180123_0_ instanceof EntityPlayer) {
            s = "Player";
         } else {
            if(!(p_180123_0_ instanceof EntityLightningBolt)) {
               return false;
            }
   ...
   static {
      ...
      func_75618_a(EntityAreaEffectCloud.class, "AreaEffectCloud", 3);
      ...
      func_75618_a(EntityTippedArrow.class, "Arrow", 10);
      ...
      func_75618_a(EntitySpectralArrow.class, "SpectralArrow", 24);
      func_75618_a(EntityShulkerBullet.class, "ShulkerBullet", 25);
      func_75618_a(EntityDragonFireball.class, "DragonFireball", 26);
      func_75618_a(EntityArmorStand.class, "ArmorStand", 30);
      func_75618_a(EntityBoat.class, "Boat", 41);
      func_75618_a(EntityMinecartEmpty.class, EntityMinecart.Type.RIDEABLE.func_184954_b(), 42);
      func_75618_a(EntityMinecartChest.class, EntityMinecart.Type.CHEST.func_184954_b(), 43);
      func_75618_a(EntityMinecartFurnace.class, EntityMinecart.Type.FURNACE.func_184954_b(), 44);
      func_75618_a(EntityMinecartTNT.class, EntityMinecart.Type.TNT.func_184954_b(), 45);
      func_75618_a(EntityMinecartHopper.class, EntityMinecart.Type.HOPPER.func_184954_b(), 46);
      func_75618_a(EntityMinecartMobSpawner.class, EntityMinecart.Type.SPAWNER.func_184954_b(), 47);
      func_75618_a(EntityMinecartCommandBlock.class, EntityMinecart.Type.COMMAND_BLOCK.func_184954_b(), 40);
      ...
      func_75614_a(EntityShulker.class, "Shulker", 69, 9725844, 5060690);
      ...
      func_75614_a(EntityPolarBear.class, "PolarBear", 102, 15921906, 9803152);
   ...
   public static class EntityEggInfo {
      public final String field_75613_a;
      ...
      public EntityEggInfo(String p_i47076_1_, int p_i47076_2_, int p_i47076_3_) {
         this.field_75613_a = p_i47076_1_;
         this.field_75611_b = p_i47076_2_;
         this.field_75612_c = p_i47076_3_;
