...
public class EntityVillager extends EntityAgeable implements IMerchant, INpc {
   ...
   public static void func_189785_b(DataFixer p_189785_0_) {
      ...
      p_189785_0_.func_188258_a(FixTypes.ENTITY, new ItemStackDataLists("Villager", new String[]{"Inventory"}));
   ...
   private boolean func_175559_s(int p_175559_1_) {
      ...
      for(int i = 0; i < this.field_175560_bz.func_70302_i_(); ++i) {
         ItemStack itemstack = this.field_175560_bz.func_70301_a(i);
         if(itemstack != null) {
            if(itemstack.func_77973_b() == Items.field_151025_P && itemstack.field_77994_a >= 3 * p_175559_1_ || itemstack.func_77973_b() == Items.field_151174_bG && itemstack.field_77994_a >= 12 * p_175559_1_ || itemstack.func_77973_b() == Items.field_151172_bF && itemstack.field_77994_a >= 12 * p_175559_1_ || itemstack.func_77973_b() == Items.field_185164_cV && itemstack.field_77994_a >= 12 * p_175559_1_) {
               return true;
            }
   ...
   public boolean func_175556_cs() {
      for(int i = 0; i < this.field_175560_bz.func_70302_i_(); ++i) {
         ItemStack itemstack = this.field_175560_bz.func_70301_a(i);
         if(itemstack != null && (itemstack.func_77973_b() == Items.field_151014_N || itemstack.func_77973_b() == Items.field_151174_bG || itemstack.func_77973_b() == Items.field_151172_bF || itemstack.func_77973_b() == Items.field_185163_cU)) {
            return true;
         }
      }
   ...
   static class ListEnchantedBookForEmeralds implements EntityVillager.ITradeList {
      public void func_179401_a(MerchantRecipeList p_179401_1_, Random p_179401_2_) {
         Enchantment enchantment = (Enchantment)Enchantment.field_185264_b.func_186801_a(p_179401_2_);
   ...
   static class ListEnchantedItemForEmeralds implements EntityVillager.ITradeList {
      ...
      public void func_179401_a(MerchantRecipeList p_179401_1_, Random p_179401_2_) {
         ...
         itemstack1 = EnchantmentHelper.func_77504_a(p_179401_2_, itemstack1, 5 + p_179401_2_.nextInt(15), false);
