...
public abstract class EntityAnimal extends EntityAgeable implements IAnimals {
   ...
   public boolean func_184645_a(EntityPlayer p_184645_1_, EnumHand p_184645_2_, @Nullable ItemStack p_184645_3_) {
      if(p_184645_3_ != null) {
         if(this.func_70877_b(p_184645_3_) && this.func_70874_b() == 0 && this.field_70881_d <= 0) {
            this.func_175505_a(p_184645_1_, p_184645_3_);
            this.func_146082_f(p_184645_1_);
            return true;
         }

         if(this.func_70631_g_() && this.func_70877_b(p_184645_3_)) {
            this.func_175505_a(p_184645_1_, p_184645_3_);
