   ...
   public boolean func_184645_a(EntityPlayer p_184645_1_, EnumHand p_184645_2_, @Nullable ItemStack p_184645_3_) {
      if(p_184645_3_ != null && p_184645_3_.func_77973_b() == Items.field_151063_bx) {
         if(!this.field_70170_p.field_72995_K) {
            Class<? extends Entity> oclass = EntityList.func_90035_a(EntityList.func_180122_a(ItemMonsterPlacer.func_185080_h(p_184645_3_)));
            if(oclass != null && this.getClass() == oclass) {
               ...
               if(entityageable != null) {
                  ...
                  if(p_184645_3_.func_82837_s()) {
                     entityageable.func_96094_a(p_184645_3_.func_82833_r());
                  }
