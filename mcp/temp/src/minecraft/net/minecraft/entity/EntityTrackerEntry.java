...
public class EntityTrackerEntry {
   ...
   private Packet<?> func_151260_c() {
      ...
      if(this.field_73132_a instanceof EntityItem) {
         ...
         Entity entity2 = ((EntityFishHook)this.field_73132_a).field_146042_b;
         return new SPacketSpawnObject(this.field_73132_a, 90, entity2 != null?entity2.func_145782_y():this.field_73132_a.func_145782_y());
         ...
         return new SPacketSpawnObject(this.field_73132_a, 91, 1 + (entity1 != null?entity1.func_145782_y():this.field_73132_a.func_145782_y()));
      } else if(this.field_73132_a instanceof EntityTippedArrow) {
         Entity entity = ((EntityArrow)this.field_73132_a).field_70250_c;
         return new SPacketSpawnObject(this.field_73132_a, 60, 1 + (entity != null?entity.func_145782_y():this.field_73132_a.func_145782_y()));
