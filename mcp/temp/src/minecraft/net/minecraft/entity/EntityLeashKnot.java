...
public class EntityLeashKnot extends EntityHanging {
   ...
   public boolean func_184230_a(EntityPlayer p_184230_1_, @Nullable ItemStack p_184230_2_, EnumHand p_184230_3_) {
      if(this.field_70170_p.field_72995_K) {
         ...
         boolean flag = false;
         if(p_184230_2_ != null && p_184230_2_.func_77973_b() == Items.field_151058_ca) {
            double d0 = 7.0D;
         ...
         if(!flag) {
            ...
            if(p_184230_1_.field_71075_bZ.field_75098_d) {
               ...
               for(EntityLiving entityliving1 : this.field_70170_p.func_72872_a(EntityLiving.class, new AxisAlignedBB(this.field_70165_t - 7.0D, this.field_70163_u - 7.0D, this.field_70161_v - 7.0D, this.field_70165_t + 7.0D, this.field_70163_u + 7.0D, this.field_70161_v + 7.0D))) {
