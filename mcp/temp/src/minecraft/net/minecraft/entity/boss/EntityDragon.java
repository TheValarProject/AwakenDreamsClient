...
public class EntityDragon extends EntityLiving implements IEntityMultiPart, IMob {
   ...
   public void func_70636_d() {
      ...
      if(this.func_110143_aJ() <= 0.0F) {
         ...
         this.field_70170_p.func_175688_a(EnumParticleTypes.EXPLOSION_LARGE, this.field_70165_t + (double)f13, this.field_70163_u + 2.0D + (double)f15, this.field_70161_v + (double)f17, 0.0D, 0.0D, 0.0D, new int[0]);
      } else {
         this.func_70969_j();
         ...
         if(this.func_175446_cd()) {
            ...
            if(this.field_70170_p.field_72995_K) {
               ...
               if(vec3d != null) {
                  ...
                  d7 = MathHelper.func_151237_a(d7 / (double)MathHelper.func_76133_a(d6 * d6 + d8 * d8), (double)(-f6), (double)f6);
                  ...
                  float f10 = 0.06F;
                  this.func_70060_a(0.0F, -1.0F, 0.06F * (f8 * f9 + (1.0F - f9)));
            ...
            this.field_70987_i.func_70012_b(this.field_70165_t + (double)(f19 * 0.5F), this.field_70163_u, this.field_70161_v - (double)(f3 * 0.5F), 0.0F, 0.0F);
            this.field_70983_bA.func_70071_h_();
            this.field_70983_bA.func_70012_b(this.field_70165_t + (double)(f3 * 4.5F), this.field_70163_u + 2.0D, this.field_70161_v + (double)(f19 * 4.5F), 0.0F, 0.0F);
            this.field_70990_bB.func_70071_h_();
            this.field_70990_bB.func_70012_b(this.field_70165_t - (double)(f3 * 4.5F), this.field_70163_u + 2.0D, this.field_70161_v - (double)(f19 * 4.5F), 0.0F, 0.0F);
            ...
            float f4 = MathHelper.func_76126_a(this.field_70177_z * 0.017453292F - this.field_70704_bt * 0.01F);
            float f20 = MathHelper.func_76134_b(this.field_70177_z * 0.017453292F - this.field_70704_bt * 0.01F);
            this.field_70986_h.func_70071_h_();
            this.field_184673_bv.func_70071_h_();
            float f5 = this.func_184662_q(1.0F);
            this.field_70986_h.func_70012_b(this.field_70165_t + (double)(f4 * 6.5F * f16), this.field_70163_u + (double)f5 + (double)(f18 * 6.5F), this.field_70161_v - (double)(f20 * 6.5F * f16), 0.0F, 0.0F);
            this.field_184673_bv.func_70012_b(this.field_70165_t + (double)(f4 * 5.5F * f16), this.field_70163_u + (double)f5 + (double)(f18 * 5.5F), this.field_70161_v - (double)(f20 * 5.5F * f16), 0.0F, 0.0F);
            ...
            for(int j = 0; j < 3; ++j) {
               ...
               double[] adouble1 = this.func_70974_a(12 + j * 2, 1.0F);
               ...
               entitydragonpart.func_70012_b(this.field_70165_t - (double)((f19 * 1.5F + f22 * f24) * f16), this.field_70163_u + (adouble1[1] - adouble[1]) - (double)((f24 + 1.5F) * f18) + 1.5D, this.field_70161_v + (double)((f3 * 1.5F + f7 * f24) * f16), 0.0F, 0.0F);
            }
