   ...
   public boolean func_75253_b() {
      ...
      if(entitylivingbase == null) {
         ...
         if(team != null && team1 == team) {
            ...
            double d0 = this.func_179431_f();
            return this.field_179434_b.func_70068_e(entitylivingbase) > d0 * d0?false:!(entitylivingbase instanceof EntityPlayerMP) || !((EntityPlayerMP)entitylivingbase).field_71134_c.func_73083_d();
         }
      }
   }
