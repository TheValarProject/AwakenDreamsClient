...
public class EntityAIFindEntityNearest extends EntityAIBase {
   ...
   public EntityAIFindEntityNearest(EntityLiving p_i45884_1_, Class<? extends EntityLivingBase> p_i45884_2_) {
      ...
      this.field_179443_c = new Predicate<EntityLivingBase>() {
         public boolean apply(@Nullable EntityLivingBase p_apply_1_) {
            ...
            return p_apply_1_.func_82150_aj()?false:((double)p_apply_1_.func_70032_d(EntityAIFindEntityNearest.this.field_179442_b) > d0?false:EntityAITarget.func_179445_a(EntityAIFindEntityNearest.this.field_179442_b, p_apply_1_, false, true));
         }
      };
   ...
   public boolean func_75253_b() {
      ...
      if(entitylivingbase == null) {
         ...
         double d0 = this.func_179438_f();
         return this.field_179442_b.func_70068_e(entitylivingbase) > d0 * d0?false:!(entitylivingbase instanceof EntityPlayerMP) || !((EntityPlayerMP)entitylivingbase).field_71134_c.func_73083_d();
      }
   }
