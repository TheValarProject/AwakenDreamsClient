...
public class EntityAITempt extends EntityAIBase {
   ...
   public EntityAITempt(EntityCreature p_i45316_1_, double p_i45316_2_, Item p_i45316_4_, boolean p_i45316_5_) {
      this(p_i45316_1_, p_i45316_2_, p_i45316_5_, Sets.newHashSet(new Item[]{p_i45316_4_}));
   }
   ...
   public boolean func_75250_a() {
      if(this.field_75290_i > 0) {
         ...
         return this.field_75289_h == null?false:this.func_188508_a(this.field_75289_h.func_184614_ca()) || this.func_188508_a(this.field_75289_h.func_184592_cb());
      }
   }

   protected boolean func_188508_a(@Nullable ItemStack p_188508_1_) {
      return p_188508_1_ == null?false:this.field_151484_k.contains(p_188508_1_.func_77973_b());
   }
