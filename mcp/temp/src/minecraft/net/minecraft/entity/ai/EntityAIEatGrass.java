...
public class EntityAIEatGrass extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if(this.field_151500_b.func_70681_au().nextInt(this.field_151500_b.func_70631_g_()?50:1000) != 0) {
         ...
         return field_179505_b.apply(this.field_151501_c.func_180495_p(blockpos))?true:this.field_151501_c.func_180495_p(blockpos.func_177977_b()).func_177230_c() == Blocks.field_150349_c;
      }
   }
