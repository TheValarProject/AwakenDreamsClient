...
public class EntityAIMate extends EntityAIBase {
   ...
   private EntityAnimal func_75389_f() {
      List<EntityAnimal> list = this.field_75394_a.<EntityAnimal>func_72872_a(this.field_75390_d.getClass(), this.field_75390_d.func_174813_aQ().func_186662_g(8.0D));
      ...
      if(entityageable != null) {
         ...
         if(entityplayer != null) {
            ...
            if(this.field_75390_d instanceof EntityCow) {
               entityplayer.func_71029_a(AchievementList.field_187975_H);
            }
         }
