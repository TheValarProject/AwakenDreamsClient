...
public class EntityGuardian extends EntityMob {
   private static final DataParameter<Byte> field_184722_a = EntityDataManager.<Byte>func_187226_a(EntityGuardian.class, DataSerializers.field_187191_a);
   ...
   protected void func_70088_a() {
      super.func_70088_a();
      this.field_70180_af.func_187214_a(field_184722_a, Byte.valueOf((byte)0));
      this.field_70180_af.func_187214_a(field_184723_b, Integer.valueOf(0));
   }

   private boolean func_175468_a(int p_175468_1_) {
      return (((Byte)this.field_70180_af.func_187225_a(field_184722_a)).byteValue() & p_175468_1_) != 0;
   }

   private void func_175473_a(int p_175473_1_, boolean p_175473_2_) {
      byte b0 = ((Byte)this.field_70180_af.func_187225_a(field_184722_a)).byteValue();
      if(p_175473_2_) {
         this.field_70180_af.func_187227_b(field_184722_a, Byte.valueOf((byte)(b0 | p_175473_1_)));
      } else {
         this.field_70180_af.func_187227_b(field_184722_a, Byte.valueOf((byte)(b0 & ~p_175473_1_)));
      }
   ...
   public void func_184206_a(DataParameter<?> p_184206_1_) {
      ...
      if(field_184722_a.equals(p_184206_1_)) {
         if(this.func_175461_cl() && this.field_70130_N < 1.0F) {
            this.func_70105_a(1.9975F, 1.9975F);
         }
      } else if(field_184723_b.equals(p_184206_1_)) {
   ...
   protected SoundEvent func_184639_G() {
      return this.func_175461_cl()?(this.func_70090_H()?SoundEvents.field_187512_aB:SoundEvents.field_187513_aC):(this.func_70090_H()?SoundEvents.field_187670_cb:SoundEvents.field_187672_cc);
   }

   protected SoundEvent func_184601_bQ() {
      return this.func_175461_cl()?(this.func_70090_H()?SoundEvents.field_187517_aG:SoundEvents.field_187518_aH):(this.func_70090_H()?SoundEvents.field_187687_ch:SoundEvents.field_187690_ci);
   }

   protected SoundEvent func_184615_bR() {
      return this.func_175461_cl()?(this.func_70090_H()?SoundEvents.field_187515_aE:SoundEvents.field_187516_aF):(this.func_70090_H()?SoundEvents.field_187678_ce:SoundEvents.field_187681_cf);
   }
      ...
      if(this.field_70170_p.field_72995_K) {
         ...
         if(!this.func_70090_H()) {
            ...
            if(this.field_70181_x > 0.0D && this.field_175480_bp && !this.func_174814_R()) {
               this.field_70170_p.func_184134_a(this.field_70165_t, this.field_70163_u, this.field_70161_v, SoundEvents.field_187684_cg, this.func_184176_by(), 1.0F, 1.0F, false);
            }
         ...
         if(this.func_175474_cn()) {
            ...
            if(entitylivingbase != null) {
               ...
               while(d4 < d3) {
                  ...
                  this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_BUBBLE, this.field_70165_t + d0 * d4, this.field_70163_u + d1 * d4 + (double)this.func_70047_e(), this.field_70161_v + d2 * d4, 0.0D, 0.0D, 0.0D, new int[0]);
               }
            }
         }
      }
   ...
   protected ResourceLocation func_184647_J() {
      return this.func_175461_cl()?LootTableList.field_186441_w:LootTableList.field_186440_v;
   }
