   ...
   protected boolean func_184689_o() {
      if(!this.func_175446_cd() && this.func_70089_S()) {
         ...
         for(int i = 0; i < 5; ++i) {
            ...
            if(blockpos1.func_177956_o() > 0 && this.field_70170_p.func_175623_d(blockpos1) && this.field_70170_p.func_175673_a(this.field_70170_p.func_175723_af(), this) && this.field_70170_p.func_184144_a(this, new AxisAlignedBB(blockpos1)).isEmpty()) {
               boolean flag = false;
