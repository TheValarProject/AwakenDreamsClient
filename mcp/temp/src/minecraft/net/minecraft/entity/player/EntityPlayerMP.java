...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener {
   ...
   public EntityPlayerMP(MinecraftServer p_i45285_1_, WorldServer p_i45285_2_, GameProfile p_i45285_3_, PlayerInteractionManager p_i45285_4_) {
      ...
      if(!p_i45285_2_.field_73011_w.func_177495_o() && p_i45285_2_.func_72912_H().func_76077_q() != GameType.ADVENTURE) {
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      if(this.func_184187_bx() != null && entity != this & entity.func_184180_b(EntityPlayerMP.class).size() == 1) {
         NBTTagCompound nbttagcompound = new NBTTagCompound();
         NBTTagCompound nbttagcompound1 = new NBTTagCompound();
         entity.func_70039_c(nbttagcompound1);
         nbttagcompound.func_186854_a("Attach", this.func_184187_bx().func_110124_au());
   ...
   public void func_71127_g() {
      try {
         ...
         if(this.field_70173_aa % 20 * 5 == 0 && !this.func_147099_x().func_77443_a(AchievementList.field_187979_L)) {
            this.func_147098_j();
         }
   ...
   public void func_70645_a(DamageSource p_70645_1_) {
      ...
      if(entitylivingbase != null) {
         EntityList.EntityEggInfo entitylist$entityegginfo = (EntityList.EntityEggInfo)EntityList.field_75627_a.get(EntityList.func_75621_b(entitylivingbase));
   ...
   public void func_180468_a(IInteractionObject p_180468_1_) {
      if(p_180468_1_ instanceof ILootContainer && ((ILootContainer)p_180468_1_).func_184276_b() != null && this.func_175149_v()) {
         this.func_145747_a((new TextComponentTranslation("container.spectatorCantOpen", new Object[0])).func_150255_a((new Style()).func_150238_a(TextFormatting.RED)));
      } else {
         this.func_71117_bO();
   ...
   public void func_146105_b(ITextComponent p_146105_1_) {
      this.field_71135_a.func_147359_a(new SPacketChat(p_146105_1_));
   }
