...
public abstract class EntityLiving extends EntityLivingBase {
   ...
   private final ItemStack[] field_184656_bv = new ItemStack[2];
   protected float[] field_82174_bp = new float[2];
   private final ItemStack[] field_184657_bw = new ItemStack[4];
   ...
   protected int func_70693_a(EntityPlayer p_70693_1_) {
      if(this.field_70728_aV > 0) {
         ...
         for(int j = 0; j < this.field_184657_bw.length; ++j) {
            if(this.field_184657_bw[j] != null && this.field_184655_bs[j] <= 1.0F) {
               i += 1 + this.field_70146_Z.nextInt(3);
            }
         }

         for(int k = 0; k < this.field_184656_bv.length; ++k) {
            if(this.field_184656_bv[k] != null && this.field_82174_bp[k] <= 1.0F) {
               i += 1 + this.field_70146_Z.nextInt(3);
            }
         }
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      for(float f1 : this.field_184655_bs) {
         nbttaglist2.func_74742_a(new NBTTagFloat(f1));
      }
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if(p_70037_1_.func_150297_b("ArmorItems", 9)) {
         ...
         for(int i = 0; i < this.field_184657_bw.length; ++i) {
            this.field_184657_bw[i] = ItemStack.func_77949_a(nbttaglist.func_150305_b(i));
         }
      }
      ...
      if(p_70037_1_.func_150297_b("HandItems", 9)) {
         ...
         for(int j = 0; j < this.field_184656_bv.length; ++j) {
            this.field_184656_bv[j] = ItemStack.func_77949_a(nbttaglist1.func_150305_b(j));
         }
      }
   ...
   protected void func_175445_a(EntityItem p_175445_1_) {
      ...
      if(flag && this.func_175448_a(itemstack)) {
         ...
         if(itemstack1 != null && (double)(this.field_70146_Z.nextFloat() - 0.1F) < d0) {
         ...
         if(itemstack.func_77973_b() == Items.field_151045_i && p_175445_1_.func_145800_j() != null) {
            ...
            if(entityplayer != null) {
               entityplayer.func_71029_a(AchievementList.field_187996_x);
            }
         }
   ...
   public Iterable<ItemStack> func_184214_aD() {
      return Arrays.<ItemStack>asList(this.field_184656_bv);
   }

   public Iterable<ItemStack> func_184193_aE() {
      return Arrays.<ItemStack>asList(this.field_184657_bw);
   }
   ...
   public ItemStack func_184582_a(EntityEquipmentSlot p_184582_1_) {
      ...
      case HAND:
         itemstack = this.field_184656_bv[p_184582_1_.func_188454_b()];
         break;
      case ARMOR:
         itemstack = this.field_184657_bw[p_184582_1_.func_188454_b()];
      }
   ...
   public void func_184201_a(EntityEquipmentSlot p_184201_1_, @Nullable ItemStack p_184201_2_) {
      ...
      case HAND:
         this.field_184656_bv[p_184201_1_.func_188454_b()] = p_184201_2_;
         break;
      case ARMOR:
         this.field_184657_bw[p_184201_1_.func_188454_b()] = p_184201_2_;
      }
   ...
   protected void func_82160_b(boolean p_82160_1_, int p_82160_2_) {
      for(EntityEquipmentSlot entityequipmentslot : EntityEquipmentSlot.values()) {
         ...
         if(itemstack != null && (p_82160_1_ || flag) && (double)(this.field_70146_Z.nextFloat() - (float)p_82160_2_ * 0.01F) < d0) {
   ...
   public static EntityEquipmentSlot func_184640_d(ItemStack p_184640_0_) {
      return p_184640_0_.func_77973_b() != Item.func_150898_a(Blocks.field_150423_aK) && p_184640_0_.func_77973_b() != Items.field_151144_bL?(p_184640_0_.func_77973_b() instanceof ItemArmor?((ItemArmor)p_184640_0_.func_77973_b()).field_77881_a:(p_184640_0_.func_77973_b() == Items.field_185160_cR?EntityEquipmentSlot.CHEST:(p_184640_0_.func_77973_b() == Items.field_185159_cQ?EntityEquipmentSlot.OFFHAND:EntityEquipmentSlot.MAINHAND))):EntityEquipmentSlot.HEAD;
   }
   ...
   public final boolean func_184230_a(EntityPlayer p_184230_1_, @Nullable ItemStack p_184230_2_, EnumHand p_184230_3_) {
      if(this.func_110167_bD() && this.func_110166_bE() == p_184230_1_) {
         this.func_110160_i(true, !p_184230_1_.field_71075_bZ.field_75098_d);
         return true;
      } else if(p_184230_2_ != null && p_184230_2_.func_77973_b() == Items.field_151058_ca && this.func_184652_a(p_184230_1_)) {
         this.func_110162_b(p_184230_1_, true);
         --p_184230_2_.field_77994_a;
         return true;
      } else {
   ...
   public boolean func_174820_d(int p_174820_1_, @Nullable ItemStack p_174820_2_) {
      ...
      if(p_174820_2_ != null && !func_184648_b(entityequipmentslot, p_174820_2_) && entityequipmentslot != EntityEquipmentSlot.HEAD) {
         return false;
      } else {
