         ...
         for(int j = 0; j < 2; ++j) {
            if(!this.field_78876_b[i][j].isEmpty()) {
               ...
               for(final Particle particle : this.field_78876_b[i][j]) {
                  try {
                     particle.func_180434_a(vertexbuffer, p_78874_1_, p_78874_2_, f, f4, f1, f2, f3);
                  } catch (Throwable throwable) {
      ...
      for(int i = 0; i < 2; ++i) {
         ...
         if(!queue.isEmpty()) {
            ...
            for(Particle particle : queue) {
               particle.func_180434_a(vertexbuffer, p_78872_1_, p_78872_2_, f1, f5, f2, f3, f4);
            }
         }
      }
   ...
   public void func_180533_a(BlockPos p_180533_1_, IBlockState p_180533_2_) {
      if(p_180533_2_.func_185904_a() != Material.field_151579_a) {
         ...
         for(int j = 0; j < 4; ++j) {
            for(int k = 0; k < 4; ++k) {
               for(int l = 0; l < 4; ++l) {
                  double d0 = (double)p_180533_1_.func_177958_n() + ((double)j + 0.5D) / 4.0D;
                  double d1 = (double)p_180533_1_.func_177956_o() + ((double)k + 0.5D) / 4.0D;
                  double d2 = (double)p_180533_1_.func_177952_p() + ((double)l + 0.5D) / 4.0D;
                  this.func_78873_a((new ParticleDigging(this.field_78878_a, d0, d1, d2, d0 - (double)p_180533_1_.func_177958_n() - 0.5D, d1 - (double)p_180533_1_.func_177956_o() - 0.5D, d2 - (double)p_180533_1_.func_177952_p() - 0.5D, p_180533_2_)).func_174846_a(p_180533_1_));
               }
            }
         }
