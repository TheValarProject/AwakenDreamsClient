...
public class GuiConnecting extends GuiScreen {
   ...
   private void func_146367_a(final String p_146367_1_, final int p_146367_2_) {
      field_146370_f.info("Connecting to {}, {}", new Object[]{p_146367_1_, Integer.valueOf(p_146367_2_)});
      (new Thread("Server Connector #" + field_146372_a.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               GuiConnecting.field_146370_f.error((String)"Couldn\'t connect to server", (Throwable)unknownhostexception);
               ...
               GuiConnecting.field_146370_f.error((String)"Couldn\'t connect to server", (Throwable)exception);
