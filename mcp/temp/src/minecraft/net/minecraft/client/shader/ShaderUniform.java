...
public class ShaderUniform {
   ...
   public void func_148097_a(float[] p_148097_1_) {
      if(p_148097_1_.length < this.field_148103_c) {
         field_148104_a.warn("Uniform.set called with a too-small value array (expected {}, got {}). Ignoring.", new Object[]{Integer.valueOf(this.field_148103_c), Integer.valueOf(p_148097_1_.length)});
      } else {
         this.field_148098_f.position(0);
   ...
   public void func_148093_b() {
      ...
      if(this.field_148100_d <= 3) {
         ...
         if(this.field_148100_d > 10) {
            field_148104_a.warn("Uniform.upload called, but type value ({}) is not a valid type. Ignoring.", new Object[]{Integer.valueOf(this.field_148100_d)});
            return;
         }
   ...
   private void func_148091_i() {
      ...
      case 3:
         ...
         break;
      default:
         field_148104_a.warn("Uniform.upload called, but count value ({}) is  not in the range of 1 to 4. Ignoring.", new Object[]{Integer.valueOf(this.field_148103_c)});
      }
