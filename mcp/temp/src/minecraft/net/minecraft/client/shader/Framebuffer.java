...
public class Framebuffer {
   ...
   public void func_147605_b(int p_147605_1_, int p_147605_2_) {
      ...
      if(!OpenGlHelper.func_148822_b()) {
         ...
         GlStateManager.func_187419_a(3553, 0, '\u8058', this.field_147622_a, this.field_147620_b, 0, 6408, 5121, (IntBuffer)null);
   ...
   public void func_178038_a(int p_178038_1_, int p_178038_2_, boolean p_178038_3_) {
      if(OpenGlHelper.func_148822_b()) {
         ...
         vertexbuffer.func_181662_b(0.0D, (double)f1, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
         vertexbuffer.func_181662_b((double)f, (double)f1, 0.0D).func_187315_a((double)f2, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
         vertexbuffer.func_181662_b((double)f, 0.0D, 0.0D).func_187315_a((double)f2, (double)f3).func_181669_b(255, 255, 255, 255).func_181675_d();
         vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_187315_a(0.0D, (double)f3).func_181669_b(255, 255, 255, 255).func_181675_d();
