...
public class ShaderManager {
   ...
   public ShaderManager(IResourceManager p_i45087_1_, String p_i45087_2_) throws JsonException, IOException {
      ...
      try {
         ...
         JsonObject jsonobject = jsonparser.parse(IOUtils.toString(iresource.func_110527_b(), Charsets.UTF_8)).getAsJsonObject();
   ...
   private void func_147990_i() {
      ...
      for(int j = 0; i < this.field_147998_g.size(); ++j) {
         ...
         if(k == -1) {
            field_148003_a.warn("Shader {}could not find sampler named {} in the specified shader program.", new Object[]{this.field_148007_m, s});
      ...
      for(ShaderUniform shaderuniform : this.field_148011_i) {
         ...
         if(l == -1) {
            field_148003_a.warn("Could not find uniform named {} in the specified shader program.", new Object[]{s1});
         } else {
