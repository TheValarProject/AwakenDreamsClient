...
public class ShaderLinkHelper {
   ...
   public void func_148075_b(ShaderManager p_148075_1_) throws IOException {
      ...
      if(i == 0) {
         field_148080_a.warn("Error encountered when linking program containing VS {} and FS {}. Log output:", new Object[]{p_148075_1_.func_147989_e().func_148055_a(), p_148075_1_.func_147994_f().func_148055_a()});
