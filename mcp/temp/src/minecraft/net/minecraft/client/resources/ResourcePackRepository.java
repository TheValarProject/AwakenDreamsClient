...
public class ResourcePackRepository {
   ...
   public static Map<String, String> func_190115_a() {
      ...
      map.put("X-Minecraft-Version", "1.10");
      return map;
   }
   ...
   private void func_110616_f() {
      if(this.field_110618_d.exists()) {
         if(!this.field_110618_d.isDirectory() && (!this.field_110618_d.delete() || !this.field_110618_d.mkdirs())) {
            field_177320_c.warn("Unable to recreate resourcepack folder, it exists but is not a directory: {}", new Object[]{this.field_110618_d});
         }
      } else if(!this.field_110618_d.mkdirs()) {
         field_177320_c.warn("Unable to create resourcepack folder: {}", new Object[]{this.field_110618_d});
      }
   ...
   public ListenableFuture<Object> func_180601_a(String p_180601_1_, String p_180601_2_) {
      ...
      try {
         ...
         if(file1.exists()) {
            ...
            field_177320_c.warn("Deleting file {}", new Object[]{file1});
         ...
         Futures.addCallback(this.field_177322_i, new FutureCallback<Object>() {
            public void onSuccess(@Nullable Object p_onSuccess_1_) {
               if(ResourcePackRepository.this.func_190113_a(s1, file1)) {
                  ...
                  ResourcePackRepository.field_177320_c.warn("Deleting file {}", new Object[]{file1});
                  FileUtils.deleteQuietly(file1);
               }
   ...
   private boolean func_190113_a(String p_190113_1_, File p_190113_2_) {
      try {
         ...
         if(p_190113_1_.isEmpty()) {
            field_177320_c.info("Found file {} without verification hash", new Object[]{p_190113_2_});
            return true;
         }

         if(s.toLowerCase().equals(p_190113_1_.toLowerCase())) {
            field_177320_c.info("Found file {} matching requested hash {}", new Object[]{p_190113_2_, p_190113_1_});
            return true;
         }

         field_177320_c.warn("File {} had wrong hash (expected {}, found {}).", new Object[]{p_190113_2_, p_190113_1_, s});
      } catch (IOException ioexception) {
         field_177320_c.warn("File {} couldn\'t be hashed.", new Object[]{p_190113_2_, ioexception});
      }
   ...
   private boolean func_190112_b(File p_190112_1_) {
      ...
      try {
         ...
         field_177320_c.warn((String)"Server resourcepack is invalid, ignoring it", (Throwable)exception);
         return false;
      }
   }
   ...
   private void func_183028_i() {
      try {
         ...
         for(File file1 : list) {
            if(i++ >= 10) {
               field_177320_c.info("Deleting old server resource pack {}", new Object[]{file1.getName()});
               FileUtils.deleteQuietly(file1);
            }
         }
      } catch (IllegalArgumentException illegalargumentexception) {
         field_177320_c.error("Error while deleting old server resource pack : {}", new Object[]{illegalargumentexception.getMessage()});
      }
