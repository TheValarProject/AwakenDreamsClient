...
public class GuiContainerCreative extends InventoryEffectRenderer {
   ...
   protected void func_184098_a(Slot p_184098_1_, int p_184098_2_, int p_184098_3_, ClickType p_184098_4_) {
      ...
      if(p_184098_1_ == null && field_147058_w != CreativeTabs.field_78036_m.func_78021_a() && p_184098_4_ != ClickType.QUICK_CRAFT) {
      ...
      } else if(p_184098_1_ == this.field_147064_C && flag) {
         ...
         } else if(p_184098_4_ == ClickType.THROW && this.field_146297_k.field_71439_g.field_71071_by.func_70445_o() != null) {
         ...
         ItemStack itemstack2 = p_184098_1_.func_75211_c();
         if(p_184098_4_ == ClickType.SWAP) {
            if(itemstack2 != null && p_184098_3_ >= 0 && p_184098_3_ < 9) {
               ItemStack itemstack7 = itemstack2.func_77946_l();
               itemstack7.field_77994_a = itemstack7.func_77976_d();
               this.field_146297_k.field_71439_g.field_71071_by.func_70299_a(p_184098_3_, itemstack7);
               this.field_146297_k.field_71439_g.field_71069_bz.func_75142_b();
            }
         ...
         if(p_184098_4_ == ClickType.CLONE) {
            if(inventoryplayer.func_70445_o() == null && p_184098_1_.func_75216_d()) {
               ItemStack itemstack6 = p_184098_1_.func_75211_c().func_77946_l();
         ...
         if(p_184098_4_ == ClickType.THROW) {
            if(itemstack2 != null) {
               ...
               itemstack3.field_77994_a = p_184098_3_ == 0?1:itemstack3.func_77976_d();
         ...
         if(itemstack1 != null && itemstack2 != null && itemstack1.func_77969_a(itemstack2) && ItemStack.func_77970_a(itemstack1, itemstack2)) {
            if(p_184098_3_ == 0) {
               if(flag) {
   ...
   private void func_147053_i() {
      ...
      while(iterator.hasNext()) {
         ...
         for(String s : itemstack.func_82840_a(this.field_146297_k.field_71439_g, this.field_146297_k.field_71474_y.field_82882_x)) {
            if(TextFormatting.func_110646_a(s).toLowerCase().contains(s1)) {
               flag = true;
               break;
            }
         }
   ...
   protected void func_146285_a(ItemStack p_146285_1_, int p_146285_2_, int p_146285_3_) {
      if(field_147058_w == CreativeTabs.field_78027_g.func_78021_a()) {
         ...
         if(creativetabs != null) {
            list.add(1, "" + TextFormatting.BOLD + TextFormatting.BLUE + I18n.func_135052_a(creativetabs.func_78024_c(), new Object[0]));
         }
   ...
   class CreativeSlot extends Slot {
      ...
      public void func_75215_d(@Nullable ItemStack p_75215_1_) {
