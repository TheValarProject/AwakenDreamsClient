...
public class GuiShareToLan extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_146597_g = this.func_189646_b(new GuiButton(104, this.field_146294_l / 2 - 155, 100, 150, 20, I18n.func_135052_a("selectWorld.gameMode", new Object[0])));
      this.field_146596_f = this.func_189646_b(new GuiButton(103, this.field_146294_l / 2 + 5, 100, 150, 20, I18n.func_135052_a("selectWorld.allowCommands", new Object[0])));
      this.func_146595_g();
   }
