...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
   ...
   public void func_180790_a(int p_180790_1_, int p_180790_2_, int p_180790_3_, int p_180790_4_, int p_180790_5_, int p_180790_6_, int p_180790_7_, boolean p_180790_8_) {
         ...
         field_148302_b.submit(new Runnable() {
            public void run() {
               try {
                  ...
                  ServerListEntryNormal.this.field_148301_e.field_78843_d = TextFormatting.DARK_RED + "Can\'t resolve hostname";
               } catch (Exception var3) {
                  ServerListEntryNormal.this.field_148301_e.field_78844_e = -1L;
                  ServerListEntryNormal.this.field_148301_e.field_78843_d = TextFormatting.DARK_RED + "Can\'t connect to server.";
               }
      ...
      boolean flag = this.field_148301_e.field_82821_f > 210;
      ...
      if(this.field_148301_e.func_147409_e() == null) {
         ...
         label101: {
            try {
               ...
               field_148304_a.error("Invalid icon for server {} ({})", new Object[]{this.field_148301_e.field_78847_a, this.field_148301_e.field_78845_b, throwable});
