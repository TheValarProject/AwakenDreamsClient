...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   public void func_146541_h() {
      ...
      GuiButton guibutton = this.func_189646_b(new GuiButton(2, this.field_146294_l / 2 - 80, this.field_146295_m - 52, 80, 20, I18n.func_135052_a("stat.blocksButton", new Object[0])));
      GuiButton guibutton1 = this.func_189646_b(new GuiButton(3, this.field_146294_l / 2, this.field_146295_m - 52, 80, 20, I18n.func_135052_a("stat.itemsButton", new Object[0])));
      GuiButton guibutton2 = this.func_189646_b(new GuiButton(4, this.field_146294_l / 2 + 80, this.field_146295_m - 52, 80, 20, I18n.func_135052_a("stat.mobsButton", new Object[0])));
   ...
   private void func_146521_a(int p_146521_1_, int p_146521_2_, Item p_146521_3_) {
      ...
      this.field_146296_j.func_175042_a(new ItemStack(p_146521_3_), p_146521_1_ + 2, p_146521_2_ + 2);
   ...
   private void func_146527_c(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
      ...
      vertexbuffer.func_181662_b((double)(p_146527_1_ + 0), (double)(p_146527_2_ + 18), (double)this.field_73735_i).func_187315_a((double)((float)(p_146527_3_ + 0) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F)).func_181675_d();
      vertexbuffer.func_181662_b((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 18), (double)this.field_73735_i).func_187315_a((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F)).func_181675_d();
      vertexbuffer.func_181662_b((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 0), (double)this.field_73735_i).func_187315_a((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 0) * 0.0078125F)).func_181675_d();
      vertexbuffer.func_181662_b((double)(p_146527_1_ + 0), (double)(p_146527_2_ + 0), (double)this.field_73735_i).func_187315_a((double)((float)(p_146527_3_ + 0) * 0.0078125F), (double)((float)(p_146527_4_ + 0) * 0.0078125F)).func_181675_d();
   ...
   class StatsBlock extends GuiStats.Stats {
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         ...
         this.func_148209_a(StatList.func_188060_a(item), p_180791_2_ + 115, p_180791_3_, p_180791_1_ % 2 == 0);
         this.func_148209_a(StatList.func_188057_b(item), p_180791_2_ + 165, p_180791_3_, p_180791_1_ % 2 == 0);
         this.func_148209_a(statcrafting, p_180791_2_ + 215, p_180791_3_, p_180791_1_ % 2 == 0);
         this.func_148209_a(StatList.func_188056_d(item), p_180791_2_ + 265, p_180791_3_, p_180791_1_ % 2 == 0);
         this.func_148209_a(StatList.func_188058_e(item), p_180791_2_ + 315, p_180791_3_, p_180791_1_ % 2 == 0);
      }
   ...
   class StatsGeneral extends GuiSlot {
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         StatBase statbase = (StatBase)StatList.field_188094_c.get(p_180791_1_);
   ...
   class StatsItem extends GuiStats.Stats {
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         ...
         Item item = statcrafting.func_150959_a();
         GuiStats.this.func_146521_a(p_180791_2_ + 40, p_180791_3_, item);
         this.func_148209_a(StatList.func_188059_c(item), p_180791_2_ + 115, p_180791_3_, p_180791_1_ % 2 == 0);
         this.func_148209_a(StatList.func_188060_a(item), p_180791_2_ + 165, p_180791_3_, p_180791_1_ % 2 == 0);
         this.func_148209_a(statcrafting, p_180791_2_ + 215, p_180791_3_, p_180791_1_ % 2 == 0);
         this.func_148209_a(StatList.func_188056_d(item), p_180791_2_ + 265, p_180791_3_, p_180791_1_ % 2 == 0);
         this.func_148209_a(StatList.func_188058_e(item), p_180791_2_ + 315, p_180791_3_, p_180791_1_ % 2 == 0);
      }
   ...
   class StatsMobsList extends GuiSlot {
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         ...
         String s = I18n.func_135052_a("entity." + entitylist$entityegginfo.field_75613_a + ".name", new Object[0]);
