...
public class MapItemRenderer {
   ...
   class Instance {
      ...
      private void func_148237_a(boolean p_148237_1_) {
         ...
         vertexbuffer.func_181662_b(0.0D, 128.0D, -0.009999999776482582D).func_187315_a(0.0D, 1.0D).func_181675_d();
         vertexbuffer.func_181662_b(128.0D, 128.0D, -0.009999999776482582D).func_187315_a(1.0D, 1.0D).func_181675_d();
         vertexbuffer.func_181662_b(128.0D, 0.0D, -0.009999999776482582D).func_187315_a(1.0D, 0.0D).func_181675_d();
         vertexbuffer.func_181662_b(0.0D, 0.0D, -0.009999999776482582D).func_187315_a(0.0D, 0.0D).func_181675_d();
         ...
         for(Vec4b vec4b : this.field_148242_b.field_76203_h.values()) {
            if(!p_148237_1_ || vec4b.func_176110_a() == 1) {
               ...
               GlStateManager.func_179109_b(0.0F + (float)vec4b.func_176112_b() / 2.0F + 64.0F, 0.0F + (float)vec4b.func_176113_c() / 2.0F + 64.0F, -0.02F);
               ...
               vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
               float f5 = -0.001F;
               vertexbuffer.func_181662_b(-1.0D, 1.0D, (double)((float)k * -0.001F)).func_187315_a((double)f1, (double)f2).func_181675_d();
               vertexbuffer.func_181662_b(1.0D, 1.0D, (double)((float)k * -0.001F)).func_187315_a((double)f3, (double)f2).func_181675_d();
               vertexbuffer.func_181662_b(1.0D, -1.0D, (double)((float)k * -0.001F)).func_187315_a((double)f3, (double)f4).func_181675_d();
               vertexbuffer.func_181662_b(-1.0D, -1.0D, (double)((float)k * -0.001F)).func_187315_a((double)f1, (double)f4).func_181675_d();
               tessellator.func_78381_a();
