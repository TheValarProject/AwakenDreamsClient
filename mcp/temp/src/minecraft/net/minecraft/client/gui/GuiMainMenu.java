...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
   ...
   private void func_73972_b(int p_73972_1_, int p_73972_2_) {
      ...
      this.field_73973_d = this.func_189646_b(new GuiButton(12, this.field_146294_l / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.func_135052_a("menu.resetdemo", new Object[0])));
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      ...
      if(p_146284_1_.field_146127_k == 12) {
         ...
         WorldInfo worldinfo = isaveformat.func_75803_c("Demo_World");
         if(worldinfo != null) {
            this.field_146297_k.func_147108_a(new GuiYesNo(this, I18n.func_135052_a("selectWorld.deleteQuestion", new Object[0]), "\'" + worldinfo.func_76065_j() + "\' " + I18n.func_135052_a("selectWorld.deleteWarning", new Object[0]), I18n.func_135052_a("selectWorld.deleteButton", new Object[0]), I18n.func_135052_a("gui.cancel", new Object[0]), 12));
         }
      }
   ...
   private void func_73970_b(int p_73970_1_, int p_73970_2_, float p_73970_3_) {
      ...
      for(int j = 0; j < 64; ++j) {
         ...
         for(int k = 0; k < 6; ++k) {
            ...
            int l = 255 / (j + 1);
            float f3 = 0.0F;
            vertexbuffer.func_181662_b(-1.0D, -1.0D, 1.0D).func_187315_a(0.0D, 0.0D).func_181669_b(255, 255, 255, l).func_181675_d();
            vertexbuffer.func_181662_b(1.0D, -1.0D, 1.0D).func_187315_a(1.0D, 0.0D).func_181669_b(255, 255, 255, l).func_181675_d();
            vertexbuffer.func_181662_b(1.0D, 1.0D, 1.0D).func_187315_a(1.0D, 1.0D).func_181669_b(255, 255, 255, l).func_181675_d();
            vertexbuffer.func_181662_b(-1.0D, 1.0D, 1.0D).func_187315_a(0.0D, 1.0D).func_181669_b(255, 255, 255, l).func_181675_d();
   ...
   private void func_73968_a(float p_73968_1_) {
      ...
      for(int j = 0; j < 3; ++j) {
         ...
         vertexbuffer.func_181662_b((double)k, (double)l, (double)this.field_73735_i).func_187315_a((double)(0.0F + f1), 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, f).func_181675_d();
         vertexbuffer.func_181662_b((double)k, 0.0D, (double)this.field_73735_i).func_187315_a((double)(1.0F + f1), 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, f).func_181675_d();
         vertexbuffer.func_181662_b(0.0D, 0.0D, (double)this.field_73735_i).func_187315_a((double)(1.0F + f1), 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, f).func_181675_d();
         vertexbuffer.func_181662_b(0.0D, (double)l, (double)this.field_73735_i).func_187315_a((double)(0.0F + f1), 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, f).func_181675_d();
      }
   ...
   private void func_73971_c(int p_73971_1_, int p_73971_2_, float p_73971_3_) {
      ...
      VertexBuffer vertexbuffer = tessellator.func_178180_c();
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      vertexbuffer.func_181662_b(0.0D, (double)j, (double)this.field_73735_i).func_187315_a((double)(0.5F - f1), (double)(0.5F + f2)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      ...
      vertexbuffer.func_181662_b((double)i, 0.0D, (double)this.field_73735_i).func_187315_a((double)(0.5F + f1), (double)(0.5F - f2)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, (double)this.field_73735_i).func_187315_a((double)(0.5F + f1), (double)(0.5F + f2)).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).func_181675_d();
      tessellator.func_78381_a();
   }
