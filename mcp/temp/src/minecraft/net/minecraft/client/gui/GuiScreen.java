...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
   ...
   protected void func_175272_a(ITextComponent p_175272_1_, int p_175272_2_, int p_175272_3_) {
      if(p_175272_1_ != null && p_175272_1_.func_150256_b().func_150210_i() != null) {
         ...
         if(hoverevent.func_150701_a() == HoverEvent.Action.SHOW_ITEM) {
            ...
            if(statbase != null) {
               ITextComponent itextcomponent = statbase.func_150951_e();
               ITextComponent itextcomponent1 = new TextComponentTranslation("stats.tooltip.type." + (statbase.func_75967_d()?"achievement":"statistic"), new Object[0]);
               itextcomponent1.func_150256_b().func_150217_b(Boolean.valueOf(true));
               String s1 = statbase instanceof Achievement?((Achievement)statbase).func_75989_e():null;
               List<String> list = Lists.newArrayList(new String[]{itextcomponent.func_150254_d(), itextcomponent1.func_150254_d()});
               if(s1 != null) {
               ...
               this.func_146279_a(TextFormatting.RED + "Invalid statistic/achievement!", p_175272_2_, p_175272_3_);
            }
         }
   ...
   protected boolean func_175276_a(ITextComponent p_175276_1_) {
      if(p_175276_1_ == null) {
         return false;
      } else {
         ...
         if(func_146272_n()) {
            ...
            if(clickevent.func_150669_a() == ClickEvent.Action.OPEN_URL) {
               ...
               try {
                  ...
                  field_175287_a.error("Can\'t open url for {}", new Object[]{clickevent, urisyntaxexception});
               }
               ...
               field_175287_a.error("Don\'t know how to handle {}", new Object[]{clickevent});
            }
   ...
   public void func_146278_c(int p_146278_1_) {
      ...
      vertexbuffer.func_181662_b(0.0D, (double)this.field_146295_m, 0.0D).func_187315_a(0.0D, (double)((float)this.field_146295_m / 32.0F + (float)p_146278_1_)).func_181669_b(64, 64, 64, 255).func_181675_d();
      vertexbuffer.func_181662_b((double)this.field_146294_l, (double)this.field_146295_m, 0.0D).func_187315_a((double)((float)this.field_146294_l / 32.0F), (double)((float)this.field_146295_m / 32.0F + (float)p_146278_1_)).func_181669_b(64, 64, 64, 255).func_181675_d();
      vertexbuffer.func_181662_b((double)this.field_146294_l, 0.0D, 0.0D).func_187315_a((double)((float)this.field_146294_l / 32.0F), (double)p_146278_1_).func_181669_b(64, 64, 64, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_187315_a(0.0D, (double)p_146278_1_).func_181669_b(64, 64, 64, 255).func_181675_d();
   ...
   private void func_175282_a(URI p_175282_1_) {
      try {
         ...
         field_175287_a.error("Couldn\'t open link: {}", new Object[]{throwable == null?"<UNKNOWN>":throwable.getMessage()});
      }
