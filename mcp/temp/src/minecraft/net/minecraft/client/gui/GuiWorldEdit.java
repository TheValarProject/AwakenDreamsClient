...
public class GuiWorldEdit extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      GuiButton guibutton = this.func_189646_b(new GuiButton(3, this.field_146294_l / 2 - 100, this.field_146295_m / 4 + 24 + 12, I18n.func_135052_a("selectWorld.edit.resetIcon", new Object[0])));
      this.field_146292_n.add(new GuiButton(4, this.field_146294_l / 2 - 100, this.field_146295_m / 4 + 48 + 12, I18n.func_135052_a("selectWorld.edit.openFolder", new Object[0])));
      this.field_146292_n.add(new GuiButton(0, this.field_146294_l / 2 - 100, this.field_146295_m / 4 + 96 + 12, I18n.func_135052_a("selectWorld.edit.save", new Object[0])));
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      this.func_146276_q_();
      this.func_73732_a(this.field_146289_q, I18n.func_135052_a("selectWorld.edit.title", new Object[0]), this.field_146294_l / 2, 20, 16777215);
