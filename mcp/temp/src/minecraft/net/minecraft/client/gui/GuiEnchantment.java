         ...
         if(this.func_146978_c(60, 14 + 19 * j, 108, 17, p_73863_1_, p_73863_2_) && k > 0 && l >= 0 && enchantment != null) {
            ...
            if(!flag) {
               ...
               if(this.field_146297_k.field_71439_g.field_71068_ca < k) {
                  list.add(TextFormatting.RED + "Level Requirement: " + this.field_147075_G.field_75167_g[j]);
               } else {
                  String s;
                  if(i1 == 1) {
                     s = I18n.func_135052_a("container.enchant.lapis.one", new Object[0]);
                  } else {
                     s = I18n.func_135052_a("container.enchant.lapis.many", new Object[]{Integer.valueOf(i1)});
                  }

                  TextFormatting textformatting = i >= i1?TextFormatting.GRAY:TextFormatting.RED;
                  list.add(textformatting + "" + s);
                  if(i1 == 1) {
                     s = I18n.func_135052_a("container.enchant.level.one", new Object[0]);
                  } else {
                     s = I18n.func_135052_a("container.enchant.level.many", new Object[]{Integer.valueOf(i1)});
                  }
