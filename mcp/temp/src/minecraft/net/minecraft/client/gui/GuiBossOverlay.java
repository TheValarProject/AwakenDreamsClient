...
public class GuiBossOverlay extends Gui {
   ...
   public void func_184055_a(SPacketUpdateBossInfo p_184055_1_) {
      if(p_184055_1_.func_186902_b() == SPacketUpdateBossInfo.Operation.ADD) {
         this.field_184060_g.put(p_184055_1_.func_186908_a(), new BossInfoLerping(p_184055_1_));
         ...
         ((BossInfoLerping)this.field_184060_g.get(p_184055_1_.func_186908_a())).func_186765_a(p_184055_1_);
      }
