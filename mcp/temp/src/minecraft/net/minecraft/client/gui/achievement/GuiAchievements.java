...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
   ...
   public GuiAchievements(GuiScreen p_i45026_1_, StatisticsManager p_i45026_2_) {
      ...
      int i = 141;
      int j = 141;
      this.field_146565_w = (double)(AchievementList.field_187982_f.field_75993_a * 24 - 70 - 12);
      this.field_146569_s = this.field_146565_w;
      this.field_146567_u = this.field_146565_w;
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      if(this.field_146558_F) {
         ...
         if(Mouse.isButtonDown(0)) {
            ...
            if((this.field_146554_D == 0 || this.field_146554_D == 1) && p_73863_1_ >= k && p_73863_1_ < k + 224 && p_73863_2_ >= l && p_73863_2_ < l + 155) {
               if(this.field_146554_D == 0) {
                  ...
                  this.field_146565_w = this.field_146567_u;
                  this.field_146573_x = this.field_146566_v;
               }
         ...
         if(this.field_146570_r != f2) {
            float f3 = f2 * (float)this.field_146555_f;
            float f4 = f2 * (float)this.field_146557_g;
            float f = this.field_146570_r * (float)this.field_146555_f;
            float f1 = this.field_146570_r * (float)this.field_146557_g;
            this.field_146567_u -= (double)((f - f3) * 0.5F);
            this.field_146566_v -= (double)((f1 - f4) * 0.5F);
            this.field_146569_s = this.field_146567_u;
            this.field_146568_t = this.field_146566_v;
            this.field_146565_w = this.field_146567_u;
            this.field_146573_x = this.field_146566_v;
   ...
   protected void func_146552_b(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
      ...
      if(achievement != null) {
         ...
         if(this.field_146556_E.func_77442_b(achievement)) {
            ...
            String s2 = (new TextComponentTranslation("achievement.requires", new Object[]{achievement.field_75992_c.func_150951_e()})).func_150260_c();
            ...
            String s3 = (new TextComponentTranslation("achievement.requires", new Object[]{achievement.field_75992_c.func_150951_e()})).func_150260_c();
