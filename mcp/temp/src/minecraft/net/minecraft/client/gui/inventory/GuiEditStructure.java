...
public class GuiEditStructure extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_189829_E = this.func_189646_b(new GuiButton(0, this.field_146294_l / 2 - 4 - 150, 210, 150, 20, I18n.func_135052_a("gui.done", new Object[0])));
      this.field_189830_F = this.func_189646_b(new GuiButton(1, this.field_146294_l / 2 + 4, 210, 150, 20, I18n.func_135052_a("gui.cancel", new Object[0])));
      this.field_189831_G = this.func_189646_b(new GuiButton(9, this.field_146294_l / 2 + 4 + 100, 185, 50, 20, I18n.func_135052_a("structure_block.button.save", new Object[0])));
      this.field_189832_H = this.func_189646_b(new GuiButton(10, this.field_146294_l / 2 + 4 + 100, 185, 50, 20, I18n.func_135052_a("structure_block.button.load", new Object[0])));
      this.field_189837_M = this.func_189646_b(new GuiButton(18, this.field_146294_l / 2 - 4 - 150, 185, 50, 20, "MODE"));
      this.field_189838_N = this.func_189646_b(new GuiButton(19, this.field_146294_l / 2 + 4 + 100, 120, 50, 20, I18n.func_135052_a("structure_block.button.detect_size", new Object[0])));
   ...
   protected void func_73869_a(char p_73869_1_, int p_73869_2_) throws IOException {
      if(this.field_189853_u.func_146176_q() && func_189818_a(p_73869_1_)) {
   ...
   private static boolean func_189818_a(char p_189818_0_) {
      boolean flag = true;
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      this.func_73732_a(this.field_146289_q, I18n.func_135052_a("tile.structureBlock.name", new Object[0]), this.field_146294_l / 2, 10, 16777215);
      if(tileentitystructure$mode != TileEntityStructure.Mode.DATA) {
         this.func_73731_b(this.field_146289_q, I18n.func_135052_a("structure_block.structure_name", new Object[0]), this.field_146294_l / 2 - 153, 30, 10526880);
      ...
      if(tileentitystructure$mode == TileEntityStructure.Mode.LOAD || tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
         this.func_73731_b(this.field_146289_q, I18n.func_135052_a("structure_block.position", new Object[0]), this.field_146294_l / 2 - 153, 70, 10526880);
         this.field_189854_v.func_146194_f();
         this.field_189855_w.func_146194_f();
         this.field_189856_x.func_146194_f();
         String s = I18n.func_135052_a("structure_block.include_entities", new Object[0]);
      ...
      if(tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
         this.func_73731_b(this.field_146289_q, I18n.func_135052_a("structure_block.size", new Object[0]), this.field_146294_l / 2 - 153, 110, 10526880);
         this.field_189857_y.func_146194_f();
         this.field_189858_z.func_146194_f();
         this.field_189825_A.func_146194_f();
         String s2 = I18n.func_135052_a("structure_block.detect_size", new Object[0]);
         ...
         String s1 = I18n.func_135052_a("structure_block.show_air", new Object[0]);
      ...
      if(tileentitystructure$mode == TileEntityStructure.Mode.LOAD) {
         this.func_73731_b(this.field_146289_q, I18n.func_135052_a("structure_block.integrity", new Object[0]), this.field_146294_l / 2 - 153, 110, 10526880);
         this.field_189826_B.func_146194_f();
         this.field_189827_C.func_146194_f();
         String s3 = I18n.func_135052_a("structure_block.show_boundingbox", new Object[0]);
      ...
      if(tileentitystructure$mode == TileEntityStructure.Mode.DATA) {
         this.func_73731_b(this.field_146289_q, I18n.func_135052_a("structure_block.custom_data", new Object[0]), this.field_146294_l / 2 - 153, 110, 10526880);
         this.field_189828_D.func_146194_f();
      }

      String s4 = "structure_block.mode_info." + tileentitystructure$mode.func_176610_l();
      this.func_73731_b(this.field_146289_q, I18n.func_135052_a(s4, new Object[0]), this.field_146294_l / 2 - 153, 174, 10526880);
