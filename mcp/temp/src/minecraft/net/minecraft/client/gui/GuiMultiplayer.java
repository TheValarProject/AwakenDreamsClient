...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
   ...
   public void func_73866_w_() {
      ...
      if(this.field_146801_C) {
         ...
         try {
            ...
            field_146802_a.warn("Unable to start LAN server detection: {}", new Object[]{exception.getMessage()});
         }
   ...
   public void func_146794_g() {
      this.field_146810_r = this.func_189646_b(new GuiButton(7, this.field_146294_l / 2 - 154, this.field_146295_m - 28, 70, 20, I18n.func_135052_a("selectServer.edit", new Object[0])));
      this.field_146808_t = this.func_189646_b(new GuiButton(2, this.field_146294_l / 2 - 74, this.field_146295_m - 28, 70, 20, I18n.func_135052_a("selectServer.delete", new Object[0])));
      this.field_146809_s = this.func_189646_b(new GuiButton(1, this.field_146294_l / 2 - 154, this.field_146295_m - 52, 100, 20, I18n.func_135052_a("selectServer.select", new Object[0])));
      ...
      if(p_146284_1_.field_146124_l) {
         ...
         if(p_146284_1_.field_146127_k == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
            ...
            if(s4 != null) {
               ...
               String s = I18n.func_135052_a("selectServer.deleteQuestion", new Object[0]);
               String s1 = "\'" + s4 + "\' " + I18n.func_135052_a("selectServer.deleteWarning", new Object[0]);
               String s2 = I18n.func_135052_a("selectServer.deleteButton", new Object[0]);
