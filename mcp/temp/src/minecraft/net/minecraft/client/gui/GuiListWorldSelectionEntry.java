...
public class GuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry {
   ...
   public void func_180790_a(int p_180790_1_, int p_180790_2_, int p_180790_3_, int p_180790_4_, int p_180790_5_, int p_180790_6_, int p_180790_7_, boolean p_180790_8_) {
      ...
      if(StringUtils.isEmpty(s)) {
         s = I18n.func_135052_a("selectWorld.world", new Object[0]) + " " + (p_180790_1_ + 1);
      }

      if(this.field_186786_g.func_75785_d()) {
         s2 = I18n.func_135052_a("selectWorld.conversion", new Object[0]) + " " + s2;
      } else {
         s2 = I18n.func_135052_a("gameMode." + this.field_186786_g.func_75790_f().func_77149_b(), new Object[0]);
         if(this.field_186786_g.func_75789_g()) {
            s2 = TextFormatting.DARK_RED + I18n.func_135052_a("gameMode.hardcore", new Object[0]) + TextFormatting.RESET;
         }
         ...
         if(this.field_186786_g.func_186355_l()) {
            if(this.field_186786_g.func_186356_m()) {
               s2 = s2 + ", " + I18n.func_135052_a("selectWorld.version", new Object[0]) + " " + TextFormatting.RED + s3 + TextFormatting.RESET;
            } else {
               s2 = s2 + ", " + I18n.func_135052_a("selectWorld.version", new Object[0]) + " " + TextFormatting.ITALIC + s3 + TextFormatting.RESET;
            }
         } else {
            s2 = s2 + ", " + I18n.func_135052_a("selectWorld.version", new Object[0]) + " " + s3;
         }
      }

      this.field_186784_e.field_71466_p.func_78276_b(s, p_180790_2_ + 32 + 3, p_180790_3_ + 1, 16777215);
      this.field_186784_e.field_71466_p.func_78276_b(s1, p_180790_2_ + 32 + 3, p_180790_3_ + this.field_186784_e.field_71466_p.field_78288_b + 3, 8421504);
      this.field_186784_e.field_71466_p.func_78276_b(s2, p_180790_2_ + 32 + 3, p_180790_3_ + this.field_186784_e.field_71466_p.field_78288_b + this.field_186784_e.field_71466_p.field_78288_b + 3, 8421504);
      ...
      if(this.field_186784_e.field_71474_y.field_85185_A || p_180790_8_) {
         ...
         int i = j < 32?32:0;
         if(this.field_186786_g.func_186355_l()) {
            Gui.func_146110_a(p_180790_2_, p_180790_3_, 32.0F, (float)i, 32, 32, 256.0F, 256.0F);
            if(this.field_186786_g.func_186356_m()) {
               Gui.func_146110_a(p_180790_2_, p_180790_3_, 96.0F, (float)i, 32, 32, 256.0F, 256.0F);
               if(j < 32) {
               ...
               Gui.func_146110_a(p_180790_2_, p_180790_3_, 64.0F, (float)i, 32, 32, 256.0F, 256.0F);
               if(j < 32) {
            ...
            Gui.func_146110_a(p_180790_2_, p_180790_3_, 0.0F, (float)i, 32, 32, 256.0F, 256.0F);
         }
      }
   ...
   public void func_186774_a() {
      if(this.field_186786_g.func_186356_m()) {
         ...
         }, I18n.func_135052_a("selectWorld.versionQuestion", new Object[0]), I18n.func_135052_a("selectWorld.versionWarning", new Object[]{this.field_186786_g.func_186357_i()}), I18n.func_135052_a("selectWorld.versionJoinButton", new Object[0]), I18n.func_135052_a("gui.cancel", new Object[0]), 0));
      } else {
         this.func_186777_e();
      }
   ...
   private void func_186769_f() {
      ...
      if(flag) {
         ...
         try {
            ...
            field_186780_a.error("Invalid icon for world {}", new Object[]{this.field_186786_g.func_75786_a(), throwable});
            this.field_186789_j = null;
            return;
         }
