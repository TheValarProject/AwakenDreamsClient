...
public class GuiCommandBlock extends GuiScreen implements ITabCompleter {
   ...
   public void func_73866_w_() {
      ...
      this.field_146490_i = this.func_189646_b(new GuiButton(0, this.field_146294_l / 2 - 4 - 150, this.field_146295_m / 4 + 120 + 12, 150, 20, I18n.func_135052_a("gui.done", new Object[0])));
      this.field_146487_r = this.func_189646_b(new GuiButton(1, this.field_146294_l / 2 + 4, this.field_146295_m / 4 + 120 + 12, 150, 20, I18n.func_135052_a("gui.cancel", new Object[0])));
      this.field_175390_s = this.func_189646_b(new GuiButton(4, this.field_146294_l / 2 + 150 - 20, 135, 20, 20, "O"));
      this.field_184079_s = this.func_189646_b(new GuiButton(5, this.field_146294_l / 2 - 50 - 100 - 4, 165, 100, 20, I18n.func_135052_a("advMode.mode.sequence", new Object[0])));
      this.field_184080_t = this.func_189646_b(new GuiButton(6, this.field_146294_l / 2 - 50, 165, 100, 20, I18n.func_135052_a("advMode.mode.unconditional", new Object[0])));
      this.field_184081_u = this.func_189646_b(new GuiButton(7, this.field_146294_l / 2 + 50 + 4, 165, 100, 20, I18n.func_135052_a("advMode.mode.redstoneTriggered", new Object[0])));
