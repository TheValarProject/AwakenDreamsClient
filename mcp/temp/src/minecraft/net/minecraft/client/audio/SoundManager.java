   ...
   public void func_148596_a() {
      ...
      for(SoundEvent soundevent : SoundEvent.field_187505_a) {
         ...
         if(this.field_148622_c.func_184398_a(resourcelocation) == null) {
            field_148621_b.warn("Missing sound for event: {}", new Object[]{SoundEvent.field_187505_a.func_177774_c(soundevent)});
                  ...
                  SoundSystemConfig.setLogger(new SoundSystemLogger() {
                     ...
                     public void errorMessage(String p_errorMessage_1_, String p_errorMessage_2_, int p_errorMessage_3_) {
                        if(!p_errorMessage_2_.isEmpty()) {
                           SoundManager.field_148621_b.error("Error in class \'{}\'", new Object[]{p_errorMessage_1_});
      ...
      if(this.field_148617_f) {
         ...
         if(soundeventaccessor == null) {
            if(field_188775_c.add(resourcelocation)) {
               field_148621_b.warn(field_148623_a, "Unable to play unknown soundEvent: {}", new Object[]{resourcelocation});
            }
            ...
            if(this.field_148620_e.getMasterVolume() <= 0.0F) {
               field_148621_b.debug(field_148623_a, "Skipped playing soundEvent: {}, master volume was zero", new Object[]{resourcelocation});
            } else {
               Sound sound = p_148611_1_.func_184364_b();
               if(sound == SoundHandler.field_147700_a) {
                  if(field_188775_c.add(resourcelocation)) {
                     field_148621_b.warn(field_148623_a, "Unable to play empty soundEvent: {}", new Object[]{resourcelocation});
                  }
                  ...
                  if(f1 == 0.0F) {
                     field_148621_b.debug(field_148623_a, "Skipped playing sound {}, volume was zero.", new Object[]{sound.func_188719_a()});
                  } else {
      ...
      if(p_189567_2_ != null) {
         for(String s : this.field_188776_k.get(p_189567_2_)) {
            ...
            if(!p_189567_1_.isEmpty()) {
               if(isound.func_147650_b().equals(new ResourceLocation(p_189567_1_))) {
                  this.func_148602_b(isound);
               }
            } else {
               this.func_148602_b(isound);
