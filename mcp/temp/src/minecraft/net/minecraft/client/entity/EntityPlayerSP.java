   ...
   public void func_70071_h_() {
      if(this.field_70170_p.func_175667_e(new BlockPos(this.field_70165_t, 0.0D, this.field_70161_v))) {
         ...
         if(this.func_184218_aH()) {
            ...
            this.field_71174_a.func_147297_a(new CPacketInput(this.field_70702_br, this.field_70701_bs, this.field_71158_b.field_78901_c, this.field_71158_b.field_78899_d));
   ...
   public void func_70636_d() {
      ...
      if(this.field_71075_bZ.field_75100_b && this.func_175160_A()) {
         if(this.field_71158_b.field_78899_d) {
            ...
            this.field_71158_b.field_78900_b = (float)((double)this.field_71158_b.field_78900_b / 0.3D);
