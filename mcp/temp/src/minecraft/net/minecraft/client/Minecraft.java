...
public class Minecraft implements IThreadListener, ISnooperInfo {
   ...
   private void func_71384_a() throws LWJGLException, IOException {
      ...
      field_147123_G.info("LWJGL Version: {}", new Object[]{Sys.getVersion()});
      this.func_175594_ao();
      this.func_175605_an();
      this.func_175609_am();
      ...
      AchievementList.field_187982_f.func_75988_a(new IStatStringFormat() {
   ...
   public void func_110436_a() {
      ...
      if(this.field_71437_Z != null) {
         this.field_71437_Z.func_184116_b();
      }
   ...
   private void func_180510_a(TextureManager p_180510_1_) throws LWJGLException {
      ...
      try {
         ...
         field_147123_G.error("Unable to load logo: {}", new Object[]{field_110444_H, ioexception});
      } finally {
         IOUtils.closeQuietly(inputstream);
      }
      ...
      vertexbuffer.func_181662_b(0.0D, (double)this.field_71440_d, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
      vertexbuffer.func_181662_b((double)this.field_71443_c, (double)this.field_71440_d, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
      vertexbuffer.func_181662_b((double)this.field_71443_c, 0.0D, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(255, 255, 255, 255).func_181675_d();
   ...
   public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_) {
      ...
      vertexbuffer.func_181662_b((double)p_181536_1_, (double)(p_181536_2_ + p_181536_6_), 0.0D).func_187315_a((double)((float)p_181536_3_ * 0.00390625F), (double)((float)(p_181536_4_ + p_181536_6_) * 0.00390625F)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
      vertexbuffer.func_181662_b((double)(p_181536_1_ + p_181536_5_), (double)(p_181536_2_ + p_181536_6_), 0.0D).func_187315_a((double)((float)(p_181536_3_ + p_181536_5_) * 0.00390625F), (double)((float)(p_181536_4_ + p_181536_6_) * 0.00390625F)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
      vertexbuffer.func_181662_b((double)(p_181536_1_ + p_181536_5_), (double)p_181536_2_, 0.0D).func_187315_a((double)((float)(p_181536_3_ + p_181536_5_) * 0.00390625F), (double)((float)p_181536_4_ * 0.00390625F)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
      vertexbuffer.func_181662_b((double)p_181536_1_, (double)p_181536_2_, 0.0D).func_187315_a((double)((float)p_181536_3_ * 0.00390625F), (double)((float)p_181536_4_ * 0.00390625F)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
   ...
   private void func_71361_d(String p_71361_1_) {
      ...
      if(i != 0) {
         ...
         field_147123_G.error("@ {}", new Object[]{p_71361_1_});
         field_147123_G.error("{}: {}", new Object[]{Integer.valueOf(i), s});
      }
   ...
   private void func_71366_a(long p_71366_1_) {
      if(this.field_71424_I.field_76327_a) {
         ...
         vertexbuffer.func_181662_b((double)((float)j - 176.0F), (double)((float)k - 96.0F - 16.0F), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)((float)j - 176.0F), (double)(k + 320), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)((float)j + 176.0F), (double)(k + 320), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)((float)j + 176.0F), (double)((float)k - 96.0F - 16.0F), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         tessellator.func_78381_a();
         ...
         for(int l = 0; l < list.size(); ++l) {
            ...
            int l1 = j1 >> 8 & 255;
            int i2 = j1 & 255;
            vertexbuffer.func_181662_b((double)j, (double)k, 0.0D).func_181669_b(k1, l1, i2, 255).func_181675_d();
            ...
            for(int j2 = i1; j2 >= 0; --j2) {
               ...
               vertexbuffer.func_181662_b((double)((float)j + f1), (double)((float)k - f2), 0.0D).func_181669_b(k1, l1, i2, 255).func_181675_d();
            }
            ...
            for(int i3 = i1; i3 >= 0; --i3) {
               ...
               vertexbuffer.func_181662_b((double)((float)j + f4), (double)((float)k - f5), 0.0D).func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255).func_181675_d();
               vertexbuffer.func_181662_b((double)((float)j + f4), (double)((float)k - f5 + 10.0F), 0.0D).func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255).func_181675_d();
            }
            ...
            for(EnumHand enumhand : EnumHand.values()) {
               ...
               if(this.field_71476_x == null) {
                  ...
                  case ENTITY:
                     ...
                     if(this.field_71442_b.func_187097_a(this.field_71439_g, this.field_71476_x.field_72308_g, this.field_71439_g.func_184586_b(enumhand), enumhand) == EnumActionResult.SUCCESS) {
                        return;
                     }
                     break;
                  case BLOCK:
                     ...
                     if(this.field_71441_e.func_180495_p(blockpos).func_185904_a() != Material.field_151579_a) {
                        ...
                        EnumActionResult enumactionresult = this.field_71442_b.func_187099_a(this.field_71439_g, this.field_71441_e, itemstack, blockpos, this.field_71476_x.field_178784_b, this.field_71476_x.field_72307_f, enumhand);
                        if(enumactionresult == EnumActionResult.SUCCESS) {
                           this.field_71439_g.func_184609_a(enumhand);
                           if(itemstack != null) {
                              if(itemstack.field_77994_a == 0) {
                                 this.field_71439_g.func_184611_a(enumhand, (ItemStack)null);
   ...
   private boolean func_184122_c(int p_184122_1_) {
      if(p_184122_1_ == 30) {
         this.field_71438_f.func_72712_a();
         this.func_184120_a("Reloading all chunks", new Object[0]);
         return true;
      } else if(p_184122_1_ == 48) {
         boolean flag1 = !this.field_175616_W.func_178634_b();
         this.field_175616_W.func_178629_b(flag1);
         this.func_184120_a("Hitboxes: {0}", new Object[]{flag1?"shown":"hidden"});
         return true;
         ...
         this.func_184120_a("RenderDistance: {0}", new Object[]{Integer.valueOf(this.field_71474_y.field_151451_c)});
         return true;
      } else if(p_184122_1_ == 34) {
         boolean flag = this.field_184132_p.func_190075_b();
         this.func_184120_a("Chunk borders: {0}", new Object[]{flag?"shown":"hidden"});
         return true;
      } else if(p_184122_1_ == 35) {
         this.field_71474_y.field_82882_x = !this.field_71474_y.field_82882_x;
         this.func_184120_a("Advanced tooltips: {0}", new Object[]{this.field_71474_y.field_82882_x?"shown":"hidden"});
         this.field_71474_y.func_74303_b();
         return true;
      } else if(p_184122_1_ == 49) {
         if(!this.field_71439_g.func_70003_b(2, "")) {
            this.func_184120_a("Unable to switch gamemode, no permission", new Object[0]);
         ...
         this.field_71474_y.func_74303_b();
         this.func_184120_a("PauseOnLostFocus: {0}", new Object[]{this.field_71474_y.field_82881_y?"enabled":"disabled"});
         return true;
      } else if(p_184122_1_ == 16) {
         this.func_184120_a("Keybindings:", new Object[0]);
         GuiNewChat guinewchat = this.field_71456_v.func_146158_b();
         guinewchat.func_146227_a(new TextComponentString("F3 + A = Reload chunks"));
         guinewchat.func_146227_a(new TextComponentString("F3 + B = Show hitboxes"));
         guinewchat.func_146227_a(new TextComponentString("F3 + D = Clear chat"));
         guinewchat.func_146227_a(new TextComponentString("F3 + F = Cycle renderdistance (Shift to inverse)"));
         guinewchat.func_146227_a(new TextComponentString("F3 + G = Show chunk boundaries"));
         guinewchat.func_146227_a(new TextComponentString("F3 + H = Advanced tooltips"));
         guinewchat.func_146227_a(new TextComponentString("F3 + N = Cycle creative <-> spectator"));
         guinewchat.func_146227_a(new TextComponentString("F3 + P = Pause on lost focus"));
         guinewchat.func_146227_a(new TextComponentString("F3 + Q = Show this list"));
         guinewchat.func_146227_a(new TextComponentString("F3 + T = Reload resourcepacks"));
         return true;
      } else if(p_184122_1_ == 20) {
         this.func_110436_a();
         this.func_184120_a("Reloaded resourcepacks", new Object[0]);
         return true;
      } else {
         return false;
      }
   ...
   private void func_184117_aA() {
      ...
      while(this.field_71474_y.field_151445_Q.func_151468_f()) {
         this.func_147114_u().func_147297_a(new CPacketClientStatus(CPacketClientStatus.State.OPEN_INVENTORY_ACHIEVEMENT));
   ...
   private void func_184120_a(String p_184120_1_, Object... p_184120_2_) {
      this.field_71456_v.func_146158_b().func_146227_a((new TextComponentString("")).func_150257_a((new TextComponentString("[Debug]: ")).func_150255_a((new Style()).func_150238_a(TextFormatting.YELLOW).func_150227_a(Boolean.valueOf(true)))).func_150258_a(MessageFormat.format(p_184120_1_, p_184120_2_)));
   }
   ...
   public void func_71353_a(@Nullable WorldClient p_71353_1_, String p_71353_2_) {
      ...
      if(p_71353_1_ != null) {
         ...
         if(this.field_71439_g == null) {
            this.field_71439_g = this.field_71442_b.func_178892_a(p_71353_1_, new StatisticsManager());
   ...
   public void func_71354_a(int p_71354_1_) {
      ...
      this.field_71439_g = this.field_71442_b.func_178892_a(this.field_71441_e, this.field_71439_g == null?new StatisticsManager():this.field_71439_g.func_146107_m());
   ...
   public static int func_71369_N() {
      for(int i = 16384; i > 0; i >>= 1) {
         GlStateManager.func_187419_a('\u8064', 0, 6408, i, i, 0, 6408, 5121, (IntBuffer)null);
         int j = GlStateManager.func_187411_c('\u8064', 0, 4096);
         if(j != 0) {
            return i;
         }
      }
   ...
   public float func_184121_ak() {
      return this.field_71428_T.field_74281_c;
   }
