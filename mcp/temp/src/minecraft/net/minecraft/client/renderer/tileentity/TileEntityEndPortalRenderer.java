...
public class TileEntityEndPortalRenderer extends TileEntitySpecialRenderer<TileEntityEndPortal> {
   ...
   public void func_180535_a(TileEntityEndPortal p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_, float p_180535_8_, int p_180535_9_) {
      ...
      for(int i = 0; i < 16; ++i) {
         ...
         float f7 = (float)(-(p_180535_4_ + 0.75D));
         ...
         float f10 = f8 / f9;
         f10 = (float)(p_180535_4_ + 0.75D) + f10;
         ...
         vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_ + 0.75D, p_180535_6_).func_181666_a(f11, f12, f13, 1.0F).func_181675_d();
         vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_ + 0.75D, p_180535_6_ + 1.0D).func_181666_a(f11, f12, f13, 1.0F).func_181675_d();
         vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_ + 0.75D, p_180535_6_ + 1.0D).func_181666_a(f11, f12, f13, 1.0F).func_181675_d();
         vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_ + 0.75D, p_180535_6_).func_181666_a(f11, f12, f13, 1.0F).func_181675_d();
