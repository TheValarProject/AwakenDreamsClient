...
public abstract class TileEntitySpecialRenderer<T extends TileEntity> {
   ...
   public void func_180535_a(T p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_, float p_180535_8_, int p_180535_9_) {
      ITextComponent itextcomponent = p_180535_1_.func_145748_c_();
      if(itextcomponent != null && this.field_147501_a.field_190057_j != null && p_180535_1_.func_174877_v().equals(this.field_147501_a.field_190057_j.func_178782_a())) {
         this.func_190053_a(true);
         this.func_190052_a(p_180535_1_, itextcomponent.func_150254_d(), p_180535_2_, p_180535_4_, p_180535_6_, 12);
