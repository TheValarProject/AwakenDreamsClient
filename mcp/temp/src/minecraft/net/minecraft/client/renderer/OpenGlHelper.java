...
public class OpenGlHelper {
   ...
   public static void func_188785_m(int p_188785_0_) {
      ...
      vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
      vertexbuffer.func_181662_b((double)p_188785_0_, 0.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, (double)p_188785_0_, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, (double)p_188785_0_).func_181669_b(0, 0, 0, 255).func_181675_d();
      tessellator.func_78381_a();
      GL11.glLineWidth(2.0F);
      vertexbuffer.func_181668_a(1, DefaultVertexFormats.field_181706_f);
      vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_181669_b(255, 0, 0, 255).func_181675_d();
      vertexbuffer.func_181662_b((double)p_188785_0_, 0.0D, 0.0D).func_181669_b(255, 0, 0, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_181669_b(0, 255, 0, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, (double)p_188785_0_, 0.0D).func_181669_b(0, 255, 0, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_181669_b(127, 127, 255, 255).func_181675_d();
      vertexbuffer.func_181662_b(0.0D, 0.0D, (double)p_188785_0_).func_181669_b(127, 127, 255, 255).func_181675_d();
      tessellator.func_78381_a();
   ...
   public static void func_188786_a(File p_188786_0_) {
      ...
      if(Util.func_110647_a() == Util.EnumOS.OSX) {
         try {
            ...
            field_188787_T.error((String)"Couldn\'t open file", (Throwable)ioexception1);
         }
         ...
         try {
            ...
            field_188787_T.error((String)"Couldn\'t open file", (Throwable)ioexception);
         }
      }
