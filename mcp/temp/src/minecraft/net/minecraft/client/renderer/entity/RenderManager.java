...
public class RenderManager {
   ...
   public RenderManager(TextureManager p_i46180_1_, RenderItem p_i46180_2_) {
      ...
      this.field_78729_o.put(EntityShulker.class, new RenderShulker(this, new ModelShulker()));
      this.field_78729_o.put(EntityPolarBear.class, new RenderPolarBear(this, new ModelPolarBear(), 0.7F));
   ...
   public void func_188388_a(Entity p_188388_1_, float p_188388_2_, boolean p_188388_3_) {
      ...
      int i = p_188388_1_.func_70070_b(p_188388_2_);
   ...
   public void func_188389_a(Entity p_188389_1_, float p_188389_2_) {
      ...
      int i = p_188389_1_.func_70070_b(p_188389_2_);
   ...
   private void func_85094_b(Entity p_85094_1_, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_) {
      ...
      vertexbuffer.func_181662_b(p_85094_2_, p_85094_4_ + (double)p_85094_1_.func_70047_e(), p_85094_6_).func_181669_b(0, 0, 255, 255).func_181675_d();
      vertexbuffer.func_181662_b(p_85094_2_ + vec3d.field_72450_a * 2.0D, p_85094_4_ + (double)p_85094_1_.func_70047_e() + vec3d.field_72448_b * 2.0D, p_85094_6_ + vec3d.field_72449_c * 2.0D).func_181669_b(0, 0, 255, 255).func_181675_d();
