   ...
   public static class Deserializer implements JsonDeserializer<Selector> {
      ...
      static ICondition func_188158_a(JsonObject p_188158_0_) {
         ...
         if(set.isEmpty()) {
            ...
            return (ICondition)(set.size() == 1?(p_188158_0_.has("OR")?new ConditionOr(Iterables.transform(JsonUtils.func_151214_t(p_188158_0_, "OR"), field_188163_a)):(p_188158_0_.has("AND")?new ConditionAnd(Iterables.transform(JsonUtils.func_151214_t(p_188158_0_, "AND"), field_188163_a)):func_188161_b((Entry)set.iterator().next()))):new ConditionAnd(Iterables.transform(set, field_188164_b)));
         }
      }
