...
public class ModelBakery {
   ...
   private final RegistrySimple<ModelResourceLocation, IBakedModel> field_177605_n = new RegistrySimple();
   ...
   private void func_177577_b() {
      this.field_177612_i.put(field_177604_a, new VariantList(Lists.newArrayList(new Variant[]{new Variant(new ResourceLocation(field_177604_a.func_110623_a()), ModelRotation.X0_Y0, false, 1)})));
   ...
   private ModelBlockDefinition func_188636_a(ResourceLocation p_188636_1_, IResource p_188636_2_) {
      ...
      try {
         ...
         lvt_4_1_ = ModelBlockDefinition.func_178331_a(new InputStreamReader(inputstream, Charsets.UTF_8));
      } catch (Exception exception) {
      ...
      for(Variant variant : p_188638_2_.func_188114_a()) {
         ...
         if(this.field_177611_h.get(resourcelocation) == null) {
            try {
               ...
               field_177603_c.warn("Unable to load block model: \'{}\' for variant: \'{}\': {} ", new Object[]{resourcelocation, p_188638_1_, exception});
            }
         }
      }
   ...
   private void func_177590_d() {
      ...
      for(Item item : Item.field_150901_e) {
         for(String s : this.func_177596_a(item)) {
            ...
            ResourceLocation resourcelocation1 = (ResourceLocation)Item.field_150901_e.func_177774_c(item);
   ...
   private void func_188634_a(String p_188634_1_, ResourceLocation p_188634_2_, ResourceLocation p_188634_3_) {
      ...
      if(this.field_177611_h.get(p_188634_2_) == null) {
         try {
            ...
            field_177603_c.warn("Unable to load item model: \'{}\' for item: \'{}\'", new Object[]{p_188634_2_, p_188634_3_, exception});
         }
   ...
   private void func_177592_e() {
      ...
      this.field_177613_u.put(Items.field_151068_bn, Lists.newArrayList(new String[]{"bottle_drinkable"}));
      this.field_177613_u.put(Items.field_151144_bL, Lists.newArrayList(new String[]{"skull_skeleton", "skull_wither", "skull_zombie", "skull_char", "skull_creeper", "skull_dragon"}));
      this.field_177613_u.put(Items.field_185155_bH, Lists.newArrayList(new String[]{"bottle_splash"}));
      this.field_177613_u.put(Items.field_185156_bI, Lists.newArrayList(new String[]{"bottle_lingering"}));
         ...
         for(Variant variant : p_188639_1_.func_188114_a()) {
            ...
            if(modelblock != null && modelblock.func_178303_d()) {
               if(modelblock.func_178298_a().isEmpty()) {
                  field_177603_c.warn("Missing elements for: {}", new Object[]{p_188639_2_});
               } else {
               ...
               field_177603_c.warn("Missing model for: {}", new Object[]{p_188639_2_});
            }
         }

         IBakedModel ibakedmodel1 = null;
         if(i == 0) {
            field_177603_c.warn("No weighted models for: {}", new Object[]{p_188639_2_});
         } else if(i == 1) {
   ...
   private void func_188635_i() {
      for(Entry<String, ResourceLocation> entry : this.field_177615_s.entrySet()) {
         ...
         if(modelblock != null && modelblock.func_178303_d()) {
            if(modelblock.func_178298_a().isEmpty()) {
               field_177603_c.warn("Missing elements for: {}", new Object[]{resourcelocation});
            ...
            field_177603_c.warn("Missing model for: {}", new Object[]{resourcelocation});
         }
      }
   ...
   private Set<ResourceLocation> func_177575_g() {
      ...
      for(ModelResourceLocation modelresourcelocation : list) {
         ...
         for(Variant variant : variantlist.func_188114_a()) {
            ModelBlock modelblock = (ModelBlock)this.field_177611_h.get(variant.func_188046_a());
            if(modelblock == null) {
               field_177603_c.warn("Missing model for: {}", new Object[]{modelresourcelocation});
            } else {
      ...
      for(ModelBlockDefinition modelblockdefinition : this.field_188642_k.keySet()) {
         for(VariantList variantlist1 : modelblockdefinition.func_188001_c().func_188137_b()) {
            for(Variant variant1 : variantlist1.func_188114_a()) {
               ...
               if(modelblock1 == null) {
                  field_177603_c.warn("Missing model for: {}", new Object[]{Block.field_149771_c.func_177774_c(modelblockdefinition.func_188001_c().func_188135_c().func_177622_c())});
               } else {
   ...
   private void func_177574_i() {
      ...
      while(!((Deque)deque).isEmpty()) {
         ...
         try {
            ...
            field_177603_c.warn("In parent chain: {}; unable to load model: \'{}\'", new Object[]{field_177601_e.join(this.func_177573_e(resourcelocation1)), resourcelocation1, exception});
         }
