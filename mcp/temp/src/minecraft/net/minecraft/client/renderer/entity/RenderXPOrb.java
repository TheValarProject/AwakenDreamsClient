...
public class RenderXPOrb extends Render<EntityXPOrb> {
   ...
   public void func_76986_a(EntityXPOrb p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      if(!this.field_188301_f) {
         ...
         vertexbuffer.func_181662_b(-0.5D, -0.25D, 0.0D).func_187315_a((double)f, (double)f3).func_181669_b(l, 255, j1, 128).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
         vertexbuffer.func_181662_b(0.5D, -0.25D, 0.0D).func_187315_a((double)f1, (double)f3).func_181669_b(l, 255, j1, 128).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
         vertexbuffer.func_181662_b(0.5D, 0.75D, 0.0D).func_187315_a((double)f1, (double)f2).func_181669_b(l, 255, j1, 128).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
         vertexbuffer.func_181662_b(-0.5D, 0.75D, 0.0D).func_187315_a((double)f, (double)f2).func_181669_b(l, 255, j1, 128).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
