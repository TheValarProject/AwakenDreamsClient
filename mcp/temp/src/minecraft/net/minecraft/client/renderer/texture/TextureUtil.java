...
public class TextureUtil {
   ...
   private static void func_147947_a(int p_147947_0_, int[] p_147947_1_, int p_147947_2_, int p_147947_3_, int p_147947_4_, int p_147947_5_, boolean p_147947_6_, boolean p_147947_7_, boolean p_147947_8_) {
      ...
      for(int j = 0; j < p_147947_2_ * p_147947_3_; j += p_147947_2_ * l) {
         ...
         GlStateManager.func_187414_b(3553, p_147947_0_, p_147947_4_, p_147947_5_ + k, p_147947_2_, l, '\u80e1', '\u8367', field_111000_c);
      }
   ...
   public static void func_180600_a(int p_180600_0_, int p_180600_1_, int p_180600_2_, int p_180600_3_) {
      ...
      if(p_180600_1_ >= 0) {
         GlStateManager.func_187421_b(3553, '\u813d', p_180600_1_);
         GlStateManager.func_187421_b(3553, '\u813a', 0);
         GlStateManager.func_187421_b(3553, '\u813b', p_180600_1_);
         GlStateManager.func_187403_b(3553, '\u8501', 0.0F);
      }

      for(int i = 0; i <= p_180600_1_; ++i) {
         GlStateManager.func_187419_a(3553, i, 6408, p_180600_2_ >> i, p_180600_3_ >> i, 0, '\u80e1', '\u8367', (IntBuffer)null);
      }
   ...
   private static void func_110993_a(BufferedImage p_110993_0_, int p_110993_1_, int p_110993_2_, boolean p_110993_3_, boolean p_110993_4_) {
      ...
      for(int l = 0; l < i * j; l += i * k) {
         ...
         GlStateManager.func_187414_b(3553, 0, p_110993_1_, p_110993_2_ + i1, i, j1, '\u80e1', '\u8367', field_111000_c);
      }
   ...
   static {
      ...
      for(i = 0; i < field_188544_e.length; ++i) {
         field_188544_e[i] = (float)Math.pow((double)((float)i / 255.0F), 2.2D);
      }
