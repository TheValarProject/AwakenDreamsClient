...
public class ChunkRenderDispatcher {
   ...
   private void func_178510_a(VertexBuffer p_178510_1_, int p_178510_2_, RenderChunk p_178510_3_) {
   ...
   private void func_178506_a(VertexBuffer p_178506_1_, net.minecraft.client.renderer.vertex.VertexBuffer p_178506_2_) {
   ...
   public void func_188244_g() {
      ...
      for(Thread thread : this.field_188250_d) {
         try {
            ...
            field_178523_a.warn((String)"Interrupted whilst waiting for worker to die", (Throwable)interruptedexception);
         }
      }
   ...
   public boolean func_188248_h() {
      return this.field_178520_e.size() == 0;
   }
