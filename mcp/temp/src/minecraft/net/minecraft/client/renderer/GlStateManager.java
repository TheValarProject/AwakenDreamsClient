...
public class GlStateManager {
   ...
   public static void func_187431_e(int p_187431_0_) {
      ...
      func_187399_a(8960, 8704, '\u8570');
      func_187399_a(8960, '\u8571', 7681);
      func_187399_a(8960, '\u8580', '\u8576');
      func_187399_a(8960, '\u8590', 768);
      func_187399_a(8960, '\u8572', 7681);
      func_187399_a(8960, '\u8588', 5890);
      func_187399_a(8960, '\u8598', 770);
   }

   public static void func_187417_n() {
      func_187399_a(8960, 8704, 8448);
      func_187399_a(8960, '\u8571', 8448);
      func_187399_a(8960, '\u8572', 8448);
      func_187399_a(8960, '\u8580', 5890);
      func_187399_a(8960, '\u8588', 5890);
      func_187399_a(8960, '\u8590', 768);
      func_187399_a(8960, '\u8598', 770);
   }
   ...
   static {
      ...
      field_179173_q = 7425;
      field_179172_r = new GlStateManager.BooleanState('\u803a');
   ...
   public static enum Profile {
      DEFAULT {
         public void func_187373_a() {
            ...
            GL11.glLightModel(2899, (FloatBuffer)RenderHelper.func_74521_a(0.2F, 0.2F, 0.2F, 1.0F));

            for(int i = 0; i < 8; ++i) {
               GlStateManager.func_179122_b(i);
               GL11.glLight(16384 + i, 4608, (FloatBuffer)RenderHelper.func_74521_a(0.0F, 0.0F, 0.0F, 1.0F));
               GL11.glLight(16384 + i, 4611, (FloatBuffer)RenderHelper.func_74521_a(0.0F, 0.0F, 1.0F, 0.0F));
               if(i == 0) {
                  GL11.glLight(16384 + i, 4609, (FloatBuffer)RenderHelper.func_74521_a(1.0F, 1.0F, 1.0F, 1.0F));
                  GL11.glLight(16384 + i, 4610, (FloatBuffer)RenderHelper.func_74521_a(1.0F, 1.0F, 1.0F, 1.0F));
               } else {
                  GL11.glLight(16384 + i, 4609, (FloatBuffer)RenderHelper.func_74521_a(0.0F, 0.0F, 0.0F, 1.0F));
                  GL11.glLight(16384 + i, 4610, (FloatBuffer)RenderHelper.func_74521_a(0.0F, 0.0F, 0.0F, 1.0F));
               }
            }
            ...
            GL11.glFog(2918, (FloatBuffer)RenderHelper.func_74521_a(0.0F, 0.0F, 0.0F, 0.0F));
            ...
            GL11.glTexEnv(8960, 8705, (FloatBuffer)RenderHelper.func_74521_a(0.0F, 0.0F, 0.0F, 0.0F));
