...
public class RenderFish extends Render<EntityFishHook> {
   ...
   public void func_76986_a(EntityFishHook p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      ...
      if(p_76986_1_.field_146042_b != null && !this.field_188301_f) {
         int k = p_76986_1_.field_146042_b.func_184591_cq() == EnumHandSide.RIGHT?1:-1;
         ...
         float f9 = (p_76986_1_.field_146042_b.field_70760_ar + (p_76986_1_.field_146042_b.field_70761_aq - p_76986_1_.field_146042_b.field_70760_ar) * p_76986_9_) * 0.017453292F;
         ...
         if((this.field_76990_c.field_78733_k == null || this.field_76990_c.field_78733_k.field_74320_O <= 0) && p_76986_1_.field_146042_b == Minecraft.func_71410_x().field_71439_g) {
            ...
            vec3d = vec3d.func_178789_a(-(p_76986_1_.field_146042_b.field_70127_C + (p_76986_1_.field_146042_b.field_70125_A - p_76986_1_.field_146042_b.field_70127_C) * p_76986_9_) * 0.017453292F);
            vec3d = vec3d.func_178785_b(-(p_76986_1_.field_146042_b.field_70126_B + (p_76986_1_.field_146042_b.field_70177_z - p_76986_1_.field_146042_b.field_70126_B) * p_76986_9_) * 0.017453292F);
            vec3d = vec3d.func_178785_b(f8 * 0.5F);
            vec3d = vec3d.func_178789_a(-f8 * 0.7F);
            d4 = p_76986_1_.field_146042_b.field_70169_q + (p_76986_1_.field_146042_b.field_70165_t - p_76986_1_.field_146042_b.field_70169_q) * (double)p_76986_9_ + vec3d.field_72450_a;
            d5 = p_76986_1_.field_146042_b.field_70167_r + (p_76986_1_.field_146042_b.field_70163_u - p_76986_1_.field_146042_b.field_70167_r) * (double)p_76986_9_ + vec3d.field_72448_b;
            d6 = p_76986_1_.field_146042_b.field_70166_s + (p_76986_1_.field_146042_b.field_70161_v - p_76986_1_.field_146042_b.field_70166_s) * (double)p_76986_9_ + vec3d.field_72449_c;
            d7 = (double)p_76986_1_.field_146042_b.func_70047_e();
         } else {
            d4 = p_76986_1_.field_146042_b.field_70169_q + (p_76986_1_.field_146042_b.field_70165_t - p_76986_1_.field_146042_b.field_70169_q) * (double)p_76986_9_ - d1 * d2 - d0 * 0.8D;
            d5 = p_76986_1_.field_146042_b.field_70167_r + (double)p_76986_1_.field_146042_b.func_70047_e() + (p_76986_1_.field_146042_b.field_70163_u - p_76986_1_.field_146042_b.field_70167_r) * (double)p_76986_9_ - 0.45D;
            d6 = p_76986_1_.field_146042_b.field_70166_s + (p_76986_1_.field_146042_b.field_70161_v - p_76986_1_.field_146042_b.field_70166_s) * (double)p_76986_9_ - d0 * d2 + d1 * 0.8D;
            d7 = p_76986_1_.field_146042_b.func_70093_af()?-0.1875D:0.0D;
         }
         ...
         for(int i1 = 0; i1 <= 16; ++i1) {
            ...
            vertexbuffer.func_181662_b(p_76986_2_ + d10 * (double)f10, p_76986_4_ + d11 * (double)(f10 * f10 + f10) * 0.5D + 0.25D, p_76986_6_ + d12 * (double)f10).func_181669_b(0, 0, 0, 255).func_181675_d();
         }
