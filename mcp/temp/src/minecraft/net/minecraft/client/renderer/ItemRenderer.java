...
public class ItemRenderer {
   ...
   public void func_187462_a(EntityLivingBase p_187462_1_, ItemStack p_187462_2_, ItemCameraTransforms.TransformType p_187462_3_, boolean p_187462_4_) {
      if(p_187462_2_ != null) {
         ...
         boolean flag = this.field_178112_h.func_175050_a(p_187462_2_) && this.func_178107_a(block);
         if(flag) {
   ...
   private boolean func_178107_a(@Nullable Block p_178107_1_) {
      return p_178107_1_ != null && p_178107_1_.func_180664_k() == BlockRenderLayer.TRANSLUCENT;
   }
   ...
   private void func_187461_a(ItemStack p_187461_1_) {
      ...
      vertexbuffer.func_181662_b(-7.0D, 135.0D, 0.0D).func_187315_a(0.0D, 1.0D).func_181675_d();
      vertexbuffer.func_181662_b(135.0D, 135.0D, 0.0D).func_187315_a(1.0D, 1.0D).func_181675_d();
   ...
   public void func_187457_a(AbstractClientPlayer p_187457_1_, float p_187457_2_, float p_187457_3_, EnumHand p_187457_4_, float p_187457_5_, @Nullable ItemStack p_187457_6_, float p_187457_7_) {
   ...
   private void func_178108_a(float p_178108_1_, TextureAtlasSprite p_178108_2_) {
      ...
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
      vertexbuffer.func_181662_b(-1.0D, -1.0D, -0.5D).func_187315_a((double)f7, (double)f9).func_181675_d();
      vertexbuffer.func_181662_b(1.0D, -1.0D, -0.5D).func_187315_a((double)f6, (double)f9).func_181675_d();
      vertexbuffer.func_181662_b(1.0D, 1.0D, -0.5D).func_187315_a((double)f6, (double)f8).func_181675_d();
      vertexbuffer.func_181662_b(-1.0D, 1.0D, -0.5D).func_187315_a((double)f7, (double)f8).func_181675_d();
      tessellator.func_78381_a();
      GlStateManager.func_179121_F();
   ...
   private void func_78448_c(float p_78448_1_) {
      ...
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
      vertexbuffer.func_181662_b(-1.0D, -1.0D, -0.5D).func_187315_a((double)(4.0F + f7), (double)(4.0F + f8)).func_181675_d();
      vertexbuffer.func_181662_b(1.0D, -1.0D, -0.5D).func_187315_a((double)(0.0F + f7), (double)(4.0F + f8)).func_181675_d();
      vertexbuffer.func_181662_b(1.0D, 1.0D, -0.5D).func_187315_a((double)(0.0F + f7), (double)(0.0F + f8)).func_181675_d();
      vertexbuffer.func_181662_b(-1.0D, 1.0D, -0.5D).func_187315_a((double)(4.0F + f7), (double)(0.0F + f8)).func_181675_d();
      tessellator.func_78381_a();
      GlStateManager.func_179121_F();
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void func_78442_d(float p_78442_1_) {
      ...
      for(int i = 0; i < 2; ++i) {
         ...
         vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
         vertexbuffer.func_181662_b(-0.5D, -0.5D, -0.5D).func_187315_a((double)f2, (double)f4).func_181675_d();
         vertexbuffer.func_181662_b(0.5D, -0.5D, -0.5D).func_187315_a((double)f1, (double)f4).func_181675_d();
         vertexbuffer.func_181662_b(0.5D, 0.5D, -0.5D).func_187315_a((double)f1, (double)f3).func_181675_d();
         vertexbuffer.func_181662_b(-0.5D, 0.5D, -0.5D).func_187315_a((double)f2, (double)f3).func_181675_d();
         tessellator.func_78381_a();
         GlStateManager.func_179121_F();
      }
