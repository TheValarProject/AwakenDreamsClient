...
public class VertexBuffer {
   ...
   private void func_181670_b(int p_181670_1_) {
      if(MathHelper.func_154354_b(p_181670_1_, 4) / 4 > this.field_178999_b.remaining() || this.field_178997_d * this.field_179011_q.func_177338_f() + p_181670_1_ > this.field_179001_a.capacity()) {
         ...
         field_187316_a.debug("Needed to grow BufferBuilder buffer: Old size {} bytes, new size {} bytes.", new Object[]{Integer.valueOf(i), Integer.valueOf(j)});
   ...
   public VertexBuffer.State func_181672_a() {
      ...
      return new VertexBuffer.State(aint, new VertexFormat(this.field_179011_q));
   }
   ...
   public void func_178993_a(VertexBuffer.State p_178993_1_) {
   ...
   public VertexBuffer func_187315_a(double p_187315_1_, double p_187315_3_) {
   ...
   public VertexBuffer func_187314_a(int p_187314_1_, int p_187314_2_) {
      int i = this.field_178997_d * this.field_179011_q.func_177338_f() + this.field_179011_q.func_181720_d(this.field_181678_g);
      switch(this.field_181677_f.func_177367_b()) {
      case FLOAT:
   ...
   public VertexBuffer func_181666_a(float p_181666_1_, float p_181666_2_, float p_181666_3_, float p_181666_4_) {
      return this.func_181669_b((int)(p_181666_1_ * 255.0F), (int)(p_181666_2_ * 255.0F), (int)(p_181666_3_ * 255.0F), (int)(p_181666_4_ * 255.0F));
   }

   public VertexBuffer func_181669_b(int p_181669_1_, int p_181669_2_, int p_181669_3_, int p_181669_4_) {
      if(this.field_78939_q) {
         return this;
      } else {
         int i = this.field_178997_d * this.field_179011_q.func_177338_f() + this.field_179011_q.func_181720_d(this.field_181678_g);
   ...
   public VertexBuffer func_181662_b(double p_181662_1_, double p_181662_3_, double p_181662_5_) {
      int i = this.field_178997_d * this.field_179011_q.func_177338_f() + this.field_179011_q.func_181720_d(this.field_181678_g);
      switch(this.field_181677_f.func_177367_b()) {
      case FLOAT:
   ...
   public VertexBuffer func_181663_c(float p_181663_1_, float p_181663_2_, float p_181663_3_) {
      int i = this.field_178997_d * this.field_179011_q.func_177338_f() + this.field_179011_q.func_181720_d(this.field_181678_g);
      switch(this.field_181677_f.func_177367_b()) {
      case FLOAT:
