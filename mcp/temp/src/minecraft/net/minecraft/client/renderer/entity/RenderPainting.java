   ...
   private void func_77010_a(EntityPainting p_77010_1_, int p_77010_2_, int p_77010_3_, int p_77010_4_, int p_77010_5_) {
      ...
      for(int i = 0; i < p_77010_2_ / 16; ++i) {
         for(int j = 0; j < p_77010_3_ / 16; ++j) {
            ...
            vertexbuffer.func_181662_b((double)f15, (double)f18, -0.5D).func_187315_a((double)f20, (double)f21).func_181663_c(0.0F, 0.0F, -1.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f18, -0.5D).func_187315_a((double)f19, (double)f21).func_181663_c(0.0F, 0.0F, -1.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f17, -0.5D).func_187315_a((double)f19, (double)f22).func_181663_c(0.0F, 0.0F, -1.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f17, -0.5D).func_187315_a((double)f20, (double)f22).func_181663_c(0.0F, 0.0F, -1.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f17, 0.5D).func_187315_a(0.75D, 0.0D).func_181663_c(0.0F, 0.0F, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f17, 0.5D).func_187315_a(0.8125D, 0.0D).func_181663_c(0.0F, 0.0F, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f18, 0.5D).func_187315_a(0.8125D, 0.0625D).func_181663_c(0.0F, 0.0F, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f18, 0.5D).func_187315_a(0.75D, 0.0625D).func_181663_c(0.0F, 0.0F, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f17, -0.5D).func_187315_a(0.75D, 0.001953125D).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f17, -0.5D).func_187315_a(0.8125D, 0.001953125D).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f17, 0.5D).func_187315_a(0.8125D, 0.001953125D).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f17, 0.5D).func_187315_a(0.75D, 0.001953125D).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f18, 0.5D).func_187315_a(0.75D, 0.001953125D).func_181663_c(0.0F, -1.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f18, 0.5D).func_187315_a(0.8125D, 0.001953125D).func_181663_c(0.0F, -1.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f18, -0.5D).func_187315_a(0.8125D, 0.001953125D).func_181663_c(0.0F, -1.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f18, -0.5D).func_187315_a(0.75D, 0.001953125D).func_181663_c(0.0F, -1.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f17, 0.5D).func_187315_a(0.751953125D, 0.0D).func_181663_c(-1.0F, 0.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f18, 0.5D).func_187315_a(0.751953125D, 0.0625D).func_181663_c(-1.0F, 0.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f18, -0.5D).func_187315_a(0.751953125D, 0.0625D).func_181663_c(-1.0F, 0.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f15, (double)f17, -0.5D).func_187315_a(0.751953125D, 0.0D).func_181663_c(-1.0F, 0.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f17, -0.5D).func_187315_a(0.751953125D, 0.0D).func_181663_c(1.0F, 0.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f18, -0.5D).func_187315_a(0.751953125D, 0.0625D).func_181663_c(1.0F, 0.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f18, 0.5D).func_187315_a(0.751953125D, 0.0625D).func_181663_c(1.0F, 0.0F, 0.0F).func_181675_d();
            vertexbuffer.func_181662_b((double)f16, (double)f17, 0.5D).func_187315_a(0.751953125D, 0.0D).func_181663_c(1.0F, 0.0F, 0.0F).func_181675_d();
