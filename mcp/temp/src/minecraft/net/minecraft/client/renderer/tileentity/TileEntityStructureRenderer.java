...
public class TileEntityStructureRenderer extends TileEntitySpecialRenderer<TileEntityStructure> {
   public void func_180535_a(TileEntityStructure p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_, float p_180535_8_, int p_180535_9_) {
      if(Minecraft.func_71410_x().field_71439_g.func_189808_dh() || Minecraft.func_71410_x().field_71439_g.func_175149_v()) {
         ...
         BlockPos blockpos = p_180535_1_.func_189711_e();
         BlockPos blockpos1 = p_180535_1_.func_189717_g();
         if(blockpos1.func_177958_n() >= 1 && blockpos1.func_177956_o() >= 1 && blockpos1.func_177952_p() >= 1) {
            if(p_180535_1_.func_189700_k() == TileEntityStructure.Mode.SAVE || p_180535_1_.func_189700_k() == TileEntityStructure.Mode.LOAD) {
               double d0 = 0.01D;
               double d1 = (double)blockpos.func_177958_n();
               double d2 = (double)blockpos.func_177952_p();
               double d6 = p_180535_4_ + (double)blockpos.func_177956_o() - 0.01D;
               double d9 = d6 + (double)blockpos1.func_177956_o() + 0.02D;
               double d3;
               double d4;
               switch(p_180535_1_.func_189716_h()) {
               case LEFT_RIGHT:
               ...
               double d8;
               double d10;
               switch(p_180535_1_.func_189726_i()) {
               case CLOCKWISE_90:
                  d5 = p_180535_2_ + (d4 < 0.0D?d1 - 0.01D:d1 + 1.0D + 0.01D);
                  d7 = p_180535_6_ + (d3 < 0.0D?d2 + 1.0D + 0.01D:d2 - 0.01D);
                  d8 = d5 - d4;
                  d10 = d7 + d3;
                  break;
               case CLOCKWISE_180:
                  d5 = p_180535_2_ + (d3 < 0.0D?d1 - 0.01D:d1 + 1.0D + 0.01D);
                  d7 = p_180535_6_ + (d4 < 0.0D?d2 - 0.01D:d2 + 1.0D + 0.01D);
                  d8 = d5 - d3;
                  d10 = d7 - d4;
                  break;
               case COUNTERCLOCKWISE_90:
                  d5 = p_180535_2_ + (d4 < 0.0D?d1 + 1.0D + 0.01D:d1 - 0.01D);
                  d7 = p_180535_6_ + (d3 < 0.0D?d2 - 0.01D:d2 + 1.0D + 0.01D);
                  d8 = d5 + d4;
                  d10 = d7 - d3;
                  break;
               default:
                  d5 = p_180535_2_ + (d3 < 0.0D?d1 + 1.0D + 0.01D:d1 - 0.01D);
                  d7 = p_180535_6_ + (d4 < 0.0D?d2 + 1.0D + 0.01D:d2 - 0.01D);
                  d8 = d5 + d3;
                  d10 = d7 + d4;
               }
               ...
               if(p_180535_1_.func_189700_k() == TileEntityStructure.Mode.SAVE || p_180535_1_.func_189721_I()) {
                  this.func_190055_a(tessellator, vertexbuffer, d5, d6, d7, d8, d9, d10, 255, 223, 127);
               }

               if(p_180535_1_.func_189700_k() == TileEntityStructure.Mode.SAVE && p_180535_1_.func_189707_H()) {
                  this.func_190054_a(p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_, blockpos, tessellator, vertexbuffer, true);
                  this.func_190054_a(p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_, blockpos, tessellator, vertexbuffer, false);
               }
   ...
   private void func_190054_a(TileEntityStructure p_190054_1_, double p_190054_2_, double p_190054_4_, double p_190054_6_, BlockPos p_190054_8_, Tessellator p_190054_9_, VertexBuffer p_190054_10_, boolean p_190054_11_) {
      ...
      for(BlockPos blockpos2 : BlockPos.MutableBlockPos.func_177980_a(blockpos1, blockpos1.func_177971_a(p_190054_1_.func_189717_g()).func_177982_a(-1, -1, -1))) {
