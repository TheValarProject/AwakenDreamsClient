...
public class ItemColors {
   ...
   public static ItemColors func_186729_a(final BlockColors p_186729_0_) {
      ...
      }, new Item[]{Items.field_151024_Q, Items.field_151027_R, Items.field_151026_S, Items.field_151021_T});
      itemcolors.func_186730_a(new IItemColor() {
         public int func_186726_a(ItemStack p_186726_1_, int p_186726_2_) {
            return p_186726_2_ > 0?-1:ItemBanner.func_179225_h(p_186726_1_).func_176768_e().field_76291_p;
         }
      }, new Item[]{Items.field_179564_cE, Items.field_185159_cQ});
      ...
      }, new Item[]{Items.field_151154_bQ});
      itemcolors.func_186730_a(new IItemColor() {
         public int func_186726_a(ItemStack p_186726_1_, int p_186726_2_) {
            return p_186726_2_ > 0?-1:PotionUtils.func_185181_a(PotionUtils.func_185189_a(p_186726_1_));
         }
      }, new Item[]{Items.field_151068_bn, Items.field_185155_bH, Items.field_185156_bI});
      itemcolors.func_186730_a(new IItemColor() {
         public int func_186726_a(ItemStack p_186726_1_, int p_186726_2_) {
            EntityList.EntityEggInfo entitylist$entityegginfo = (EntityList.EntityEggInfo)EntityList.field_75627_a.get(ItemMonsterPlacer.func_185080_h(p_186726_1_));
            return entitylist$entityegginfo == null?-1:(p_186726_2_ == 0?entitylist$entityegginfo.field_75611_b:entitylist$entityegginfo.field_75612_c);
         }
      ...
      }, new Block[]{Blocks.field_150349_c, Blocks.field_150329_H, Blocks.field_150395_bd, Blocks.field_150362_t, Blocks.field_150361_u, Blocks.field_150392_bi});
      itemcolors.func_186730_a(new IItemColor() {
         public int func_186726_a(ItemStack p_186726_1_, int p_186726_2_) {
            return p_186726_2_ == 0?PotionUtils.func_185181_a(PotionUtils.func_185189_a(p_186726_1_)):-1;
         }
      }, new Item[]{Items.field_185167_i});
      return itemcolors;
   }
