      ...
      try {
         if(p_178474_1_.func_178546_a() != ChunkCompileTaskGenerator.Status.PENDING) {
            if(!p_178474_1_.func_178537_h()) {
               field_152478_a.warn("Chunk render task was {} when I expected it to be pending; ignoring task", new Object[]{p_178474_1_.func_178546_a()});
            }
      ...
      if(lvt_2_2_ == null) {
         ...
         try {
            if(p_178474_1_.func_178546_a() != ChunkCompileTaskGenerator.Status.COMPILING) {
               if(!p_178474_1_.func_178537_h()) {
                  field_152478_a.warn("Chunk render task was {} when I expected it to be compiling; aborting task", new Object[]{p_178474_1_.func_178546_a()});
               }
            ...
            public void onSuccess(@Nullable List<Object> p_onSuccess_1_) {
               ...
               label21: {
                  try {
                     ...
                     if(!p_178474_1_.func_178537_h()) {
                        ChunkRenderWorker.field_152478_a.warn("Chunk render task was {} when I expected it to be uploading; aborting task", new Object[]{p_178474_1_.func_178546_a()});
                     }
                  } finally {
                     p_178474_1_.func_178540_f().unlock();
                  }
