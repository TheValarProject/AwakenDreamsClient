...
public class BlockModelRenderer {
   ...
   public boolean func_178267_a(IBlockAccess p_178267_1_, IBakedModel p_178267_2_, IBlockState p_178267_3_, BlockPos p_178267_4_, VertexBuffer p_178267_5_, boolean p_178267_6_) {
   ...
   public boolean func_187493_a(IBlockAccess p_187493_1_, IBakedModel p_187493_2_, IBlockState p_187493_3_, BlockPos p_187493_4_, VertexBuffer p_187493_5_, boolean p_187493_6_, long p_187493_7_) {
   ...
   public boolean func_187498_b(IBlockAccess p_187498_1_, IBakedModel p_187498_2_, IBlockState p_187498_3_, BlockPos p_187498_4_, VertexBuffer p_187498_5_, boolean p_187498_6_, long p_187498_7_) {
      boolean flag = false;
   ...
   public boolean func_187497_c(IBlockAccess p_187497_1_, IBakedModel p_187497_2_, IBlockState p_187497_3_, BlockPos p_187497_4_, VertexBuffer p_187497_5_, boolean p_187497_6_, long p_187497_7_) {
      boolean flag = false;
      BitSet bitset = new BitSet(3);
   ...
   private void func_187492_a(IBlockAccess p_187492_1_, IBlockState p_187492_2_, BlockPos p_187492_3_, VertexBuffer p_187492_4_, List<BakedQuad> p_187492_5_, float[] p_187492_6_, BitSet p_187492_7_, BlockModelRenderer.AmbientOcclusionFace p_187492_8_) {
      double d0 = (double)p_187492_3_.func_177958_n();
      double d1 = (double)p_187492_3_.func_177956_o();
      double d2 = (double)p_187492_3_.func_177952_p();
      Block block = p_187492_2_.func_177230_c();
      Block.EnumOffsetType block$enumoffsettype = block.func_176218_Q();
      if(block$enumoffsettype != Block.EnumOffsetType.NONE) {
         long i = MathHelper.func_180186_a(p_187492_3_);
   ...
   private void func_187494_a(IBlockState p_187494_1_, int[] p_187494_2_, EnumFacing p_187494_3_, @Nullable float[] p_187494_4_, BitSet p_187494_5_) {
      ...
      if(p_187494_4_ != null) {
         ...
         p_187494_4_[EnumFacing.WEST.func_176745_a() + EnumFacing.values().length] = 1.0F - f;
         p_187494_4_[EnumFacing.EAST.func_176745_a() + EnumFacing.values().length] = 1.0F - f3;
         p_187494_4_[EnumFacing.DOWN.func_176745_a() + EnumFacing.values().length] = 1.0F - f1;
         p_187494_4_[EnumFacing.UP.func_176745_a() + EnumFacing.values().length] = 1.0F - f4;
         p_187494_4_[EnumFacing.NORTH.func_176745_a() + EnumFacing.values().length] = 1.0F - f2;
         p_187494_4_[EnumFacing.SOUTH.func_176745_a() + EnumFacing.values().length] = 1.0F - f5;
      }
   ...
   private void func_187496_a(IBlockAccess p_187496_1_, IBlockState p_187496_2_, BlockPos p_187496_3_, int p_187496_4_, boolean p_187496_5_, VertexBuffer p_187496_6_, List<BakedQuad> p_187496_7_, BitSet p_187496_8_) {
      double d0 = (double)p_187496_3_.func_177958_n();
      double d1 = (double)p_187496_3_.func_177956_o();
      double d2 = (double)p_187496_3_.func_177952_p();
      Block block = p_187496_2_.func_177230_c();
      Block.EnumOffsetType block$enumoffsettype = block.func_176218_Q();
      if(block$enumoffsettype != Block.EnumOffsetType.NONE) {
         int i = p_187496_3_.func_177958_n();
         int j = p_187496_3_.func_177952_p();
      ...
      for(int i1 = p_187496_7_.size(); l < i1; ++l) {
         ...
         if(bakedquad.func_178212_b()) {
            int j1 = this.field_187499_a.func_186724_a(p_187496_2_, p_187496_1_, p_187496_3_, bakedquad.func_178211_c());
            if(EntityRenderer.field_78517_a) {
               j1 = TextureUtil.func_177054_c(j1);
            }
