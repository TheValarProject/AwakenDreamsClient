...
public class BlockColors {
   ...
   public static BlockColors func_186723_a() {
      ...
      blockcolors.func_186722_a(new IBlockColor() {
         public int func_186720_a(IBlockState p_186720_1_, @Nullable IBlockAccess p_186720_2_, @Nullable BlockPos p_186720_3_, int p_186720_4_) {
            ...
            return p_186720_2_ == null || p_186720_3_ == null || blockdoubleplant$enumplanttype != BlockDoublePlant.EnumPlantType.GRASS && blockdoubleplant$enumplanttype != BlockDoublePlant.EnumPlantType.FERN?-1:BiomeColorHelper.func_180286_a(p_186720_2_, p_186720_3_);
         }
      ...
      }, new Block[]{Blocks.field_150457_bL});
      blockcolors.func_186722_a(new IBlockColor() {
         public int func_186720_a(IBlockState p_186720_1_, @Nullable IBlockAccess p_186720_2_, @Nullable BlockPos p_186720_3_, int p_186720_4_) {
      ...
      }, new Block[]{Blocks.field_150349_c});
      blockcolors.func_186722_a(new IBlockColor() {
         public int func_186720_a(IBlockState p_186720_1_, @Nullable IBlockAccess p_186720_2_, @Nullable BlockPos p_186720_3_, int p_186720_4_) {
            BlockPlanks.EnumType blockplanks$enumtype = (BlockPlanks.EnumType)p_186720_1_.func_177229_b(BlockOldLeaf.field_176239_P);
            return blockplanks$enumtype == BlockPlanks.EnumType.SPRUCE?ColorizerFoliage.func_77466_a():(blockplanks$enumtype == BlockPlanks.EnumType.BIRCH?ColorizerFoliage.func_77469_b():(p_186720_2_ != null && p_186720_3_ != null?BiomeColorHelper.func_180287_b(p_186720_2_, p_186720_3_):ColorizerFoliage.func_77468_c()));
         }
      ...
      }, new Block[]{Blocks.field_150361_u});
      blockcolors.func_186722_a(new IBlockColor() {
         public int func_186720_a(IBlockState p_186720_1_, @Nullable IBlockAccess p_186720_2_, @Nullable BlockPos p_186720_3_, int p_186720_4_) {
      ...
      }, new Block[]{Blocks.field_150488_af});
      blockcolors.func_186722_a(new IBlockColor() {
         public int func_186720_a(IBlockState p_186720_1_, @Nullable IBlockAccess p_186720_2_, @Nullable BlockPos p_186720_3_, int p_186720_4_) {
      ...
      }, new Block[]{Blocks.field_150394_bc, Blocks.field_150393_bb});
      blockcolors.func_186722_a(new IBlockColor() {
         public int func_186720_a(IBlockState p_186720_1_, @Nullable IBlockAccess p_186720_2_, @Nullable BlockPos p_186720_3_, int p_186720_4_) {
            return p_186720_2_ != null && p_186720_3_ != null?BiomeColorHelper.func_180286_a(p_186720_2_, p_186720_3_):(p_186720_1_.func_177229_b(BlockTallGrass.field_176497_a) == BlockTallGrass.EnumType.DEAD_BUSH?16777215:ColorizerGrass.func_77480_a(0.5D, 1.0D));
         }
      ...
      }, new Block[]{Blocks.field_150392_bi});
      return blockcolors;
   }
   ...
   public int func_189991_a(IBlockState p_189991_1_) {
      ...
      if(iblockcolor != null) {
         ...
         MapColor mapcolor = p_189991_1_.func_185909_g();
