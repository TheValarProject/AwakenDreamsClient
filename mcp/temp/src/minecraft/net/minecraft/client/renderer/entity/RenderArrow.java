...
public abstract class RenderArrow<T extends EntityArrow> extends Render<T> {
   ...
   public void func_76986_a(T p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      ...
      vertexbuffer.func_181662_b(-7.0D, -2.0D, -2.0D).func_187315_a(0.0D, 0.15625D).func_181675_d();
      vertexbuffer.func_181662_b(-7.0D, -2.0D, 2.0D).func_187315_a(0.15625D, 0.15625D).func_181675_d();
      vertexbuffer.func_181662_b(-7.0D, 2.0D, 2.0D).func_187315_a(0.15625D, 0.3125D).func_181675_d();
      vertexbuffer.func_181662_b(-7.0D, 2.0D, -2.0D).func_187315_a(0.0D, 0.3125D).func_181675_d();
      ...
      for(int j = 0; j < 4; ++j) {
         ...
         vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
         vertexbuffer.func_181662_b(-8.0D, -2.0D, 0.0D).func_187315_a(0.0D, 0.0D).func_181675_d();
         vertexbuffer.func_181662_b(8.0D, -2.0D, 0.0D).func_187315_a(0.5D, 0.0D).func_181675_d();
         vertexbuffer.func_181662_b(8.0D, 2.0D, 0.0D).func_187315_a(0.5D, 0.15625D).func_181675_d();
         vertexbuffer.func_181662_b(-8.0D, 2.0D, 0.0D).func_187315_a(0.0D, 0.15625D).func_181675_d();
         tessellator.func_78381_a();
      }
