         ...
         for(Integer integer1 : this.field_188291_b.keySet()) {
            ...
            for(PathPoint pathpoint3 : path1.func_189965_h()) {
               if(this.func_190066_a(pathpoint3) <= 40.0F) {
                  DebugRenderer.func_190076_a(String.format("%s", new Object[]{pathpoint3.field_186287_m}), (double)pathpoint3.field_75839_a + 0.5D, (double)pathpoint3.field_75837_b + 0.75D, (double)pathpoint3.field_75838_c + 0.5D, p_190060_1_, -65536);
                  DebugRenderer.func_190076_a(String.format("%.2f", new Object[]{Float.valueOf(pathpoint3.field_186286_l)}), (double)pathpoint3.field_75839_a + 0.5D, (double)pathpoint3.field_75837_b + 0.25D, (double)pathpoint3.field_75838_c + 0.5D, p_190060_1_, -65536);
               }
            }

            for(PathPoint pathpoint4 : path1.func_189966_g()) {
               if(this.func_190066_a(pathpoint4) <= 40.0F) {
                  DebugRenderer.func_190076_a(String.format("%s", new Object[]{pathpoint4.field_186287_m}), (double)pathpoint4.field_75839_a + 0.5D, (double)pathpoint4.field_75837_b + 0.75D, (double)pathpoint4.field_75838_c + 0.5D, p_190060_1_, -16776961);
                  DebugRenderer.func_190076_a(String.format("%.2f", new Object[]{Float.valueOf(pathpoint4.field_186286_l)}), (double)pathpoint4.field_75839_a + 0.5D, (double)pathpoint4.field_75837_b + 0.25D, (double)pathpoint4.field_75838_c + 0.5D, p_190060_1_, -16776961);
               }
            }
            ...
            for(int k = 0; k < path1.func_75874_d(); ++k) {
               ...
               if(this.func_190066_a(pathpoint2) <= 40.0F) {
                  DebugRenderer.func_190076_a(String.format("%s", new Object[]{pathpoint2.field_186287_m}), (double)pathpoint2.field_75839_a + 0.5D, (double)pathpoint2.field_75837_b + 0.75D, (double)pathpoint2.field_75838_c + 0.5D, p_190060_1_, -1);
                  DebugRenderer.func_190076_a(String.format("%.2f", new Object[]{Float.valueOf(pathpoint2.field_186286_l)}), (double)pathpoint2.field_75839_a + 0.5D, (double)pathpoint2.field_75837_b + 0.25D, (double)pathpoint2.field_75838_c + 0.5D, p_190060_1_, -1);
               }
            }
         }
   ...
   public void func_190067_a(float p_190067_1_, Path p_190067_2_) {
      ...
      for(int i = 0; i < p_190067_2_.func_75874_d(); ++i) {
         ...
         if(this.func_190066_a(pathpoint) <= 40.0F) {
            ...
            int l = j >> 8 & 255;
            int i1 = j & 255;
            vertexbuffer.func_181662_b((double)pathpoint.field_75839_a - this.field_190069_f + 0.5D, (double)pathpoint.field_75837_b - this.field_190070_g + 0.5D, (double)pathpoint.field_75838_c - this.field_190071_h + 0.5D).func_181669_b(k, l, i1, 255).func_181675_d();
         }
      }
