...
public class RenderGlobal implements IWorldEventListener, IResourceManagerReloadListener {
   ...
   public void func_180447_b(float p_180447_1_, int p_180447_2_) {
      if(this.field_72777_q.field_71441_e.field_73011_w.func_76569_d()) {
         if(this.field_72777_q.field_71474_y.func_181147_e() == 2) {
            ...
            Entity entity = this.field_72777_q.func_175606_aa();
            float f = (float)(entity.field_70137_T + (entity.field_70163_u - entity.field_70137_T) * (double)p_180447_1_);
            int i = 32;
            int j = 8;
            Tessellator tessellator = Tessellator.func_178181_a();
            VertexBuffer vertexbuffer = tessellator.func_178180_c();
            ...
            double d0 = entity.field_70169_q + (entity.field_70165_t - entity.field_70169_q) * (double)p_180447_1_ + d2 * 0.029999999329447746D;
            double d1 = entity.field_70166_s + (entity.field_70161_v - entity.field_70166_s) * (double)p_180447_1_;
   ...
   private void func_180445_c(float p_180445_1_, int p_180445_2_) {
      GlStateManager.func_179129_p();
      Entity entity = this.field_72777_q.func_175606_aa();
      float f = (float)(entity.field_70137_T + (entity.field_70163_u - entity.field_70137_T) * (double)p_180445_1_);
      Tessellator tessellator = Tessellator.func_178181_a();
      VertexBuffer vertexbuffer = tessellator.func_178180_c();
      float f1 = 12.0F;
      float f2 = 4.0F;
      double d0 = (double)((float)this.field_72773_u + p_180445_1_);
      double d1 = (entity.field_70169_q + (entity.field_70165_t - entity.field_70169_q) * (double)p_180445_1_ + d0 * 0.029999999329447746D) / 12.0D;
      double d2 = (entity.field_70166_s + (entity.field_70161_v - entity.field_70166_s) * (double)p_180445_1_) / 12.0D + 0.33000001311302185D;
   ...
   private Particle func_174974_b(int p_174974_1_, boolean p_174974_2_, double p_174974_3_, double p_174974_5_, double p_174974_7_, double p_174974_9_, double p_174974_11_, double p_174974_13_, int... p_174974_15_) {
      ...
      if(this.field_72777_q != null && entity != null && this.field_72777_q.field_71452_i != null) {
         ...
         double d0 = entity.field_70165_t - p_174974_3_;
         double d1 = entity.field_70163_u - p_174974_5_;
         double d2 = entity.field_70161_v - p_174974_7_;
         return p_174974_2_?this.field_72777_q.field_71452_i.func_178927_a(p_174974_1_, p_174974_3_, p_174974_5_, p_174974_7_, p_174974_9_, p_174974_11_, p_174974_13_, p_174974_15_):(d0 * d0 + d1 * d1 + d2 * d2 > 1024.0D?null:(i > 1?null:this.field_72777_q.field_71452_i.func_178927_a(p_174974_1_, p_174974_3_, p_174974_5_, p_174974_7_, p_174974_9_, p_174974_11_, p_174974_13_, p_174974_15_)));
      } else {
         return null;
      }
   }
   ...
   public void func_180439_a(EntityPlayer p_180439_1_, int p_180439_2_, BlockPos p_180439_3_, int p_180439_4_) {
      ...
      case 1037:
         ...
         break;
      case 2000:
         int i1 = p_180439_4_ % 3 - 1;
         int i = p_180439_4_ / 3 % 3 - 1;
         double d8 = (double)p_180439_3_.func_177958_n() + (double)i1 * 0.6D + 0.5D;
         ...
         for(int k1 = 0; k1 < 10; ++k1) {
            ...
            this.func_174972_a(EnumParticleTypes.SMOKE_NORMAL, d14, d17, d20, d23, d25, d27, new int[0]);
         }
      ...
      case 2002:
         ...
         PotionType potiontype = PotionType.func_185169_a(p_180439_4_);
         int k = PotionUtils.func_185183_a(potiontype);
         ...
         for(int i2 = 0; i2 < 100; ++i2) {
            ...
            Particle particle1 = this.func_174974_b(enumparticletypes.func_179348_c(), enumparticletypes.func_179344_e(), d6 + d22 * 0.1D, d7 + 0.3D, d9 + d26 * 0.1D, d22, d24, d26, new int[0]);
            if(particle1 != null) {
      ...
      case 2004:
         for(int l1 = 0; l1 < 20; ++l1) {
            double d15 = (double)p_180439_3_.func_177958_n() + 0.5D + ((double)this.field_72769_h.field_73012_v.nextFloat() - 0.5D) * 2.0D;
            double d18 = (double)p_180439_3_.func_177956_o() + 0.5D + ((double)this.field_72769_h.field_73012_v.nextFloat() - 0.5D) * 2.0D;
            double d21 = (double)p_180439_3_.func_177952_p() + 0.5D + ((double)this.field_72769_h.field_73012_v.nextFloat() - 0.5D) * 2.0D;
            this.field_72769_h.func_175688_a(EnumParticleTypes.SMOKE_NORMAL, d15, d18, d21, 0.0D, 0.0D, 0.0D, new int[0]);
            this.field_72769_h.func_175688_a(EnumParticleTypes.FLAME, d15, d18, d21, 0.0D, 0.0D, 0.0D, new int[0]);
         }
      ...
      case 2006:
         for(int l = 0; l < 200; ++l) {
            ...
            double d3 = (double)(MathHelper.func_76134_b(f4) * f3);
            double d4 = 0.01D + random.nextDouble() * 0.5D;
            double d5 = (double)(MathHelper.func_76126_a(f4) * f3);
