...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   private void func_175045_a(IBakedModel p_175045_1_, int p_175045_2_, @Nullable ItemStack p_175045_3_) {
      Tessellator tessellator = Tessellator.func_178181_a();
      VertexBuffer vertexbuffer = tessellator.func_178180_c();
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_176599_b);

      for(EnumFacing enumfacing : EnumFacing.values()) {
         this.func_175032_a(vertexbuffer, p_175045_1_.func_188616_a((IBlockState)null, enumfacing, 0L), p_175045_2_, p_175045_3_);
      }

      this.func_175032_a(vertexbuffer, p_175045_1_.func_188616_a((IBlockState)null, (EnumFacing)null, 0L), p_175045_2_, p_175045_3_);
   ...
   private void func_175038_a(VertexBuffer p_175038_1_, BakedQuad p_175038_2_) {
   ...
   private void func_175033_a(VertexBuffer p_175033_1_, BakedQuad p_175033_2_, int p_175033_3_) {
   ...
   private void func_175032_a(VertexBuffer p_175032_1_, List<BakedQuad> p_175032_2_, int p_175032_3_, @Nullable ItemStack p_175032_4_) {
      ...
      for(int j = p_175032_2_.size(); i < j; ++i) {
         ...
         if(flag && bakedquad.func_178212_b()) {
            k = this.field_184395_f.func_186728_a(p_175032_4_, bakedquad.func_178211_c());
   ...
   public void func_184392_a(ItemStack p_184392_1_, EntityLivingBase p_184392_2_, ItemCameraTransforms.TransformType p_184392_3_, boolean p_184392_4_) {
      if(p_184392_1_ != null && p_184392_2_ != null && p_184392_1_.func_77973_b() != null) {
         IBakedModel ibakedmodel = this.func_184393_a(p_184392_1_, p_184392_2_.field_70170_p, p_184392_2_);
   ...
   protected void func_184394_a(ItemStack p_184394_1_, IBakedModel p_184394_2_, ItemCameraTransforms.TransformType p_184394_3_, boolean p_184394_4_) {
      if(p_184394_1_.func_77973_b() != null) {
         this.field_175057_n.func_110577_a(TextureMap.field_110575_b);
   ...
   public void func_175042_a(ItemStack p_175042_1_, int p_175042_2_, int p_175042_3_) {
      this.func_184390_a(p_175042_1_, p_175042_2_, p_175042_3_, this.func_184393_a(p_175042_1_, (World)null, (EntityLivingBase)null));
   }
   ...
   public void func_180450_b(ItemStack p_180450_1_, int p_180450_2_, int p_180450_3_) {
      this.func_184391_a(Minecraft.func_71410_x().field_71439_g, p_180450_1_, p_180450_2_, p_180450_3_);
   }

   public void func_184391_a(@Nullable EntityLivingBase p_184391_1_, final ItemStack p_184391_2_, int p_184391_3_, int p_184391_4_) {
      if(p_184391_2_ != null && p_184391_2_.func_77973_b() != null) {
         this.field_77023_b += 50.0F;

         try {
            this.func_184390_a(p_184391_2_, p_184391_3_, p_184391_4_, this.func_184393_a(p_184391_2_, (World)null, p_184391_1_));
      ...
      if(p_180453_2_ != null) {
         if(p_180453_2_.field_77994_a != 1 || p_180453_5_ != null) {
            ...
            if(p_180453_5_ == null && p_180453_2_.field_77994_a < 1) {
               s = TextFormatting.RED + String.valueOf(p_180453_2_.field_77994_a);
            }
         ...
         float f = entityplayersp == null?0.0F:entityplayersp.func_184811_cZ().func_185143_a(p_180453_2_.func_77973_b(), Minecraft.func_71410_x().func_184121_ak());
         if(f > 0.0F) {
            GlStateManager.func_179140_f();
            GlStateManager.func_179097_i();
            GlStateManager.func_179090_x();
            ...
            this.func_181565_a(vertexbuffer1, p_180453_3_, p_180453_4_ + MathHelper.func_76141_d(16.0F * (1.0F - f)), 16, MathHelper.func_76123_f(16.0F * f), 255, 255, 255, 127);
            GlStateManager.func_179098_w();
            GlStateManager.func_179145_e();
            GlStateManager.func_179126_j();
         }
   ...
   private void func_181565_a(VertexBuffer p_181565_1_, int p_181565_2_, int p_181565_3_, int p_181565_4_, int p_181565_5_, int p_181565_6_, int p_181565_7_, int p_181565_8_, int p_181565_9_) {
   ...
   private void func_175041_b() {
      ...
      this.func_175031_a(Blocks.field_185774_da, "grass_path");
      ...
      this.func_175031_a(Blocks.field_185764_cQ, "end_rod");
      this.func_175031_a(Blocks.field_185765_cR, "chorus_plant");
      this.func_175031_a(Blocks.field_185766_cS, "chorus_flower");
      this.func_175031_a(Blocks.field_185767_cT, "purpur_block");
      this.func_175031_a(Blocks.field_185768_cU, "purpur_pillar");
      this.func_175031_a(Blocks.field_185769_cV, "purpur_stairs");
      this.func_175031_a(Blocks.field_185771_cX, "purpur_slab");
      ...
      this.func_175031_a(Blocks.field_189878_dg, "nether_wart_block");
      this.func_175031_a(Blocks.field_189879_dh, "red_nether_brick");
      this.func_175031_a(Blocks.field_189880_di, "bone_block");
      this.func_175031_a(Blocks.field_189881_dj, "structure_void");
      ...
      this.func_175047_a(Items.field_151031_f, "bow");
      this.func_175047_a(Items.field_151032_g, "arrow");
      this.func_175047_a(Items.field_185166_h, "spectral_arrow");
      this.func_175047_a(Items.field_185167_i, "tipped_arrow");
      ...
      this.func_175047_a(Items.field_151124_az, "oak_boat");
      this.func_175047_a(Items.field_185150_aH, "spruce_boat");
      this.func_175047_a(Items.field_185151_aI, "birch_boat");
      this.func_175047_a(Items.field_185152_aJ, "jungle_boat");
      this.func_175047_a(Items.field_185153_aK, "acacia_boat");
      this.func_175047_a(Items.field_185154_aL, "dark_oak_boat");
      ...
      this.func_175047_a(Items.field_185164_cV, "beetroot");
      this.func_175047_a(Items.field_185163_cU, "beetroot_seeds");
      this.func_175047_a(Items.field_185165_cW, "beetroot_soup");
      this.func_175047_a(Items.field_151068_bn, "bottle_drinkable");
      this.func_175047_a(Items.field_185155_bH, "bottle_splash");
      this.func_175047_a(Items.field_185156_bI, "bottle_lingering");
      this.func_175047_a(Items.field_151069_bo, "glass_bottle");
      this.func_175047_a(Items.field_185157_bK, "dragon_breath");
      ...
      this.func_175047_a(Items.field_185158_cP, "end_crystal");
      ...
      this.func_175047_a(Items.field_185160_cR, "elytra");
      this.func_175047_a(Items.field_185161_cS, "chorus_fruit");
      this.func_175047_a(Items.field_185162_cT, "chorus_fruit_popped");
      ...
      this.func_175031_a(Blocks.field_185776_dc, "repeating_command_block");
      this.func_175031_a(Blocks.field_185777_dd, "chain_command_block");
      this.func_175029_a(Blocks.field_185779_df, TileEntityStructure.Mode.SAVE.func_185110_a(), "structure_block");
