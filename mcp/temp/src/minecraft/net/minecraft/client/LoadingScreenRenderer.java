   ...
   public void func_73718_a(int p_73718_1_) {
      if(!this.field_73725_b.field_71425_J) {
         ...
         if(i - this.field_73723_d >= 100L) {
            ...
            vertexbuffer.func_181662_b(0.0D, (double)l, 0.0D).func_187315_a(0.0D, (double)((float)l / 32.0F)).func_181669_b(64, 64, 64, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)k, (double)l, 0.0D).func_187315_a((double)((float)k / 32.0F), (double)((float)l / 32.0F)).func_181669_b(64, 64, 64, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)k, 0.0D, 0.0D).func_187315_a((double)((float)k / 32.0F), 0.0D).func_181669_b(64, 64, 64, 255).func_181675_d();
            vertexbuffer.func_181662_b(0.0D, 0.0D, 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(64, 64, 64, 255).func_181675_d();
            ...
            if(p_73718_1_ >= 0) {
               ...
               vertexbuffer.func_181662_b((double)k1, (double)l1, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
               vertexbuffer.func_181662_b((double)k1, (double)(l1 + 2), 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
               vertexbuffer.func_181662_b((double)(k1 + 100), (double)(l1 + 2), 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
               vertexbuffer.func_181662_b((double)(k1 + 100), (double)l1, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
               vertexbuffer.func_181662_b((double)k1, (double)l1, 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
               vertexbuffer.func_181662_b((double)k1, (double)(l1 + 2), 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
               vertexbuffer.func_181662_b((double)(k1 + p_73718_1_), (double)(l1 + 2), 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
               vertexbuffer.func_181662_b((double)(k1 + p_73718_1_), (double)l1, 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
               tessellator.func_78381_a();
