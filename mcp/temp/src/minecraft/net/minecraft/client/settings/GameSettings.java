...
public class GameSettings {
   ...
   public String func_74297_c(GameSettings.Options p_74297_1_) {
      ...
      if(p_74297_1_.func_74380_a()) {
         ...
         return p_74297_1_ == GameSettings.Options.ATTACK_INDICATOR?s + func_74299_a(field_186713_aK, this.field_186716_M):s;
      }
   }
   ...
   public void func_74300_a() {
      try {
         ...
         List<String> list = IOUtils.readLines((InputStream)(new FileInputStream(this.field_74354_ai)));
         ...
         for(String s : list) {
            try {
               ...
               field_151454_ax.warn("Skipping bad option: {}", new Object[]{s});
            }
         }
         ...
         for(String s1 : nbttagcompound.func_150296_c()) {
            ...
            try {
               ...
               if("resourcePacks".equals(s1)) {
                  this.field_151453_l = (List)field_151450_ay.fromJson(s2, field_151449_az);
               ...
               if("incompatibleResourcePacks".equals(s1)) {
                  this.field_183018_l = (List)field_151450_ay.fromJson(s2, field_151449_az);
               ...
               if("showInventoryAchievementHint".equals(s1)) {
                  this.field_151441_H = "true".equals(s2);
               }
               ...
               field_151454_ax.warn("Skipping bad option: {}:{}", new Object[]{s1, s2});
            }
         }
   ...
   private float func_74305_a(String p_74305_1_) {
      return "true".equals(p_74305_1_)?1.0F:("false".equals(p_74305_1_)?0.0F:Float.parseFloat(p_74305_1_));
   }
   ...
   public void func_74303_b() {
      ...
      try {
         printwriter = new PrintWriter(new FileWriter(this.field_74354_ai));
