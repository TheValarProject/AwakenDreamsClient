...
public class ServerScoreboard extends Scoreboard {
   ...
   public boolean func_151392_a(String p_151392_1_, String p_151392_2_) {
      if(super.func_151392_a(p_151392_1_, p_151392_2_)) {
         ...
         this.field_96555_a.func_184103_al().func_148540_a(new SPacketTeams(scoreplayerteam, Arrays.asList(new String[]{p_151392_1_}), 3));
         this.func_96551_b();
         return true;
      } else {
         return false;
   ...
   public void func_96512_b(String p_96512_1_, ScorePlayerTeam p_96512_2_) {
      ...
      this.field_96555_a.func_184103_al().func_148540_a(new SPacketTeams(p_96512_2_, Arrays.asList(new String[]{p_96512_1_}), 4));
      this.func_96551_b();
   }
